	...
	implements \Aimeos\MShop\Price\Manager\Lists\Type\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	private array $searchConfig = array(
		...
		'price.lists.type.i18n' => array(
			'internalcode' => 'mprility."i18n"',
	...
	public function clear( iterable $siteids ) : \Aimeos\MShop\Common\Manager\Iface
	{
		...
		return $this->clearBase( $siteids, 'mshop/price/manager/lists/type/delete' );
	}
	...
	protected function getConfigPath() : string
	{
		...
		return 'mshop/price/manager/lists/type/';
	}
