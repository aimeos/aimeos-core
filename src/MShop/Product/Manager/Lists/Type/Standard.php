	...
	implements \Aimeos\MShop\Product\Manager\Lists\Type\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	private array $searchConfig = array(
		...
		'product.lists.type.i18n' => array(
			'internalcode' => 'mprolity."i18n"',
	...
	public function clear( iterable $siteids ) : \Aimeos\MShop\Common\Manager\Iface
	{
		...
		return $this->clearBase( $siteids, 'mshop/product/manager/lists/type/delete' );
	}
	...
	protected function getConfigPath() : string
	{
		...
		return 'mshop/product/manager/lists/type/';
	}
