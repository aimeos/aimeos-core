	...
	implements \Aimeos\MShop\Product\Manager\Property\Type\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	private array $searchConfig = array(
		...
		'product.property.type.i18n' => array(
			'internalcode' => 'mproprty."i18n"',
	...
	public function clear( iterable $siteids ) : \Aimeos\MShop\Common\Manager\Iface
	{
		...
		return $this->clearBase( $siteids, 'mshop/product/manager/property/type/delete' );
	}
	...
	protected function getConfigPath() : string
	{
		...
		return 'mshop/product/manager/property/type/';
	}
