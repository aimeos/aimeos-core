	...
	implements \Aimeos\MShop\Tag\Manager\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	...
	public function __construct( \Aimeos\MShop\ContextIface $context )
	{
		 ...
		 * @since 2023.04
		 */
		$this->setResourceName( $context->config()->get( 'mshop/tag/manager/resource', 'db-tag' ) );
	...
	public function clear( iterable $siteids ) : \Aimeos\MShop\Common\Manager\Iface
	{
		...
		return $this->clearBase( $siteids, 'mshop/tag/manager/delete' );
	}
	...
	{
		$values['tag.siteid'] = $values['tag.siteid'] ?? $this->context()->locale()->getSiteId();
	 ...
	 */
	protected function saveItem( \Aimeos\MShop\Tag\Item\Iface $item, bool $fetch = true ) : \Aimeos\MShop\Tag\Item\Iface
	{
		if( !$item->isModified() ) {
			return $item;
		}
	 ...
	 * @return \Aimeos\Map List of items implementing \Aimeos\MShop\Tag\Item\Iface with ids as keys
	 */
	public function search( \Aimeos\Base\Criteria\Iface $search, array $ref = [], int &$total = null ) : \Aimeos\Map
	{
		...
		$conn = $context->db( $this->getResourceName() );
			...
			$level = $context->config()->get( 'mshop/tag/manager/sitemode', $level );
			 ...
			 * @see mshop/tag/manager/count/ansi
			 */
			$cfgPathSearch = 'mshop/tag/manager/search';
			 ...
			 * @see mshop/tag/manager/search/ansi
			 */
			$cfgPathCount = 'mshop/tag/manager/count';
	 ...
	 */
	protected function createItemBase( array $values = [] ) : \Aimeos\MShop\Tag\Item\Iface
	{
