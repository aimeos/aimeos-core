	...
	implements \Aimeos\MShop\Supplier\Manager\Address\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	private array $searchConfig = array(
		...
		'supplier.address.mobile' => array(
			'code' => 'supplier.address.mobile',
			'internalcode' => 'msupad."mobile"',
	...
	{
		return new \Aimeos\MShop\Supplier\Item\Address\Standard( $this->prefix(), $values );
	}
