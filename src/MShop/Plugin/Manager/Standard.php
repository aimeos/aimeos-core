	...
	implements \Aimeos\MShop\Plugin\Manager\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	...
	public function __construct( \Aimeos\MShop\ContextIface $context )
	{
		 ...
		 * @since 2023.04
		 */
		$this->setResourceName( $context->config()->get( 'mshop/plugin/manager/resource', 'db-plugin' ) );
	}
	...
	public function clear( iterable $siteids ) : \Aimeos\MShop\Common\Manager\Iface
	{
		...
		return $this->clearBase( $siteids, 'mshop/plugin/manager/delete' );
	}
	...
	public function delete( $itemIds ) : \Aimeos\MShop\Common\Manager\Iface
	{
		 ...
		 */
		$path = 'mshop/plugin/manager/delete';
	 ...
	 */
	protected function saveItem( \Aimeos\MShop\Plugin\Item\Iface $item, bool $fetch = true ) : \Aimeos\MShop\Plugin\Item\Iface
	{
		if( !$item->isModified() ) {
			return $item;
		}
		...
		else
		{
			 ...
			 * @see mshop/plugin/manager/count/ansi
			 */
			$path = 'mshop/plugin/manager/update';
		...
		if( $id === null && $fetch === true )
		{
			 ...
			 * @see mshop/plugin/manager/count/ansi
			 */
			$path = 'mshop/plugin/manager/newid';
	...
	public function search( \Aimeos\Base\Criteria\Iface $search, array $ref = [], int &$total = null ) : \Aimeos\Map
	{
		...
		$conn = $context->db( $this->getResourceName() );
			...
			$level = $context->config()->get( 'mshop/plugin/manager/sitemode', $level );
			 ...
			 * @see mshop/plugin/manager/count/ansi
			 */
			$cfgPathSearch = 'mshop/plugin/manager/search';
			 ...
			 * @see mshop/plugin/manager/search/ansi
			 */
			$cfgPathCount = 'mshop/plugin/manager/count';
