	...
	implements \Aimeos\MShop\Text\Manager\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	...
	public function clear( iterable $siteids ) : \Aimeos\MShop\Common\Manager\Iface
	{
		...
		foreach( $this->context()->config()->get( $path, array( 'type', 'lists' ) ) as $domain ) {
			$this->object()->getSubManager( $domain )->clear( $siteids );
		}

		return $this->clearBase( $siteids, 'mshop/text/manager/delete' );
	}
	 ...
	 */
	protected function saveItem( \Aimeos\MShop\Text\Item\Iface $item, bool $fetch = true ) : \Aimeos\MShop\Text\Item\Iface
	{
		if( !$item->isModified() ) {
		...
		else
		{
			 ...
			 * @see mshop/text/manager/count/ansi
			 */
			$path = 'mshop/text/manager/update';
	...
	public function delete( $itemIds ) : \Aimeos\MShop\Common\Manager\Iface
	{
		 ...
		 * @see mshop/text/manager/count/ansi
		 */
		$path = 'mshop/text/manager/delete';
	...
	public function search( \Aimeos\Base\Criteria\Iface $search, array $ref = [], int &$total = null ) : \Aimeos\Map
	{
		...
		$conn = $context->db( $this->getResourceName() );
			 ...
			 * @see mshop/text/manager/count/ansi
			 */
			$cfgPathSearch = 'mshop/text/manager/search';
			 ...
			 * @see mshop/text/manager/search/ansi
			 */
			$cfgPathCount = 'mshop/text/manager/count';
