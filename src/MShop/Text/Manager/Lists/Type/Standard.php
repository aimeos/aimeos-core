	...
	implements \Aimeos\MShop\Text\Manager\Lists\Type\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	...
	public function __construct( \Aimeos\MShop\ContextIface $context )
	{
		 ...
		 * @since 2023.04
		 */
		$this->setResourceName( $context->config()->get( 'mshop/text/manager/resource', 'db-text' ) );
	}
	...
	public function clear( iterable $siteids ) : \Aimeos\MShop\Common\Manager\Iface
	{
		...
		return $this->clearBase( $siteids, 'mshop/text/manager/lists/type/delete' );
	}
	...
	protected function getConfigPath() : string
	{
		...
		return 'mshop/text/manager/lists/type/';
	}
