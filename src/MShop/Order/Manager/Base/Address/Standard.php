	...
	implements \Aimeos\MShop\Order\Manager\Base\Address\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	private $searchConfig = array(
		'order.base.address.id' => array(
			...
			'internaldeps' => array( 'LEFT JOIN "mshop_order_address" AS mordad ON ( mordba."id" = mordad."baseid" )' ),
			'label' => 'Address ID',
			'type' => 'integer',
	...
	{
		$values['order.base.address.siteid'] = $values['order.base.address.siteid'] ?? $this->context()->locale()->getSiteId();
