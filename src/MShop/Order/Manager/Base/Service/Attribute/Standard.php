	...
	implements \Aimeos\MShop\Order\Manager\Base\Service\Attribute\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	...
	{
		$values['order.base.service.attribute.siteid'] = $values['order.base.service.attribute.siteid'] ?? $this->context()->locale()->getSiteId();
	 ...
	 */
	protected function saveItem( \Aimeos\MShop\Order\Item\Base\Service\Attribute\Iface $item, bool $fetch = true ) : \Aimeos\MShop\Order\Item\Base\Service\Attribute\Iface
	{
		if( !$item->isModified() ) {
			return $item;
		}
