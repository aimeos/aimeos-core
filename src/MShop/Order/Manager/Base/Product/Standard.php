	...
	implements \Aimeos\MShop\Order\Manager\Base\Product\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	...
	public function create( array $values = [] ) : \Aimeos\MShop\Common\Item\Iface
	{
		...
		$values['order.base.product.siteid'] = $values['order.base.product.siteid'] ?? $context->locale()->getSiteId();
	 ...
	 */
	protected function saveItem( \Aimeos\MShop\Order\Item\Base\Product\Iface $item, bool $fetch = true ) : \Aimeos\MShop\Order\Item\Base\Product\Iface
	{
		if( !$item->isModified() ) {
