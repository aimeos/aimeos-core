	...
	implements \Aimeos\MShop\Order\Manager\Coupon\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	...
	public function clear( iterable $siteids ) : \Aimeos\MShop\Common\Manager\Iface
	{
		...
		return $this->clearBase( $siteids, 'mshop/order/manager/coupon/delete' );
	}
	...
	public function delete( $itemIds ) : \Aimeos\MShop\Common\Manager\Iface
	{
		 ...
		 * @see mshop/order/manager/coupon/count/ansi
		 */
		$path = 'mshop/order/manager/coupon/delete';
	 ...
	 */
	protected function saveItem( \Aimeos\MShop\Order\Item\Coupon\Iface $item, bool $fetch = true ) : \Aimeos\MShop\Order\Item\Coupon\Iface
	{
		if( !$item->isModified() ) {
			return $item;
		}
		...
		else
		{
			 ...
			 * @see mshop/order/manager/coupon/count/ansi
			 */
			$path = 'mshop/order/manager/coupon/update';
		...
		$stmt->bind( $idx++, $item->getProductId(), \Aimeos\Base\DB\Statement\Base::PARAM_INT );
		...
		if( $id === null && $fetch === true )
		{
			 ...
			 * @see mshop/order/manager/coupon/count/ansi
			 */
			$path = 'mshop/order/manager/coupon/newid';
	 ...
	 * @return \Aimeos\Map List of items implementing \Aimeos\MShop\Order\Item\Coupon\Iface with ids as keys
	 */
	public function search( \Aimeos\Base\Criteria\Iface $search, array $ref = [], int &$total = null ) : \Aimeos\Map
	{
		...
		$conn = $context->db( $this->getResourceName() );
			 ...
			 * @see mshop/order/manager/coupon/count/ansi
			 */
			$cfgPathSearch = 'mshop/order/manager/coupon/search';
			 ...
			 * @see mshop/order/manager/coupon/search/ansi
			 */
			$cfgPathCount = 'mshop/order/manager/coupon/count';
			...
			try
			{
				while( ( $row = $results->fetch() ) !== null )
				{
					if( $item = $this->applyFilter( $this->createItemBase( $row ) ) ) {
						$items[$row['order.coupon.id']] = $item;
					}
				}
			}
			catch( \Exception $e )
	 ...
	 * @return \Aimeos\MShop\Order\Item\Coupon\Iface New order base coupon item
	 */
	protected function createItemBase( array $values = [] ) : \Aimeos\MShop\Order\Item\Coupon\Iface
	{
