	...
	implements \Aimeos\MShop\Media\Manager\Lists\Type\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	private array $searchConfig = array(
		...
		'media.lists.type.i18n' => array(
			'internalcode' => 'mmedlity."i18n"',
	...
	public function clear( iterable $siteids ) : \Aimeos\MShop\Common\Manager\Iface
	{
		...
		return $this->clearBase( $siteids, 'mshop/media/manager/lists/type/delete' );
	}
	...
	protected function getConfigPath() : string
	{
		...
		return 'mshop/media/manager/lists/type/';
	}
