	...
	implements \Aimeos\MShop\Attribute\Manager\Property\Type\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	private array $searchConfig = array(
		...
		'attribute.property.type.i18n' => array(
			'internalcode' => 'mattprty."i18n"',
	...
	public function clear( iterable $siteids ) : \Aimeos\MShop\Common\Manager\Iface
	{
		...
		return $this->clearBase( $siteids, 'mshop/attribute/manager/property/type/delete' );
	}
	...
	protected function getConfigPath() : string
	{
		...
		return 'mshop/attribute/manager/property/type/';
	}
