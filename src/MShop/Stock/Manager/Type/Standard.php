	...
	implements \Aimeos\MShop\Stock\Manager\Type\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	...
	public function __construct( \Aimeos\MShop\ContextIface $context )
	{
		 ...
		 * @since 2023.04
		 */
		$this->setResourceName( $context->config()->get( 'mshop/stock/manager/resource', 'db-stock' ) );
	}
	...
	public function clear( iterable $siteids ) : \Aimeos\MShop\Common\Manager\Iface
	{
		...
		return $this->clearBase( $siteids, 'mshop/stock/manager/type/delete' );
	}
	...
	protected function getConfigPath() : string
	{
		...
		return 'mshop/stock/manager/type/';
	}
