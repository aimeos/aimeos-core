	...
	implements \Aimeos\MShop\Catalog\Manager\Lists\Type\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	private array $searchConfig = array(
		...
		'catalog.lists.type.i18n' => array(
			'internalcode' => 'mcatlity."i18n"',
	...
	public function clear( iterable $siteids ) : \Aimeos\MShop\Common\Manager\Iface
	{
		...
		return $this->clearBase( $siteids, 'mshop/catalog/manager/lists/type/delete' );
	}
	...
	protected function getConfigPath() : string
	{
		...
		return 'mshop/catalog/manager/lists/type/';
	}
