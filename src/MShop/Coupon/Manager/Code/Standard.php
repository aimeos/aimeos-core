	...
	implements \Aimeos\MShop\Coupon\Manager\Code\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	...
	public function __construct( \Aimeos\MShop\ContextIface $context )
	{
		 ...
		 * @since 2023.04
		 */
		$this->setResourceName( $context->config()->get( 'mshop/coupon/manager/resource', 'db-coupon' ) );
	 ...
	 */
	protected function saveItem( \Aimeos\MShop\Coupon\Item\Code\Iface $item, bool $fetch = true ) : \Aimeos\MShop\Coupon\Item\Code\Iface
	{
		if( !$item->isModified() ) {
			return $item;
		}
