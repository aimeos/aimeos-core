 ...
 */
class MW_Config_Decorator_CacheTest extends MW_Unittest_Testcase
{
	protected $_object;
	...
	{
		$suite  = new PHPUnit_Framework_TestSuite('MW_Config_Decorator_CacheTest');
	...
	protected function setUp()
	{
		...
		$this->_object = new MW_Config_Decorator_Cache( $conf );
	}
