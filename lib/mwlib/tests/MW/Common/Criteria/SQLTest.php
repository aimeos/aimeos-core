...
/**
 * Test class for \Aimeos\MW\Common\Criteria\SQL.
 */
class SQLTest extends \PHPUnit_Framework_TestCase
{
	...
	protected function setUp()
	{
		...
		$conn = $dbm->acquire();
		$this->object = new \Aimeos\MW\Common\Criteria\SQL( $conn );
		$dbm->release( $conn );
	}
	...
	{
		$this->assertInstanceOf( '\\Aimeos\\MW\\Common\\Criteria\\Expression\\Combine\\SQL', $this->object->combine( '||', array() ) );
	}


	public function testCompare()
	{
		$this->assertInstanceOf( '\\Aimeos\\MW\\Common\\Criteria\\Expression\\Compare\\SQL', $this->object->compare( '!=', 'name', 'value' ) );
	}


	public function testSort()
	{
		$this->assertInstanceOf( '\\Aimeos\\MW\\Common\\Criteria\\Expression\\Sort\\SQL', $this->object->sort( '+', 'name' ) );
	}
	...
	{
		$this->assertInstanceOf( '\\Aimeos\\MW\\Common\\Criteria\\Expression\\Compare\\SQL', $this->object->getConditions() );
	...
	public function testToConditionsEmptyArray()
	{
		...
		$this->assertInstanceOf( '\\Aimeos\\MW\\Common\\Criteria\\Expression\\Compare\\SQL', $condition );
	}
	...
	public function testToConditionsCompare()
	{
		...
		$this->assertInstanceOf( '\\Aimeos\\MW\\Common\\Criteria\\Expression\\Compare\\Iface', $condition );
	...
	public function testToConditionsCombine()
	{
		...
		$condition = $this->object->toConditions( $array );
		$this->assertInstanceOf( '\\Aimeos\\MW\\Common\\Criteria\\Expression\\Combine\\Iface', $condition );
		$this->assertEquals( '&&', $condition->getOperator() );
		$this->assertEquals( 2, count( $condition->getExpressions() ) );

		foreach( $condition->getExpressions() as $expr )
		{
			$this->assertInstanceOf( '\\Aimeos\\MW\\Common\\Criteria\\Expression\\Compare\\Iface', $expr );
	...
	public function testToSortations()
	{
		...
		foreach( $sortations as $sort ) {
			$this->assertInstanceOf( '\\Aimeos\\MW\\Common\\Criteria\\Expression\\Sort\\Iface', $sort );
		}
 ...
 * Test plugin class
 */
class TestSQL implements \Aimeos\MW\Common\Criteria\Plugin\Iface
{
