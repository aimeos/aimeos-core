 ...
 */
class MW_View_Helper_DateTest extends MW_Unittest_Testcase
{
	protected $_object;
	...
	{
		$suite  = new PHPUnit_Framework_TestSuite('MW_View_Helper_Date');
	...
	protected function setUp()
	{
		...
		$this->_object = new MW_View_Helper_Date( $view, 'd.m.Y' );
	}
