	...
	implements \Aimeos\MAdmin\Log\Manager\Iface
{
	...
	public function saveItem( \Aimeos\MShop\Common\Item\Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** madmin/log/manager/standard/insert
				 ...
				 * @since 2014.03
				 * @category Developer
				 * @see madmin/log/manager/standard/update
				 * @see madmin/log/manager/standard/newid
				 * @see madmin/log/manager/standard/delete
				 * @see madmin/log/manager/standard/search
			...
			{
				/** madmin/log/manager/standard/update
				 ...
				 * @since 2014.03
				 * @category Developer
				 * @see madmin/log/manager/standard/insert
				 * @see madmin/log/manager/standard/newid
				 * @see madmin/log/manager/standard/delete
				 * @see madmin/log/manager/standard/search
				 * @see madmin/log/manager/standard/count
			...
			{
				/** madmin/log/manager/standard/newid
	...
	{
		/** madmin/log/manager/standard/delete
	...
	public function searchItems( \Aimeos\MW\Criteria\Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			...
			/** madmin/log/manager/standard/count
