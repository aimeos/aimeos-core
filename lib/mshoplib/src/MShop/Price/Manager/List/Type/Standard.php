 ...
 * @subpackage Price
 */
class MShop_Price_Manager_List_Type_Standard
	...
	implements MShop_Price_Manager_List_Type_Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/price/manager/list/type/default/item/delete' );
	}
	...
	public function getSubManager( $manager, $name = null )
	{
		 ...
		 *
		 *  MShop_Price_Manager_List_Type_Standard
		 *
		...
		return $this->getSubManagerBase( 'price', 'list/type/' . $manager, $name );
	}
