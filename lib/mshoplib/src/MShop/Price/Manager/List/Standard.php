 ...
 * @subpackage Price
 */
class MShop_Price_Manager_List_Standard
	extends MShop_Common_Manager_List_Base
	implements MShop_Price_Manager_List_Iface
{
	...
	{
		/** classes/price/manager/list/submanagers
	...
	public function getSubManager( $manager, $name = null )
	{
		 ...
		 *
		 *  MShop_Price_Manager_List_Standard
		 *
	...
	protected function getConfigPath()
	{
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/price/manager/list/default/item/update
		 * @see mshop/price/manager/list/default/item/newid
		 * @see mshop/price/manager/list/default/item/delete
		 * @see mshop/price/manager/list/default/item/search
		 * @see mshop/price/manager/list/default/item/count
		 * @see mshop/price/manager/list/default/item/aggregate
		 * @see mshop/price/manager/list/default/item/getposmax
		 * @see mshop/price/manager/list/default/item/move
		 * @see mshop/price/manager/list/default/item/updatepos
		 */

		/** mshop/price/manager/list/default/item/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/price/manager/list/default/item/insert
		 * @see mshop/price/manager/list/default/item/newid
		 * @see mshop/price/manager/list/default/item/delete
		 * @see mshop/price/manager/list/default/item/search
		 * @see mshop/price/manager/list/default/item/count
		...
		/** mshop/price/manager/list/default/item/newid
		...
		/** mshop/price/manager/list/default/item/delete
		...
		/** mshop/price/manager/list/default/item/search
		...
		/** mshop/price/manager/list/default/item/count
		...
		/** mshop/price/manager/list/default/item/aggregate
		...
		/** mshop/price/manager/list/default/item/getposmax
		...
		/** mshop/price/manager/list/default/item/move
		...
		/** mshop/price/manager/list/default/item/updatepos
