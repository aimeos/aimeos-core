...
class Standard
	...
	implements \Aimeos\MShop\Price\Manager\Property\Type\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	private $searchConfig = array(
		'price.property.type.id' => array(
			'code' => 'price.property.type.id',
			'internalcode' => 'mpriprty."id"',
			'label' => 'Property type ID',
			'type' => 'integer',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_INT,
			'public' => false,
		),
		'price.property.type.siteid' => array(
			'code' => 'price.property.type.siteid',
			'internalcode' => 'mpriprty."siteid"',
			'label' => 'Property type site ID',
			'type' => 'integer',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_INT,
			'public' => false,
		),
		'price.property.type.label' => array(
			'code' => 'price.property.type.label',
			'internalcode' => 'mpriprty."label"',
			'label' => 'Property type label',
			'type' => 'string',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_STR,
		),
		'price.property.type.code' => array(
			'code' => 'price.property.type.code',
			'internalcode' => 'mpriprty."code"',
			'label' => 'Property type code',
			'type' => 'string',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_STR,
		),
		'price.property.type.domain' => array(
			'code' => 'price.property.type.domain',
			'internalcode' => 'mpriprty."domain"',
			'label' => 'Property type domain',
			'type' => 'string',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_STR,
		),
		'price.property.type.position' => array(
			'code' => 'price.property.type.position',
			'internalcode' => 'mpriprty."pos"',
			'label' => 'Property type position',
			'type' => 'integer',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_INT,
		),
		'price.property.type.status' => array(
			'code' => 'price.property.type.status',
			'internalcode' => 'mpriprty."status"',
			'label' => 'Property type status',
			'type' => 'integer',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_INT,
		),
		'price.property.type.ctime' => array(
			'code' => 'price.property.type.ctime',
			'internalcode' => 'mpriprty."ctime"',
			'label' => 'Property type create date/time',
			'type' => 'datetime',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_STR,
			'public' => false,
		),
		'price.property.type.mtime' => array(
			'code' => 'price.property.type.mtime',
			'internalcode' => 'mpriprty."mtime"',
			'label' => 'Property type modify date',
			'type' => 'datetime',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_STR,
			'public' => false,
		),
		'price.property.type.editor' => array(
			'code' => 'price.property.type.editor',
			'internalcode' => 'mpriprty."editor"',
	...
	public function cleanup( array $siteids )
	{
		...
		return $this->cleanupBase( $siteids, 'mshop/price/manager/property/type/standard/delete' );
	}
	...
	public function getSubManager( $manager, $name = null )
	{
		...
		return $this->getSubManagerBase( 'price', 'property/type/' . $manager, $name );
	}
	...
	protected function getConfigPath()
	{
		 ...
		 *
		 * @see mshop/price/manager/property/type/standard/insert/ansi
		 */
		 ...
		 * @since 2018.01
		 * @category Developer
		 * @see mshop/price/manager/property/type/standard/update/ansi
		 * @see mshop/price/manager/property/type/standard/newid/ansi
		 * @see mshop/price/manager/property/type/standard/delete/ansi
		 * @see mshop/price/manager/property/type/standard/search/ansi
		 * @see mshop/price/manager/property/type/standard/count/ansi
		 */
		...
		/** mshop/price/manager/property/type/standard/newid/mysql
		...
		return 'mshop/price/manager/property/type/standard/';
	}
