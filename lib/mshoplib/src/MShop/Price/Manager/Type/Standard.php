 ...
 * @subpackage Price
 */
class MShop_Price_Manager_Type_Standard
	extends MShop_Common_Manager_Type_Base
	implements MShop_Price_Manager_Type_Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/price/manager/type/standard/item/delete' );
	}
	...
	{
		/** classes/price/manager/type/submanagers
	...
	public function getSubManager( $manager, $name = null )
	{
		 ...
		 *
		 *  MShop_Price_Manager_Type_Standard
		 *
	...
	{
		/** mshop/price/manager/type/standard/item/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/price/manager/type/standard/item/update
		 * @see mshop/price/manager/type/standard/item/newid
		 * @see mshop/price/manager/type/standard/item/delete
		 * @see mshop/price/manager/type/standard/item/search
		 * @see mshop/price/manager/type/standard/item/count
		 */

		/** mshop/price/manager/type/standard/item/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/price/manager/type/standard/item/insert
		 * @see mshop/price/manager/type/standard/item/newid
		 * @see mshop/price/manager/type/standard/item/delete
		 * @see mshop/price/manager/type/standard/item/search
		 * @see mshop/price/manager/type/standard/item/count
		...
		/** mshop/price/manager/type/standard/item/newid
		...
		/** mshop/price/manager/type/standard/item/delete
		...
		/** mshop/price/manager/type/standard/item/search
		...
		/** mshop/price/manager/type/standard/item/count
		...
		return 'mshop/price/manager/type/standard/item/';
	}
