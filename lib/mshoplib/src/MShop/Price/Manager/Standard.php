 ...
 * @subpackage Price
 */
class MShop_Price_Manager_Standard
	...
	implements MShop_Price_Manager_Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/price/manager/standard/item/delete' );
	}
	...
	{
		/** mshop/price/manager/standard/item/delete
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/price/manager/standard/item/insert
		 * @see mshop/price/manager/standard/item/update
		 * @see mshop/price/manager/standard/item/newid
		 * @see mshop/price/manager/standard/item/search
		 * @see mshop/price/manager/standard/item/count
		 */
		$path = 'mshop/price/manager/standard/item/delete';
	...
	public function saveItem( MShop_Common_Item_Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/price/manager/standard/item/insert
				 ...
				 * @see mshop/price/manager/standard/item/update
				 * @see mshop/price/manager/standard/item/newid
				 * @see mshop/price/manager/standard/item/delete
				 * @see mshop/price/manager/standard/item/search
				 * @see mshop/price/manager/standard/item/count
				 */
				$path = 'mshop/price/manager/standard/item/insert';
			}
			else
			{
				/** mshop/price/manager/standard/item/update
				 ...
				 * @see mshop/price/manager/standard/item/count
				 */
				$path = 'mshop/price/manager/standard/item/update';
			}
			...
			{
				/** mshop/price/manager/standard/item/newid
				 ...
				 * @see mshop/price/manager/standard/item/count
				 */
				$path = 'mshop/price/manager/standard/item/newid';
	...
	public function searchItems( MW_Common_Criteria_Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			...
			/** mshop/price/manager/standard/item/search
			 ...
			 * @see mshop/price/manager/standard/item/count
			 */
			$cfgPathSearch = 'mshop/price/manager/standard/item/search';

			/** mshop/price/manager/standard/item/count
			 ...
			 * @see mshop/price/manager/standard/item/search
			 */
			$cfgPathCount = 'mshop/price/manager/standard/item/count';
	...
	{
		return new MShop_Price_Item_Standard( $values, $listItems, $refItems );
	}
}
