 ...
 * @subpackage Price
 */
class MShop_Price_Manager_Lists_Standard
	extends MShop_Common_Manager_Lists_Base
	implements MShop_Price_Manager_Lists_Iface
{
	...
	{
		$path = 'classes/price/manager/lists/submanagers';
		foreach( $this->getContext()->getConfig()->get( $path, array( 'type' ) ) as $domain ) {
			$this->getSubManager( $domain )->cleanup( $siteids );
		}

		$this->cleanupBase( $siteids, 'mshop/price/manager/lists/standard/item/delete' );
	}
	...
	{
		/** classes/price/manager/lists/submanagers
	...
	{
		/** classes/price/manager/lists/name
		 ...
		 *
		 *  MShop_Price_Manager_Lists_Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  MShop_Price_Manager_Lists_Mylist
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/price/manager/lists/name = Mylist
		 *
	...
	{
		/** mshop/price/manager/lists/standard/item/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/price/manager/lists/standard/item/update
		 * @see mshop/price/manager/lists/standard/item/newid
		 * @see mshop/price/manager/lists/standard/item/delete
		 * @see mshop/price/manager/lists/standard/item/search
		 * @see mshop/price/manager/lists/standard/item/count
		 * @see mshop/price/manager/lists/standard/item/aggregate
		 * @see mshop/price/manager/lists/standard/item/getposmax
		 * @see mshop/price/manager/lists/standard/item/move
		 * @see mshop/price/manager/lists/standard/item/updatepos
		 */

		/** mshop/price/manager/lists/standard/item/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/price/manager/lists/standard/item/insert
		 * @see mshop/price/manager/lists/standard/item/newid
		 * @see mshop/price/manager/lists/standard/item/delete
		 * @see mshop/price/manager/lists/standard/item/search
		 * @see mshop/price/manager/lists/standard/item/count
		...
		/** mshop/price/manager/lists/standard/item/newid
		...
		/** mshop/price/manager/lists/standard/item/delete
		...
		/** mshop/price/manager/lists/standard/item/search
		...
		/** mshop/price/manager/lists/standard/item/count
		...
		/** mshop/price/manager/lists/standard/item/aggregate
		...
		/** mshop/price/manager/lists/standard/item/getposmax
		...
		/** mshop/price/manager/lists/standard/item/move
		...
		/** mshop/price/manager/lists/standard/item/updatepos
		...
		return 'mshop/price/manager/lists/standard/item/';
	}
