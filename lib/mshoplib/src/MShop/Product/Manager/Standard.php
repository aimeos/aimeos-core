	...
	implements MShop_Product_Manager_Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/product/manager/standard/item/delete' );
	}
	...
	public function saveItem( MShop_Common_Item_Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/product/manager/standard/item/insert
				 ...
				 * @since 2014.03
				 * @category Developer
				 * @see mshop/product/manager/standard/item/update
				 * @see mshop/product/manager/standard/item/newid
				 * @see mshop/product/manager/standard/item/delete
				 * @see mshop/product/manager/standard/item/search
				 * @see mshop/product/manager/standard/item/count
				 */
				$path = 'mshop/product/manager/standard/item/insert';
			}
			else
			{
				/** mshop/product/manager/standard/item/update
				 ...
				 * @since 2014.03
				 * @category Developer
				 * @see mshop/product/manager/standard/item/insert
				 * @see mshop/product/manager/standard/item/newid
				 * @see mshop/product/manager/standard/item/delete
				 * @see mshop/product/manager/standard/item/search
				 * @see mshop/product/manager/standard/item/count
				 */
				$path = 'mshop/product/manager/standard/item/update';
			}
			...
			{
				/** mshop/product/manager/standard/item/newid
				 ...
				 * @see mshop/product/manager/standard/item/count
				 */
				$path = 'mshop/product/manager/standard/item/newid';
	...
	{
		/** mshop/product/manager/standard/item/delete
		 ...
		 * @see mshop/product/manager/standard/item/count
		 */
		$path = 'mshop/product/manager/standard/item/delete';
	...
	public function searchItems( MW_Common_Criteria_Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			 ...
			 * @see mshop/product/manager/standard/item/count
			 */
			$cfgPathSearch = 'mshop/product/manager/standard/item/search';

			/** mshop/product/manager/standard/item/count
			 ...
			 * @see mshop/product/manager/standard/item/search
			 */
			$cfgPathCount = 'mshop/product/manager/standard/item/count';
