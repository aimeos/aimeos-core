...
namespace Aimeos\MShop\Product\Manager\Tag\Type;
...
class Standard
	...
	implements \Aimeos\MShop\Product\Manager\Tag\Type\Iface
{
	...
	{
		$path = 'mshop/product/manager/tag/type/submanagers';
		foreach( $this->getContext()->getConfig()->get( $path, array() ) as $domain ) {
			$this->getSubManager( $domain )->cleanup( $siteids );
		}

		$this->cleanupBase( $siteids, 'mshop/product/manager/tag/type/standard/item/delete' );
	}
	...
	{
		/** mshop/product/manager/tag/type/submanagers
		 * List of manager names that can be instantiated by the product tag type manager
		 *
	...
	{
		/** mshop/product/manager/tag/type/name
		 ...
		 *
		 *  mshop/product/manager/tag/type/name = Mytype
		 *
		 ...
		 * ("\Aimeos\MShop\Common\Manager\Decorator\*") around the product tag type manager.
		 *
		...
		return $this->getSubManagerBase( 'product', 'tag/type/' . $manager, $name );
	}
	...
	{
		/** mshop/product/manager/tag/type/standard/item/insert
		 * Inserts a new product tag type record into the database table
		 *
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/product/manager/tag/type/standard/item/update
		 * @see mshop/product/manager/tag/type/standard/item/newid
		 * @see mshop/product/manager/tag/type/standard/item/delete
		 * @see mshop/product/manager/tag/type/standard/item/search
		 * @see mshop/product/manager/tag/type/standard/item/count
		 */

		/** mshop/product/manager/tag/type/standard/item/update
		 * Updates an existing product tag type record in the database
		 *
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/product/manager/tag/type/standard/item/insert
		 * @see mshop/product/manager/tag/type/standard/item/newid
		 * @see mshop/product/manager/tag/type/standard/item/delete
		 * @see mshop/product/manager/tag/type/standard/item/search
		 * @see mshop/product/manager/tag/type/standard/item/count
		...
		/** mshop/product/manager/tag/type/standard/item/newid
		 ...
		 * For PostgreSQL:
		 *  SELECT currval('seq_mprotaty_id')
		 * For SQL Server:
		 *  SELECT SCOPE_IDENTITY()
		 * For Oracle:
		 *  SELECT "seq_mprotaty_id".CURRVAL FROM DUAL
		 *
		...
		/** mshop/product/manager/tag/type/standard/item/delete
		...
		/** mshop/product/manager/tag/type/standard/item/search
		...
		/** mshop/product/manager/tag/type/standard/item/count
		...
		return 'mshop/product/manager/tag/type/standard/item/';
	}
