	...
	implements \Aimeos\MShop\Product\Manager\Tag\Type\Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/product/manager/tag/type/standard/delete' );
	}
	...
	public function getResourceType( $withsub = true )
	{
		...
		return $this->getResourceTypeBase( 'product/tag/type', $path, array(), $withsub );
	}
	...
	{
		/** mshop/product/manager/tag/type/standard/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/product/manager/tag/type/standard/update
		 * @see mshop/product/manager/tag/type/standard/newid
		 * @see mshop/product/manager/tag/type/standard/delete
		 * @see mshop/product/manager/tag/type/standard/search
		 * @see mshop/product/manager/tag/type/standard/count
		 */

		/** mshop/product/manager/tag/type/standard/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/product/manager/tag/type/standard/insert
		 * @see mshop/product/manager/tag/type/standard/newid
		 * @see mshop/product/manager/tag/type/standard/delete
		 * @see mshop/product/manager/tag/type/standard/search
		 * @see mshop/product/manager/tag/type/standard/count
		...
		/** mshop/product/manager/tag/type/standard/newid
		...
		/** mshop/product/manager/tag/type/standard/delete
		...
		/** mshop/product/manager/tag/type/standard/search
		...
		/** mshop/product/manager/tag/type/standard/count
		...
		return 'mshop/product/manager/tag/type/standard/';
	}
