	...
	implements \Aimeos\MShop\Product\Manager\Tag\Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/product/manager/tag/standard/item/delete' );
	}
	...
	public function saveItem( \Aimeos\MShop\Common\Item\Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/product/manager/tag/standard/item/insert
				 ...
				 * @since 2014.03
				 * @category Developer
				 * @see mshop/product/manager/tag/standard/item/update
				 * @see mshop/product/manager/tag/standard/item/newid
				 * @see mshop/product/manager/tag/standard/item/delete
				 * @see mshop/product/manager/tag/standard/item/search
				 * @see mshop/product/manager/tag/standard/item/count
				 */
				$path = 'mshop/product/manager/tag/standard/item/insert';
			}
			else
			{
				/** mshop/product/manager/tag/standard/item/update
				 ...
				 * @since 2014.03
				 * @category Developer
				 * @see mshop/product/manager/tag/standard/item/insert
				 * @see mshop/product/manager/tag/standard/item/newid
				 * @see mshop/product/manager/tag/standard/item/delete
				 * @see mshop/product/manager/tag/standard/item/search
				 * @see mshop/product/manager/tag/standard/item/count
				 */
				$path = 'mshop/product/manager/tag/standard/item/update';
			}
			...
			{
				/** mshop/product/manager/tag/standard/item/newid
				 ...
				 * @see mshop/product/manager/tag/standard/item/count
				 */
				$path = 'mshop/product/manager/tag/standard/item/newid';
	...
	{
		/** mshop/product/manager/tag/standard/item/delete
		 ...
		 * @see mshop/product/manager/tag/standard/item/count
		 */
		$path = 'mshop/product/manager/tag/standard/item/delete';
	...
	public function searchItems( \Aimeos\MW\Common\Criteria\Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			 ...
			 * @see mshop/product/manager/tag/standard/item/count
			 */
			$cfgPathSearch = 'mshop/product/manager/tag/standard/item/search';

			/** mshop/product/manager/tag/standard/item/count
			 ...
			 * @see mshop/product/manager/tag/standard/item/search
			 */
			$cfgPathCount = 'mshop/product/manager/tag/standard/item/count';
