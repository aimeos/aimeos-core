 ...
 * @subpackage Product
 */
class MShop_Product_Manager_Property_Type_Standard
	extends MShop_Common_Manager_Type_Base
	implements MShop_Product_Manager_Property_Type_Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/product/manager/property/type/standard/item/delete' );
	}
	...
	{
		/** classes/product/manager/property/type/submanagers
	...
	{
		/** classes/product/manager/property/type/name
		 ...
		 *
		 *  classes/product/manager/property/type/name = Mytype
		 *
		 ...
		 * ("MShop_Common_Manager_Decorator_*") around the product property type manager.
		 *
	...
	{
		/** mshop/product/manager/property/type/standard/item/insert
		 ...
		 * @since 2015.01
		 * @category Developer
		 * @see mshop/product/manager/property/type/standard/item/update
		 * @see mshop/product/manager/property/type/standard/item/newid
		 * @see mshop/product/manager/property/type/standard/item/delete
		 * @see mshop/product/manager/property/type/standard/item/search
		 * @see mshop/product/manager/property/type/standard/item/count
		 */

		/** mshop/product/manager/property/type/standard/item/update
		 ...
		 * @since 2015.01
		 * @category Developer
		 * @see mshop/product/manager/property/type/standard/item/insert
		 * @see mshop/product/manager/property/type/standard/item/newid
		 * @see mshop/product/manager/property/type/standard/item/delete
		 * @see mshop/product/manager/property/type/standard/item/search
		 * @see mshop/product/manager/property/type/standard/item/count
		...
		/** mshop/product/manager/property/type/standard/item/newid
		...
		/** mshop/product/manager/property/type/standard/item/delete
		...
		/** mshop/product/manager/property/type/standard/item/search
		...
		/** mshop/product/manager/property/type/standard/item/count
		...
		return 'mshop/product/manager/property/type/standard/item/';
	}
