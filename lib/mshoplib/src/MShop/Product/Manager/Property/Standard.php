	...
	implements \Aimeos\MShop\Product\Manager\Property\Iface
{
	...
	public function saveItem( \Aimeos\MShop\Common\Item\Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/product/manager/property/standard/insert
				 ...
				 * @since 2015.01
				 * @category Developer
				 * @see mshop/product/manager/property/standard/update
				 * @see mshop/product/manager/property/standard/newid
				 * @see mshop/product/manager/property/standard/delete
				 * @see mshop/product/manager/property/standard/search
				 * @see mshop/product/manager/property/standard/count
				 */
				$path = 'mshop/product/manager/property/standard/insert';
			}
			else
			{
				/** mshop/product/manager/property/standard/update
				 ...
				 * @since 2015.01
				 * @category Developer
				 * @see mshop/product/manager/property/standard/insert
				 * @see mshop/product/manager/property/standard/newid
				 * @see mshop/product/manager/property/standard/delete
				 * @see mshop/product/manager/property/standard/search
				 * @see mshop/product/manager/property/standard/count
			...
			{
				/** mshop/product/manager/property/standard/newid
	...
	{
		/** mshop/product/manager/property/standard/delete
	...
	public function searchItems( \Aimeos\MW\Common\Criteria\Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			...
			/** mshop/product/manager/property/standard/search
			...
			/** mshop/product/manager/property/standard/count
