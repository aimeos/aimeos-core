 ...
 * @subpackage Product
 */
class MShop_Product_Manager_Lists_Standard
	extends MShop_Common_Manager_Lists_Base
	implements MShop_Product_Manager_Lists_Iface
{
	private $searchConfig = array(
		...
		'product.lists.typeid' => array(
			'code'=>'product.lists.typeid',
	...
	{
		$path = 'classes/product/manager/lists/submanagers';
		foreach( $this->getContext()->getConfig()->get( $path, array( 'type' ) ) as $domain ) {
			$this->getSubManager( $domain )->cleanup( $siteids );
		}

		$this->cleanupBase( $siteids, 'mshop/product/manager/lists/standard/item/delete' );
	}
	...
	{
		/** classes/product/manager/lists/submanagers
	...
	{
		/** classes/product/manager/lists/name
		 ...
		 *
		 *  MShop_Product_Manager_Lists_Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  MShop_Product_Manager_Lists_Mylist
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/product/manager/lists/name = Mylist
		 *
	...
	{
		/** mshop/product/manager/lists/standard/item/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/product/manager/lists/standard/item/update
		 * @see mshop/product/manager/lists/standard/item/newid
		 * @see mshop/product/manager/lists/standard/item/delete
		 * @see mshop/product/manager/lists/standard/item/search
		 * @see mshop/product/manager/lists/standard/item/count
		 * @see mshop/product/manager/lists/standard/item/aggregate
		 * @see mshop/product/manager/lists/standard/item/getposmax
		 * @see mshop/product/manager/lists/standard/item/move
		 * @see mshop/product/manager/lists/standard/item/updatepos
		 */

		/** mshop/product/manager/lists/standard/item/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/product/manager/lists/standard/item/insert
		 * @see mshop/product/manager/lists/standard/item/newid
		 * @see mshop/product/manager/lists/standard/item/delete
		 * @see mshop/product/manager/lists/standard/item/search
		 * @see mshop/product/manager/lists/standard/item/count
		...
		/** mshop/product/manager/lists/standard/item/newid
		...
		/** mshop/product/manager/lists/standard/item/delete
		...
		/** mshop/product/manager/lists/standard/item/search
		...
		/** mshop/product/manager/lists/standard/item/count
		...
		/** mshop/product/manager/lists/standard/item/aggregate
		...
		/** mshop/product/manager/lists/standard/item/getposmax
		 ...
		 * the same site that is configured via the conproduct item are considered.
		 *
		 * The SQL statement must be a string suitable for being used as
		...
		/** mshop/product/manager/lists/standard/item/move
		...
		/** mshop/product/manager/lists/standard/item/updatepos
		 ...
		 * configured via the conproduct item.
		 *
		 * The SQL statement must be a string suitable for being used as
		 * prepared statement. It must include question marks for binding the
		 * required values to the statement before they are sent to the
		...
		return 'mshop/product/manager/lists/standard/item/';
	}
