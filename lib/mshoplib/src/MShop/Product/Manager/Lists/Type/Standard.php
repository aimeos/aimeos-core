	...
	implements \Aimeos\MShop\Product\Manager\Lists\Type\Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/product/manager/lists/type/standard/delete' );
	}
	...
	public function getResourceType( $withsub = true )
	{
		...
		return $this->getResourceTypeBase( 'product/lists/type', $path, array(), $withsub );
	}
	...
	{
		/** mshop/product/manager/lists/type/standard/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/product/manager/lists/type/standard/update
		 * @see mshop/product/manager/lists/type/standard/newid
		 * @see mshop/product/manager/lists/type/standard/delete
		 * @see mshop/product/manager/lists/type/standard/search
		 * @see mshop/product/manager/lists/type/standard/count
		 */

		/** mshop/product/manager/lists/type/standard/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/product/manager/lists/type/standard/insert
		 * @see mshop/product/manager/lists/type/standard/newid
		 * @see mshop/product/manager/lists/type/standard/delete
		 * @see mshop/product/manager/lists/type/standard/search
		 * @see mshop/product/manager/lists/type/standard/count
		...
		/** mshop/product/manager/lists/type/standard/newid
		...
		/** mshop/product/manager/lists/type/standard/delete
		...
		/** mshop/product/manager/lists/type/standard/search
		...
		/** mshop/product/manager/lists/type/standard/count
