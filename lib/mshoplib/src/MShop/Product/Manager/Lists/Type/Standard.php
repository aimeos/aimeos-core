...
class Standard
	...
	implements \Aimeos\MShop\Product\Manager\Lists\Type\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	private $searchConfig = array(
		...
		'product.lists.type.position' => array(
			'code' => 'product.lists.type.position',
	 ...
	 * @return \Aimeos\MShop\Product\Manager\Lists\Type\Iface Manager object for chaining method calls
	 */
	public function cleanup( array $siteids )
	{
		$path = 'mshop/product/manager/lists/type/submanagers';
		foreach( $this->getContext()->getConfig()->get( $path, [] ) as $domain ) {
			$this->getObject()->getSubManager( $domain )->cleanup( $siteids );
		}

		return $this->cleanupBase( $siteids, 'mshop/product/manager/lists/type/standard/delete' );
	}
	...
	{
		$path = 'mshop/product/manager/lists/type/submanagers';
		return $this->getResourceTypeBase( 'product/lists/type', $path, [], $withsub );
	}
	...
	protected function getConfigPath()
	{
		 ...
		 *
		 * @see mshop/product/manager/lists/type/standard/insert/ansi
		 */
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/product/manager/lists/type/standard/update/ansi
		 * @see mshop/product/manager/lists/type/standard/newid/ansi
		 * @see mshop/product/manager/lists/type/standard/delete/ansi
		 * @see mshop/product/manager/lists/type/standard/search/ansi
		 * @see mshop/product/manager/lists/type/standard/count/ansi
		 */
		...
		/** mshop/product/manager/lists/type/standard/newid/mysql
		...
		return 'mshop/product/manager/lists/type/standard/';
	}
