	...
	implements \Aimeos\MShop\Product\Manager\Stock\Warehouse\Iface
{
	...
	public function saveItem( \Aimeos\MShop\Common\Item\Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/product/manager/stock/warehouse/standard/insert/mysql
				 * Inserts a new product stock warehouse record into the database table
				 *
				 * @see mshop/product/manager/stock/warehouse/standard/insert/ansi
				 */

				/** mshop/product/manager/stock/warehouse/standard/insert/ansi
				 * Inserts a new product stock warehouse record into the database table
				 *
				 ...
				 * @since 2014.03
				 * @category Developer
				 * @see mshop/product/manager/stock/warehouse/standard/update/ansi
				 * @see mshop/product/manager/stock/warehouse/standard/newid/ansi
				 * @see mshop/product/manager/stock/warehouse/standard/delete/ansi
				 * @see mshop/product/manager/stock/warehouse/standard/search/ansi
				 * @see mshop/product/manager/stock/warehouse/standard/count/ansi
				 */
				$path = 'mshop/product/manager/stock/warehouse/standard/insert';
			}
			else
			{
				/** mshop/product/manager/stock/warehouse/standard/update/mysql
				 * Updates an existing product stock warehouse record in the database
				 *
				 * @see mshop/product/manager/stock/warehouse/standard/update/ansi
				 */

				/** mshop/product/manager/stock/warehouse/standard/update/ansi
				 * Updates an existing product stock warehouse record in the database
				 *
			...
			{
				/** mshop/product/manager/stock/warehouse/standard/newid/mysql
				 * Retrieves the ID generated by the database when inserting a new record
				 *
				 * @see mshop/product/manager/stock/warehouse/standard/newid/ansi
				 */

				/** mshop/product/manager/stock/warehouse/standard/newid/ansi
				 * Retrieves the ID generated by the database when inserting a new record
				 *
	...
	{
		/** mshop/product/manager/stock/warehouse/standard/delete/mysql
		 * Deletes the items matched by the given IDs from the database
		 *
		 * @see mshop/product/manager/stock/warehouse/standard/delete/ansi
		 */

		/** mshop/product/manager/stock/warehouse/standard/delete/ansi
		 * Deletes the items matched by the given IDs from the database
		 *
	...
	public function searchItems( \Aimeos\MW\Criteria\Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			...
			/** mshop/product/manager/stock/warehouse/standard/search/mysql
			 * Retrieves the records matched by the given criteria in the database
			 *
			 * @see mshop/product/manager/stock/warehouse/standard/search/ansi
			 */

			/** mshop/product/manager/stock/warehouse/standard/search/ansi
			 * Retrieves the records matched by the given criteria in the database
			 *
			...
			/** mshop/product/manager/stock/warehouse/standard/count/mysql
			 * Counts the number of records matched by the given criteria in the database
			 *
			 * @see mshop/product/manager/stock/warehouse/standard/count/ansi
			 */

			/** mshop/product/manager/stock/warehouse/standard/count/ansi
			 * Counts the number of records matched by the given criteria in the database
			 *
