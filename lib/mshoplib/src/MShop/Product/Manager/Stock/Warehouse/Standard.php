	...
	implements MShop_Product_Manager_Stock_Warehouse_Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/product/manager/stock/warehouse/standard/item/delete' );
	}
	...
	public function saveItem( MShop_Common_Item_Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/product/manager/stock/warehouse/standard/item/insert
				 ...
				 * @since 2014.03
				 * @category Developer
				 * @see mshop/product/manager/stock/warehouse/standard/item/update
				 * @see mshop/product/manager/stock/warehouse/standard/item/newid
				 * @see mshop/product/manager/stock/warehouse/standard/item/delete
				 * @see mshop/product/manager/stock/warehouse/standard/item/search
				 * @see mshop/product/manager/stock/warehouse/standard/item/count
				 */
				$path = 'mshop/product/manager/stock/warehouse/standard/item/insert';
			}
			else
			{
				/** mshop/product/manager/stock/warehouse/standard/item/update
				 ...
				 * @since 2014.03
				 * @category Developer
				 * @see mshop/product/manager/stock/warehouse/standard/item/insert
				 * @see mshop/product/manager/stock/warehouse/standard/item/newid
				 * @see mshop/product/manager/stock/warehouse/standard/item/delete
				 * @see mshop/product/manager/stock/warehouse/standard/item/search
				 * @see mshop/product/manager/stock/warehouse/standard/item/count
				 */
				$path = 'mshop/product/manager/stock/warehouse/standard/item/update';
			}
			...
			{
				/** mshop/product/manager/stock/warehouse/standard/item/newid
				 ...
				 * @see mshop/product/manager/stock/warehouse/standard/item/count
				 */
				$path = 'mshop/product/manager/stock/warehouse/standard/item/newid';
	...
	{
		/** mshop/product/manager/stock/warehouse/standard/item/delete
		 ...
		 * @see mshop/product/manager/stock/warehouse/standard/item/count
		 */
		$path = 'mshop/product/manager/stock/warehouse/standard/item/delete';
	...
	public function searchItems( MW_Common_Criteria_Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			 ...
			 * @see mshop/product/manager/stock/warehouse/standard/item/count
			 */
			$cfgPathSearch = 'mshop/product/manager/stock/warehouse/standard/item/search';

			/** mshop/product/manager/stock/warehouse/standard/item/count
			 ...
			 * @see mshop/product/manager/stock/warehouse/standard/item/search
			 */
			$cfgPathCount = 'mshop/product/manager/stock/warehouse/standard/item/count';
