	...
	implements \Aimeos\MShop\Product\Manager\Stock\Iface
{
	...
	public function saveItem( \Aimeos\MShop\Common\Item\Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/product/manager/stock/standard/insert
				 ...
				 * @since 2014.03
				 * @category Developer
				 * @see mshop/product/manager/stock/standard/update
				 * @see mshop/product/manager/stock/standard/newid
				 * @see mshop/product/manager/stock/standard/delete
				 * @see mshop/product/manager/stock/standard/search
				 * @see mshop/product/manager/stock/standard/count
			...
			{
				/** mshop/product/manager/stock/standard/update
				 ...
				 * @since 2014.03
				 * @category Developer
				 * @see mshop/product/manager/stock/standard/insert
				 * @see mshop/product/manager/stock/standard/newid
				 * @see mshop/product/manager/stock/standard/delete
				 * @see mshop/product/manager/stock/standard/search
				 * @see mshop/product/manager/stock/standard/count
			...
			{
				/** mshop/product/manager/stock/standard/newid
	...
	{
		/** mshop/product/manager/stock/standard/delete
	...
	public function searchItems( \Aimeos\MW\Common\Criteria\Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			...
			/** mshop/product/manager/stock/standard/search
			...
			/** mshop/product/manager/stock/standard/count
	...
	public function increase( $productCode, $warehouseCode, $amount )
	{
		...
		try
		{
			/** mshop/product/manager/stock/standard/stocklevel
