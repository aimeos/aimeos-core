 ...
 * @subpackage Product
 */
class MShop_Product_Manager_Type_Standard
	extends MShop_Common_Manager_Type_Base
	implements MShop_Product_Manager_Type_Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/product/manager/type/standard/item/delete' );
	}
	...
	{
		/** classes/product/manager/type/submanagers
	...
	public function getSubManager( $manager, $name = null )
	{
		 ...
		 *
		 *  MShop_Product_Manager_Type_Standard
		 *
	...
	{
		/** mshop/product/manager/type/standard/item/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/product/manager/type/standard/item/update
		 * @see mshop/product/manager/type/standard/item/newid
		 * @see mshop/product/manager/type/standard/item/delete
		 * @see mshop/product/manager/type/standard/item/search
		 * @see mshop/product/manager/type/standard/item/count
		 */

		/** mshop/product/manager/type/standard/item/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/product/manager/type/standard/item/insert
		 * @see mshop/product/manager/type/standard/item/newid
		 * @see mshop/product/manager/type/standard/item/delete
		 * @see mshop/product/manager/type/standard/item/search
		 * @see mshop/product/manager/type/standard/item/count
		...
		/** mshop/product/manager/type/standard/item/newid
		...
		/** mshop/product/manager/type/standard/item/delete
		...
		/** mshop/product/manager/type/standard/item/search
		...
		/** mshop/product/manager/type/standard/item/count
		...
		return 'mshop/product/manager/type/standard/item/';
	}
