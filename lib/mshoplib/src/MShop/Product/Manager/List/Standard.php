 ...
 * @subpackage Product
 */
class MShop_Product_Manager_List_Standard
	extends MShop_Common_Manager_List_Base
	implements MShop_Product_Manager_List_Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/product/manager/list/default/item/delete' );
	}
	...
	public function getSubManager( $manager, $name = null )
	{
		 ...
		 *
		 *  MShop_Product_Manager_List_Standard
		 *
	...
	protected function getConfigPath()
	{
		 ...
		 * @see mshop/product/manager/list/default/item/aggregate
		 * @see mshop/product/manager/list/default/item/getposmax
		 * @see mshop/product/manager/list/default/item/move
		 * @see mshop/product/manager/list/default/item/updatepos
		 */
		...
		/** mshop/product/manager/list/default/item/aggregate
		...
		/** mshop/product/manager/list/default/item/getposmax
		...
		/** mshop/product/manager/list/default/item/move
		...
		/** mshop/product/manager/list/default/item/updatepos
