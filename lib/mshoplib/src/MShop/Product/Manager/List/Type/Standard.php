 ...
 * @subpackage Product
 */
class MShop_Product_Manager_List_Type_Standard
	extends MShop_Common_Manager_Type_Base
	implements MShop_Product_Manager_List_Type_Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/product/manager/list/type/default/item/delete' );
	}
	...
	public function getSubManager( $manager, $name = null )
	{
		...
		return $this->getSubManagerBase( 'product', 'list/type/' . $manager, $name );
	}
