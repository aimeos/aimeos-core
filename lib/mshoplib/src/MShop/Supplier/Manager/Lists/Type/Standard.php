 ...
 * @subpackage Supplier
 */
class MShop_Supplier_Manager_Lists_Type_Standard
	extends MShop_Common_Manager_Type_Base
	implements MShop_Supplier_Manager_Lists_Type_Iface
{
	...
	{
		$path = 'classes/supplier/manager/lists/type/submanagers';
		foreach( $this->getContext()->getConfig()->get( $path, array() ) as $domain ) {
			$this->getSubManager( $domain )->cleanup( $siteids );
		}

		$this->cleanupBase( $siteids, 'mshop/supplier/manager/lists/type/standard/item/delete' );
	}
	...
	{
		/** classes/supplier/manager/lists/type/submanagers
	...
	{
		/** classes/supplier/manager/lists/type/name
		 ...
		 *
		 *  MShop_Supplier_Manager_Lists_Type_Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  MShop_Supplier_Manager_Lists_Type_Mytype
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/supplier/manager/lists/type/name = Mytype
		 *
	...
	{
		/** mshop/supplier/manager/lists/type/standard/item/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/supplier/manager/lists/type/standard/item/update
		 * @see mshop/supplier/manager/lists/type/standard/item/newid
		 * @see mshop/supplier/manager/lists/type/standard/item/delete
		 * @see mshop/supplier/manager/lists/type/standard/item/search
		 * @see mshop/supplier/manager/lists/type/standard/item/count
		 */

		/** mshop/supplier/manager/lists/type/standard/item/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/supplier/manager/lists/type/standard/item/insert
		 * @see mshop/supplier/manager/lists/type/standard/item/newid
		 * @see mshop/supplier/manager/lists/type/standard/item/delete
		 * @see mshop/supplier/manager/lists/type/standard/item/search
		 * @see mshop/supplier/manager/lists/type/standard/item/count
		...
		/** mshop/supplier/manager/lists/type/standard/item/newid
		...
		/** mshop/supplier/manager/lists/type/standard/item/delete
		...
		/** mshop/supplier/manager/lists/type/standard/item/search
		...
		/** mshop/supplier/manager/lists/type/standard/item/count
		...
		return 'mshop/supplier/manager/lists/type/standard/item/';
	}
