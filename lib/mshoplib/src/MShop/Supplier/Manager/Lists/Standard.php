 ...
 * @subpackage Supplier
 */
class MShop_Supplier_Manager_Lists_Standard
	...
	implements MShop_Supplier_Manager_Lists_Iface
{
	...
	{
		$path = 'classes/supplier/manager/lists/submanagers';
		foreach( $this->getContext()->getConfig()->get( $path, array( 'type' ) ) as $domain ) {
			$this->getSubManager( $domain )->cleanup( $siteids );
		}

		$this->cleanupBase( $siteids, 'mshop/supplier/manager/lists/standard/item/delete' );
	}
	...
	{
		/** classes/supplier/manager/lists/submanagers
	...
	{
		/** classes/supplier/manager/lists/name
		 ...
		 *
		 *  MShop_Supplier_Manager_Lists_Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  MShop_Supplier_Manager_Lists_Mylist
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/supplier/manager/lists/name = Mylist
		 *
	...
	{
		/** mshop/supplier/manager/lists/standard/item/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/supplier/manager/lists/standard/item/update
		 * @see mshop/supplier/manager/lists/standard/item/newid
		 * @see mshop/supplier/manager/lists/standard/item/delete
		 * @see mshop/supplier/manager/lists/standard/item/search
		 * @see mshop/supplier/manager/lists/standard/item/count
		 * @see mshop/supplier/manager/lists/standard/item/aggregate
		 * @see mshop/supplier/manager/lists/standard/item/getposmax
		 * @see mshop/supplier/manager/lists/standard/item/move
		 * @see mshop/supplier/manager/lists/standard/item/updatepos
		 */

		/** mshop/supplier/manager/lists/standard/item/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/supplier/manager/lists/standard/item/insert
		 * @see mshop/supplier/manager/lists/standard/item/newid
		 * @see mshop/supplier/manager/lists/standard/item/delete
		 * @see mshop/supplier/manager/lists/standard/item/search
		 * @see mshop/supplier/manager/lists/standard/item/count
		...
		/** mshop/supplier/manager/lists/standard/item/newid
		...
		/** mshop/supplier/manager/lists/standard/item/delete
		...
		/** mshop/supplier/manager/lists/standard/item/search
		...
		/** mshop/supplier/manager/lists/standard/item/count
		...
		/** mshop/supplier/manager/lists/standard/item/aggregate
		...
		/** mshop/supplier/manager/lists/standard/item/getposmax
		...
		/** mshop/supplier/manager/lists/standard/item/move
		...
		/** mshop/supplier/manager/lists/standard/item/updatepos
		...
		return 'mshop/supplier/manager/lists/standard/item/';
	}
