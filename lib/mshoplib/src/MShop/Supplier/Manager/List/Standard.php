 ...
 * @subpackage Supplier
 */
class MShop_Supplier_Manager_List_Standard
	extends MShop_Common_Manager_List_Base
	implements MShop_Supplier_Manager_List_Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/supplier/manager/list/default/item/delete' );
	}
	...
	public function getSubManager( $manager, $name = null )
	{
		 ...
		 *
		 *  MShop_Supplier_Manager_List_Standard
		 *
	...
	protected function getConfigPath()
	{
		 ...
		 * @see mshop/supplier/manager/list/default/item/aggregate
		 * @see mshop/supplier/manager/list/default/item/getposmax
		 * @see mshop/supplier/manager/list/default/item/move
		 * @see mshop/supplier/manager/list/default/item/updatepos
		 */
		...
		/** mshop/supplier/manager/list/default/item/aggregate
		...
		/** mshop/supplier/manager/list/default/item/getposmax
		...
		/** mshop/supplier/manager/list/default/item/move
		...
		/** mshop/supplier/manager/list/default/item/updatepos
