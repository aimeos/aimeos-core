	...
	implements MShop_Supplier_Manager_Address_Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/supplier/manager/address/default/item/delete' );
	}
	...
	protected function getConfigPath()
	{
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/supplier/manager/address/default/item/update
		 * @see mshop/supplier/manager/address/default/item/newid
		 * @see mshop/supplier/manager/address/default/item/delete
		 * @see mshop/supplier/manager/address/default/item/search
		 * @see mshop/supplier/manager/address/default/item/count
		 */

		/** mshop/supplier/manager/address/default/item/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/supplier/manager/address/default/item/insert
		 * @see mshop/supplier/manager/address/default/item/newid
		 * @see mshop/supplier/manager/address/default/item/delete
		 * @see mshop/supplier/manager/address/default/item/search
		 * @see mshop/supplier/manager/address/default/item/count
		...
		/** mshop/supplier/manager/address/default/item/newid
		...
		/** mshop/supplier/manager/address/default/item/delete
		...
		/** mshop/supplier/manager/address/default/item/search
		...
		/** mshop/supplier/manager/address/default/item/count
