 ...
 * @subpackage Supplier
 */
class MShop_Supplier_Manager_Address_Standard
	...
	implements MShop_Supplier_Manager_Address_Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/supplier/manager/address/standard/item/delete' );
	}
	...
	{
		/** classes/supplier/manager/address/submanagers
	...
	public function getSubManager( $manager, $name = null )
	{
		 ...
		 *
		 *  MShop_Supplier_Manager_Address_Standard
		 *
	...
	{
		return new MShop_Supplier_Item_Address_Standard( $this->getPrefix(), $values );
	}
	...
	{
		/** mshop/supplier/manager/address/standard/item/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/supplier/manager/address/standard/item/update
		 * @see mshop/supplier/manager/address/standard/item/newid
		 * @see mshop/supplier/manager/address/standard/item/delete
		 * @see mshop/supplier/manager/address/standard/item/search
		 * @see mshop/supplier/manager/address/standard/item/count
		 */

		/** mshop/supplier/manager/address/standard/item/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/supplier/manager/address/standard/item/insert
		 * @see mshop/supplier/manager/address/standard/item/newid
		 * @see mshop/supplier/manager/address/standard/item/delete
		 * @see mshop/supplier/manager/address/standard/item/search
		 * @see mshop/supplier/manager/address/standard/item/count
		...
		/** mshop/supplier/manager/address/standard/item/newid
		...
		/** mshop/supplier/manager/address/standard/item/delete
		...
		/** mshop/supplier/manager/address/standard/item/search
		...
		/** mshop/supplier/manager/address/standard/item/count
		...
		return 'mshop/supplier/manager/address/standard/item';
	}
