	...
	implements MShop_Common_Factory_Iface
{
	...
	public static function createManager( MShop_Context_Item_Iface $context, $name = null )
	{
		 ...
		 *
		 *  MShop_Supplier_Manager_Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  MShop_Supplier_Manager_Mymanager
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/supplier/manager/name = Mymanager
		 *
		 ...
		 */
		if ( $name === null ) {
			$name = $context->getConfig()->get('classes/supplier/manager/name', 'Standard');
		}
		...
		$iface = 'MShop_Supplier_Manager_Iface';
		 ...
		 * ("MShop_Common_Manager_Decorator_*") around the supplier manager.
		 *
