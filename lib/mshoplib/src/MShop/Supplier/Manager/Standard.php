	...
	implements \Aimeos\MShop\Supplier\Manager\Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/supplier/manager/standard/item/delete' );
	}
	...
	{
		/** mshop/supplier/manager/standard/item/delete
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/supplier/manager/standard/item/insert
		 * @see mshop/supplier/manager/standard/item/update
		 * @see mshop/supplier/manager/standard/item/newid
		 * @see mshop/supplier/manager/standard/item/search
		 * @see mshop/supplier/manager/standard/item/count
		 */
		$path = 'mshop/supplier/manager/standard/item/delete';
	...
	public function saveItem( \Aimeos\MShop\Common\Item\Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/supplier/manager/standard/item/insert
				 ...
				 * @see mshop/supplier/manager/standard/item/update
				 * @see mshop/supplier/manager/standard/item/newid
				 * @see mshop/supplier/manager/standard/item/delete
				 * @see mshop/supplier/manager/standard/item/search
				 * @see mshop/supplier/manager/standard/item/count
				 */
				$path = 'mshop/supplier/manager/standard/item/insert';
			}
			else
			{
				/** mshop/supplier/manager/standard/item/update
				 ...
				 * @see mshop/supplier/manager/standard/item/count
				 */
				$path = 'mshop/supplier/manager/standard/item/update';
			}
			...
			{
				/** mshop/supplier/manager/standard/item/newid
				 ...
				 * @see mshop/supplier/manager/standard/item/count
				 */
				$path = 'mshop/supplier/manager/standard/item/newid';
	...
	public function searchItems( \Aimeos\MW\Common\Criteria\Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			 ...
			 * @see mshop/supplier/manager/standard/item/count
			 */
			$cfgPathSearch = 'mshop/supplier/manager/standard/item/search';

			/** mshop/supplier/manager/standard/item/count
			 ...
			 * @see mshop/supplier/manager/standard/item/search
			 */
			$cfgPathCount =  'mshop/supplier/manager/standard/item/count';
