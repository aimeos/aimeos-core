 ...
 * @subpackage Catalog
 */
class MShop_Catalog_Manager_List_Standard
	extends MShop_Common_Manager_List_Base
	implements MShop_Catalog_Manager_List_Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/catalog/manager/list/default/item/delete' );
	}
	...
	public function getSubManager( $manager, $name = null )
	{
		 ...
		 *
		 *  MShop_Catalog_Manager_List_Standard
		 *
		...
		return $this->getSubManagerBase( 'catalog', 'list/' . $manager, $name );
	}
	...
	protected function getConfigPath()
	{
		 ...
		 * @see mshop/catalog/manager/list/default/item/aggregate
		 * @see mshop/catalog/manager/list/default/item/getposmax
		 * @see mshop/catalog/manager/list/default/item/move
		 * @see mshop/catalog/manager/list/default/item/updatepos
		 */
		...
		/** mshop/catalog/manager/list/default/item/aggregate
		...
		/** mshop/catalog/manager/list/default/item/getposmax
		...
		/** mshop/catalog/manager/list/default/item/move
		...
		/** mshop/catalog/manager/list/default/item/updatepos
