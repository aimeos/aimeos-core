	...
	implements \Aimeos\MShop\Catalog\Manager\Lists\Iface
{
	...
	{
		$path = 'classes/catalog/manager/lists/submanagers';
		foreach( $this->getContext()->getConfig()->get( $path, array( 'type' ) ) as $domain ) {
			$this->getSubManager( $domain )->cleanup( $siteids );
		}

		$this->cleanupBase( $siteids, 'mshop/catalog/manager/lists/standard/item/delete' );
	}
	...
	{
		/** classes/catalog/manager/lists/submanagers
	...
	{
		/** classes/catalog/manager/lists/name
		 ...
		 *
		 *  classes/catalog/manager/lists/name = Mylist
		 *
	...
	{
		/** mshop/catalog/manager/lists/standard/item/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/catalog/manager/lists/standard/item/update
		 * @see mshop/catalog/manager/lists/standard/item/newid
		 * @see mshop/catalog/manager/lists/standard/item/delete
		 * @see mshop/catalog/manager/lists/standard/item/search
		 * @see mshop/catalog/manager/lists/standard/item/count
		 * @see mshop/catalog/manager/lists/standard/item/aggregate
		 * @see mshop/catalog/manager/lists/standard/item/getposmax
		 * @see mshop/catalog/manager/lists/standard/item/move
		 * @see mshop/catalog/manager/lists/standard/item/updatepos
		 */

		/** mshop/catalog/manager/lists/standard/item/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/catalog/manager/lists/standard/item/insert
		 * @see mshop/catalog/manager/lists/standard/item/newid
		 * @see mshop/catalog/manager/lists/standard/item/delete
		 * @see mshop/catalog/manager/lists/standard/item/search
		 * @see mshop/catalog/manager/lists/standard/item/count
		...
		/** mshop/catalog/manager/lists/standard/item/newid
		...
		/** mshop/catalog/manager/lists/standard/item/delete
		...
		/** mshop/catalog/manager/lists/standard/item/search
		...
		/** mshop/catalog/manager/lists/standard/item/count
		...
		/** mshop/catalog/manager/lists/standard/item/aggregate
		...
		/** mshop/catalog/manager/lists/standard/item/getposmax
		...
		/** mshop/catalog/manager/lists/standard/item/move
		...
		/** mshop/catalog/manager/lists/standard/item/updatepos
		...
		return 'mshop/catalog/manager/lists/standard/item/';
	}
