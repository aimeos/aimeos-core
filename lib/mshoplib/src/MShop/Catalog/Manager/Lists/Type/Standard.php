 ...
 * @subpackage Catalog
 */
class MShop_Catalog_Manager_Lists_Type_Standard
	...
	implements MShop_Catalog_Manager_Lists_Type_Iface
{
	...
	{
		$path = 'classes/catalog/manager/lists/type/submanagers';
		foreach( $this->getContext()->getConfig()->get( $path, array() ) as $domain ) {
			$this->getSubManager( $domain )->cleanup( $siteids );
		}

		$this->cleanupBase( $siteids, 'mshop/catalog/manager/lists/type/standard/item/delete' );
	}
	 ...
	 * @return array List of catalog items implementing MW_Common_Criteria_Attribute_Iface
	 */
	public function getSearchAttributes( $withsub = true )
	{
		/** classes/catalog/manager/lists/type/submanagers
	...
	{
		/** classes/catalog/manager/lists/type/name
		 ...
		 *
		 *  MShop_Catalog_Manager_Lists_Type_Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  MShop_Catalog_Manager_Lists_Type_Mytype
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/catalog/manager/lists/type/name = Mytype
		 *
	...
	{
		/** mshop/catalog/manager/lists/type/standard/item/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/catalog/manager/lists/type/standard/item/update
		 * @see mshop/catalog/manager/lists/type/standard/item/newid
		 * @see mshop/catalog/manager/lists/type/standard/item/delete
		 * @see mshop/catalog/manager/lists/type/standard/item/search
		 * @see mshop/catalog/manager/lists/type/standard/item/count
		 */

		/** mshop/catalog/manager/lists/type/standard/item/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/catalog/manager/lists/type/standard/item/insert
		 * @see mshop/catalog/manager/lists/type/standard/item/newid
		 * @see mshop/catalog/manager/lists/type/standard/item/delete
		 * @see mshop/catalog/manager/lists/type/standard/item/search
		 * @see mshop/catalog/manager/lists/type/standard/item/count
		...
		/** mshop/catalog/manager/lists/type/standard/item/newid
		...
		/** mshop/catalog/manager/lists/type/standard/item/delete
		...
		/** mshop/catalog/manager/lists/type/standard/item/search
		...
		/** mshop/catalog/manager/lists/type/standard/item/count
		...
		return 'mshop/catalog/manager/lists/type/standard/item/';
	}
