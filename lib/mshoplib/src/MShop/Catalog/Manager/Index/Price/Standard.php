...
class Standard
	...
	implements \Aimeos\MShop\Catalog\Manager\Index\Price\Iface
{
	...
	public function getSubManager( $manager, $name = null )
	{
		 ...
		 *
		 *  \Aimeos\MShop\Catalog\Manager\Index\Price\Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  \Aimeos\MShop\Catalog\Manager\Index\Price\Myprice
		 *
		 ...
		 * ("\Aimeos\MShop\Common\Manager\Decorator\*") around the catalog index price manager.
		 *
