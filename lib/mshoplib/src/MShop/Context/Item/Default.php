...
class MShop_Context_Item_Default implements MShop_Context_Item_Interface
{
	...
	public function getCache()
	{
		if( !isset( $this->_cache ) ) {
			throw new MShop_Exception( sprintf( 'An error occured in the context domain. Cache object not available.' ) );
		}
	...
	public function getConfig()
	{
		if( !isset( $this->_config ) ) {
			throw new MShop_Exception( sprintf( 'An error occured in the context domain. Configuration object not available.' ) );
		}
	...
	{
		if( !isset( $this->_dbm ) ) {
			throw new MShop_Exception( sprintf( 'An error occured in the context domain. Database manager object not available.' ) );
		}
	...
	{
		if( !isset( $this->_i18n ) ) {
			throw new MShop_Exception( sprintf( 'An error occured in the context domain. Internationalization object not available.' ) );
		}
