...
class MShop_Context_Item_Default implements MShop_Context_Item_Interface
{
	...
	public function getCache()
	{
		if( !isset( $this->_cache ) ) {
			throw new MShop_Exception( sprintf( 'No cache object available' ) );
		}
	...
	public function getConfig()
	{
		if( !isset( $this->_config ) ) {
			throw new MShop_Exception( sprintf( 'No configuration object available' ) );
		}
	...
	{
		if( !isset( $this->_dbm ) ) {
			throw new MShop_Exception( sprintf( 'No database manager object available' ) );
		}
	...
	{
		if( !isset( $this->_i18n ) ) {
			throw new MShop_Exception( sprintf( 'No internationalization object available' ) );
		}
	...
	public function getLocale()
	{
		if( !isset( $this->_locale ) ) {
			throw new MShop_Exception( sprintf( 'No locale object available' ) );
		}
	...
	public function getLogger()
	{
		if( !isset( $this->_logger ) ) {
			throw new MShop_Exception( sprintf( 'No log manager object available' ) );
		}
	...
	public function getSession()
	{
		if( !isset( $this->_session ) ) {
			throw new MShop_Exception( sprintf( 'No session object available' ) );
		}
