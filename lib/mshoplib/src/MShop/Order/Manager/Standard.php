	...
	implements MShop_Order_Manager_Iface
{
	...
	public function aggregate( MW_Common_Criteria_Iface $search, $key )
	{
		 ...
		 * @since 2014.09
		 * @category Developer
		 * @see mshop/order/manager/standard/item/insert
		 * @see mshop/order/manager/standard/item/update
		 * @see mshop/order/manager/standard/item/newid
		 * @see mshop/order/manager/standard/item/delete
		 * @see mshop/order/manager/standard/item/search
		 * @see mshop/order/manager/standard/item/count
		 */
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/order/manager/standard/item/delete' );
	}
	...
	public function saveItem( MShop_Common_Item_Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/order/manager/standard/item/insert
				 ...
				 * @see mshop/order/manager/standard/item/count
				 */
				$path = 'mshop/order/manager/standard/item/insert';
			}
			else
			{
				/** mshop/order/manager/standard/item/update
				 ...
				 * @see mshop/order/manager/standard/item/count
				 */
				$path = 'mshop/order/manager/standard/item/update';
			}
			...
			{
				/** mshop/order/manager/standard/item/newid
				 ...
				 * @see mshop/order/manager/standard/item/count
				 */
				$path = 'mshop/order/manager/standard/item/newid';
	...
	{
		/** mshop/order/manager/standard/item/delete
		 ...
		 * @see mshop/order/manager/standard/item/count
		 */
		$path = 'mshop/order/manager/standard/item/delete';
	...
	public function searchItems( MW_Common_Criteria_Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			 ...
			 * @see mshop/order/manager/standard/item/count
			 */
			$cfgPathSearch = 'mshop/order/manager/standard/item/search';

			/** mshop/order/manager/standard/item/count
			 ...
			 * @see mshop/order/manager/standard/item/search
			 */
			$cfgPathCount = 'mshop/order/manager/standard/item/count';
