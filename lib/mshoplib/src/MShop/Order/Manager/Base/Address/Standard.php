 ...
 * @subpackage Order
 */
class MShop_Order_Manager_Base_Address_Standard
	...
	implements MShop_Order_Manager_Base_Address_Iface
{
	...
	{
		/** mshop/order/manager/base/address/standard/aggregate
		 ...
		 * @since 2014.09
		 * @category Developer
		 * @see mshop/order/manager/base/address/standard/item/insert
		 * @see mshop/order/manager/base/address/standard/item/update
		 * @see mshop/order/manager/base/address/standard/item/newid
		 * @see mshop/order/manager/base/address/standard/item/delete
		 * @see mshop/order/manager/base/address/standard/item/search
		 * @see mshop/order/manager/base/address/standard/item/count
		 */
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/order/manager/base/address/standard/item/delete' );
	}
	...
	public function saveItem( MShop_Common_Item_Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/order/manager/base/address/standard/item/insert
				 ...
				 * @see mshop/order/manager/base/address/standard/item/count
				 */
				$path = 'mshop/order/manager/base/address/standard/item/insert';
			}
			else
			{
				/** mshop/order/manager/base/address/standard/item/update
				 ...
				 * @see mshop/order/manager/base/address/standard/item/count
				 */
				$path = 'mshop/order/manager/base/address/standard/item/update';
			}
			...
			{
				/** mshop/order/manager/base/address/standard/item/newid
				 ...
				 * @see mshop/order/manager/base/address/standard/item/count
				 */
				$path = 'mshop/order/manager/base/address/standard/item/newid';
	...
	{
		/** mshop/order/manager/base/address/standard/item/delete
		 ...
		 * @see mshop/order/manager/base/address/standard/item/count
		 */
		$path = 'mshop/order/manager/base/address/standard/item/delete';
	...
	public function searchItems( MW_Common_Criteria_Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			...
			/** mshop/order/manager/base/address/standard/item/search
			 ...
			 * @see mshop/order/manager/base/address/standard/item/count
			 */
			$cfgPathSearch = 'mshop/order/manager/base/address/standard/item/search';

			/** mshop/order/manager/base/address/standard/item/count
			 ...
			 * @see mshop/order/manager/base/address/standard/item/search
			 */
			$cfgPathCount = 'mshop/order/manager/base/address/standard/item/count';
	...
	public function getSubManager( $manager, $name = null )
	{
		 ...
		 *
		 *  MShop_Order_Manager_Base_Address_Standard
		 *
	 ...
	 * Creates new order base address item object.
	 *
	 * @see MShop_Order_Item_Base_Address_Standard Default order base address item
	 * @param array $values Possible optional array keys can be given: id, type, firstname, lastname
	 * @return MShop_Order_Item_Base_Address_Standard New order base address item object
	 */
	protected function createItemBase( array $values = array() )
	{
		return new MShop_Order_Item_Base_Address_Standard( $values );
	}
}
