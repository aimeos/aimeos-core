 ...
 * @subpackage Order
 */
class MShop_Order_Manager_Base_Product_Attribute_Standard
	extends MShop_Common_Manager_Base
	implements MShop_Order_Manager_Base_Product_Attribute_Iface
{
	...
	{
		/** mshop/order/manager/base/product/attribute/standard/aggregate
		 ...
		 * @since 2014.09
		 * @category Developer
		 * @see mshop/order/manager/base/product/attribute/standard/item/insert
		 * @see mshop/order/manager/base/product/attribute/standard/item/update
		 * @see mshop/order/manager/base/product/attribute/standard/item/newid
		 * @see mshop/order/manager/base/product/attribute/standard/item/delete
		 * @see mshop/order/manager/base/product/attribute/standard/item/search
		 * @see mshop/order/manager/base/product/attribute/standard/item/count
		 */
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/order/manager/base/product/attribute/standard/item/delete' );
	}
	 ...
	 *
	 * @return MShop_Order_Item_Base_Product_Attribute_Iface New media object
	 */
	 ...
	 * @return MShop_Order_Item_Base_Product_Attribute_Iface Returns order base product attribute item of the given id
	 ...
	 *
	 * @param MShop_Order_Item_Base_Product_Attribute_Iface $item New item that should
	 * be saved to the storage
	 * @param boolean $fetch True if the new ID should be returned in the item
	 */
	public function saveItem( MShop_Common_Item_Iface $item, $fetch = true )
	{
		$iface = 'MShop_Order_Item_Base_Product_Attribute_Iface';
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/order/manager/base/product/attribute/standard/item/insert
				 ...
				 * @see mshop/order/manager/base/product/attribute/standard/item/count
				 */
				$path = 'mshop/order/manager/base/product/attribute/standard/item/insert';
			}
			else
			{
				/** mshop/order/manager/base/product/attribute/standard/item/update
				 ...
				 * @see mshop/order/manager/base/product/attribute/standard/item/count
				 */
				$path = 'mshop/order/manager/base/product/attribute/standard/item/update';
			}
			...
			{
				/** mshop/order/manager/base/product/attribute/standard/item/newid
				 ...
				 * @see mshop/order/manager/base/product/attribute/standard/item/count
				 */
				$path = 'mshop/order/manager/base/product/attribute/standard/item/newid';
	...
	{
		/** mshop/order/manager/base/product/attribute/standard/item/delete
		 ...
		 * @see mshop/order/manager/base/product/attribute/standard/item/count
		 */
		$path = 'mshop/order/manager/base/product/attribute/standard/item/delete';
	...
	public function getSubManager( $manager, $name = null )
	{
		 ...
		 *
		 *  MShop_Order_Manager_Base_Product_Attribute_Standard
		 *
	 ...
	 * @return array List of products implementing MShop_Order_Item_Base_Product_Attribute_Iface
	 */
	public function searchItems( MW_Common_Criteria_Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			...
			/** mshop/order/manager/base/product/attribute/standard/item/search
			 ...
			 * @see mshop/order/manager/base/product/attribute/standard/item/count
			 */
			$cfgPathSearch = 'mshop/order/manager/base/product/attribute/standard/item/search';

			/** mshop/order/manager/base/product/attribute/standard/item/count
			 ...
			 * @see mshop/order/manager/base/product/attribute/standard/item/search
			 */
			$cfgPathCount = 'mshop/order/manager/base/product/attribute/standard/item/count';
	 ...
	 * @return MShop_Order_Item_Base_Product_Attribute_Iface
	 */
	protected function createItemBase( array $values = array() )
	{
		return new MShop_Order_Item_Base_Product_Attribute_Standard( $values );
	}
}
