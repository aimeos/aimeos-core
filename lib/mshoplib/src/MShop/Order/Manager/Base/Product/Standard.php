 ...
 * @subpackage Order
 */
class MShop_Order_Manager_Base_Product_Standard
	...
	implements MShop_Order_Manager_Base_Product_Iface
{
	...
	public function aggregate( MW_Common_Criteria_Iface $search, $key )
	{
		 ...
		 * @since 2014.09
		 * @category Developer
		 * @see mshop/order/manager/base/product/standard/item/insert
		 * @see mshop/order/manager/base/product/standard/item/update
		 * @see mshop/order/manager/base/product/standard/item/newid
		 * @see mshop/order/manager/base/product/standard/item/delete
		 * @see mshop/order/manager/base/product/standard/item/search
		 * @see mshop/order/manager/base/product/standard/item/count
		 */
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/order/manager/base/product/standard/item/delete' );
	}
	...
	public function saveItem( MShop_Common_Item_Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/order/manager/base/product/standard/item/insert
				 ...
				 * @see mshop/order/manager/base/product/standard/item/count
				 */
				$path = 'mshop/order/manager/base/product/standard/item/insert';
			}
			else
			{
				/** mshop/order/manager/base/product/standard/item/update
				 ...
				 * @see mshop/order/manager/base/product/standard/item/count
				 */
				$path = 'mshop/order/manager/base/product/standard/item/update';
			}
			...
			{
				/** mshop/order/manager/base/product/standard/item/newid
				 ...
				 * @see mshop/order/manager/base/product/standard/item/count
				 */
				$path = 'mshop/order/manager/base/product/standard/item/newid';
	...
	{
		/** mshop/order/manager/base/product/standard/item/delete
		 ...
		 * @see mshop/order/manager/base/product/standard/item/count
		 */
		$path = 'mshop/order/manager/base/product/standard/item/delete';
	...
	public function getSubManager( $manager, $name = null )
	{
		 ...
		 *
		 *  MShop_Order_Manager_Base_Product_Standard
		 *
	...
	public function searchItems( MW_Common_Criteria_Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			...
			/** mshop/order/manager/base/product/standard/item/search
			 ...
			 * @see mshop/order/manager/base/product/standard/item/count
			 */
			$cfgPathSearch = 'mshop/order/manager/base/product/standard/item/search';

			/** mshop/order/manager/base/product/standard/item/count
			 ...
			 * @see mshop/order/manager/base/product/standard/item/search
			 */
			$cfgPathCount = 'mshop/order/manager/base/product/standard/item/count';
	...
	{
		return new MShop_Order_Item_Base_Product_Standard( $price, $values, $attributes );
	}
