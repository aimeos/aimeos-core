	...
	implements \Aimeos\MShop\Order\Manager\Base\Service\Iface
{
	...
	public function aggregate( \Aimeos\MW\Common\Criteria\Iface $search, $key )
	{
		 ...
		 * @since 2014.09
		 * @category Developer
		 * @see mshop/order/manager/base/service/standard/item/insert
		 * @see mshop/order/manager/base/service/standard/item/update
		 * @see mshop/order/manager/base/service/standard/item/newid
		 * @see mshop/order/manager/base/service/standard/item/delete
		 * @see mshop/order/manager/base/service/standard/item/search
		 * @see mshop/order/manager/base/service/standard/item/count
		 */
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/order/manager/base/service/standard/item/delete' );
	}
	...
	public function saveItem( \Aimeos\MShop\Common\Item\Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/order/manager/base/service/standard/item/insert
				 ...
				 * @see mshop/order/manager/base/service/standard/item/count
				 */
				$path = 'mshop/order/manager/base/service/standard/item/insert';
			}
			else
			{
				/** mshop/order/manager/base/service/standard/item/update
				 ...
				 * @see mshop/order/manager/base/service/standard/item/count
				 */
				$path = 'mshop/order/manager/base/service/standard/item/update';
			}
			...
			{
				/** mshop/order/manager/base/service/standard/item/newid
				 ...
				 * @see mshop/order/manager/base/service/standard/item/count
				 */
				$path = 'mshop/order/manager/base/service/standard/item/newid';
	...
	{
		/** mshop/order/manager/base/service/standard/item/delete
		 ...
		 * @see mshop/order/manager/base/service/standard/item/count
		 */
		$path = 'mshop/order/manager/base/service/standard/item/delete';
	...
	public function searchItems( \Aimeos\MW\Common\Criteria\Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			 ...
			 * @see mshop/order/manager/base/service/standard/item/count
			 */
			$cfgPathSearch = 'mshop/order/manager/base/service/standard/item/search';

			/** mshop/order/manager/base/service/standard/item/count
			 ...
			 * @see mshop/order/manager/base/service/standard/item/search
			 */
			$cfgPathCount = 'mshop/order/manager/base/service/standard/item/count';
