	...
	implements \Aimeos\MShop\Order\Manager\Base\Service\Attribute\Iface
{
	...
	public function aggregate( \Aimeos\MW\Criteria\Iface $search, $key )
	{
		 ...
		 * @since 2014.09
		 * @category Developer
		 * @see mshop/order/manager/base/service/attribute/standard/insert
		 * @see mshop/order/manager/base/service/attribute/standard/update
		 * @see mshop/order/manager/base/service/attribute/standard/newid
		 * @see mshop/order/manager/base/service/attribute/standard/delete
		 * @see mshop/order/manager/base/service/attribute/standard/search
		 * @see mshop/order/manager/base/service/attribute/standard/count
		 */
	...
	public function saveItem( \Aimeos\MShop\Common\Item\Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/order/manager/base/service/attribute/standard/insert
			...
			{
				/** mshop/order/manager/base/service/attribute/standard/update
			...
			{
				/** mshop/order/manager/base/service/attribute/standard/newid
	...
	{
		/** mshop/order/manager/base/service/attribute/standard/delete
	...
	public function searchItems( \Aimeos\MW\Criteria\Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			...
			/** mshop/order/manager/base/service/attribute/standard/search
			...
			/** mshop/order/manager/base/service/attribute/standard/count
