	...
	implements \Aimeos\MShop\Order\Manager\Base\Service\Attribute\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		return $this->cleanupBase( $siteids, 'mshop/order/manager/base/service/attribute/standard/delete' );
	}
	...
	{
		self::checkClass( \Aimeos\MShop\Order\Item\Base\Service\Attribute\Iface::class, $item );
