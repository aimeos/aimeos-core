	...
	implements MShop_Order_Manager_Base_Coupon_Iface
{
	...
	public function aggregate( MW_Common_Criteria_Iface $search, $key )
	{
		 ...
		 * @since 2014.09
		 * @category Developer
		 * @see mshop/order/manager/base/coupon/standard/item/insert
		 * @see mshop/order/manager/base/coupon/standard/item/update
		 * @see mshop/order/manager/base/coupon/standard/item/newid
		 * @see mshop/order/manager/base/coupon/standard/item/delete
		 * @see mshop/order/manager/base/coupon/standard/item/search
		 * @see mshop/order/manager/base/coupon/standard/item/count
		 */
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/order/manager/base/coupon/standard/item/delete' );
	}
	...
	public function saveItem( MShop_Common_Item_Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/order/manager/base/coupon/standard/item/insert
				 ...
				 * @see mshop/order/manager/base/coupon/standard/item/count
				 */
				$path = 'mshop/order/manager/base/coupon/standard/item/insert';
			}
			else
			{
				/** mshop/order/manager/base/coupon/standard/item/update
				 ...
				 * @see mshop/order/manager/base/coupon/standard/item/count
				 */
				$path = 'mshop/order/manager/base/coupon/standard/item/update';
			}
			...
			{
				/** mshop/order/manager/base/coupon/standard/item/newid
				 ...
				 * @see mshop/order/manager/base/coupon/standard/item/count
				 */
				$path = 'mshop/order/manager/base/coupon/standard/item/newid';
	...
	{
		/** mshop/order/manager/base/coupon/standard/item/delete
		 ...
		 * @see mshop/order/manager/base/coupon/standard/item/count
		 */
		$path = 'mshop/order/manager/base/coupon/standard/item/delete';
	...
	public function searchItems( MW_Common_Criteria_Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			 ...
			 * @see mshop/order/manager/base/coupon/standard/item/count
			 */
			$cfgPathSearch = 'mshop/order/manager/base/coupon/standard/item/search';

			/** mshop/order/manager/base/coupon/standard/item/count
			 ...
			 * @see mshop/order/manager/base/coupon/standard/item/search
			 */
			$cfgPathCount = 'mshop/order/manager/base/coupon/standard/item/count';
