	...
	implements \Aimeos\MShop\Order\Manager\Base\Coupon\Iface
{
	...
	public function aggregate( \Aimeos\MW\Common\Criteria\Iface $search, $key )
	{
		 ...
		 * @since 2014.09
		 * @category Developer
		 * @see mshop/order/manager/base/coupon/standard/insert
		 * @see mshop/order/manager/base/coupon/standard/update
		 * @see mshop/order/manager/base/coupon/standard/newid
		 * @see mshop/order/manager/base/coupon/standard/delete
		 * @see mshop/order/manager/base/coupon/standard/search
		 * @see mshop/order/manager/base/coupon/standard/count
		 */
	...
	public function saveItem( \Aimeos\MShop\Common\Item\Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/order/manager/base/coupon/standard/insert
			...
			{
				/** mshop/order/manager/base/coupon/standard/update
			...
			{
				/** mshop/order/manager/base/coupon/standard/newid
	...
	{
		/** mshop/order/manager/base/coupon/standard/delete
	...
	public function searchItems( \Aimeos\MW\Common\Criteria\Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			...
			/** mshop/order/manager/base/coupon/standard/search
			...
			/** mshop/order/manager/base/coupon/standard/count
