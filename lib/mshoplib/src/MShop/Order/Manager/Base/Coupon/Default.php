	...
	implements MShop_Order_Manager_Base_Coupon_Interface
{
	...
	{
		/** mshop/order/manager/base/coupon/default/aggregate
		 ...
		 * @since 2014.09
		 * @category Developer
		 * @see mshop/order/manager/base/coupon/default/item/insert
		 * @see mshop/order/manager/base/coupon/default/item/update
		 * @see mshop/order/manager/base/coupon/default/item/newid
		 * @see mshop/order/manager/base/coupon/default/item/delete
		 * @see mshop/order/manager/base/coupon/default/item/search
	...
	public function saveItem( MShop_Common_Item_Interface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/order/manager/base/coupon/default/item/insert
				 ...
				 * @see mshop/order/manager/base/coupon/default/item/count
				 */
				$path = 'mshop/order/manager/base/coupon/default/item/insert';
			}
			else
			{
				/** mshop/order/manager/base/coupon/default/item/update
			...
			{
				/** mshop/order/manager/base/coupon/default/item/newid
	...
	{
		/** mshop/order/manager/base/coupon/default/item/delete
	...
	public function searchItems( MW_Common_Criteria_Interface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			...
			/** mshop/order/manager/base/coupon/default/item/count
