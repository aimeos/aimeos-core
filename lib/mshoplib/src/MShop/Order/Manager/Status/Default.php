	...
	implements MShop_Order_Manager_Status_Interface
{
	...
	public function saveItem( MShop_Common_Item_Interface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/order/manager/status/default/item/insert
				 ...
				 * @see mshop/order/manager/status/default/item/count
				 */
				$path = 'mshop/order/manager/status/default/item/insert';
			}
			else
			{
				/** mshop/order/manager/status/default/item/update
			...
			{
				/** mshop/order/manager/status/default/item/newid
	...
	{
		/** mshop/order/manager/status/default/item/delete
	...
	public function searchItems( MW_Common_Criteria_Interface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			...
			/** mshop/order/manager/status/default/item/count
