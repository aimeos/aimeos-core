	...
	implements \Aimeos\MShop\Index\Manager\Attribute\Iface
{
	...
	public function getSearchAttributes( $withsub = true )
	{
		...
		/** classes/index/manager/attribute/submanagers
		 ...
		 * @category Developer
		 */
		$path = 'classes/index/manager/attribute/submanagers';
	...
	{
		/** classes/index/manager/attribute/name
		 ...
		 *
		 *  classes/index/manager/attribute/name = Myattribute
		 *
