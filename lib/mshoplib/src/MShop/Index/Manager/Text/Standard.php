	...
	implements \Aimeos\MShop\Index\Manager\Text\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	private $searchConfig = array(
		...
		'index.text:relevance' => array(
			...
			'internalcode' => ':site AND mindte."listtype" IN ($1)
				...
				AND mindte."domain" = \'product\' AND POSITION( $3 IN mindte."value" )',
		...
		'index.text.value' => array(
			...
			'internalcode' => ':site AND mindte."listtype" IN ($1)
				AND ( mindte."langid" = $2 OR mindte."langid" IS NULL )
				AND mindte."type" IN ($3) AND mindte."domain" = \'product\'
				AND mindte."domain" = $4 AND mindte."value"',
	...
	public function __construct( \Aimeos\MShop\Context\Item\Iface $context )
	{
		...
		$this->replaceSiteMarker( $this->searchConfig['sort:index.text:relevance'], 'mindte."siteid"', $siteIds );
