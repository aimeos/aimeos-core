	...
	implements \Aimeos\MShop\Tag\Manager\Iface
{
	...
	public function saveItem( \Aimeos\MShop\Common\Item\Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/tag/manager/standard/insert
				 ...
				 * @since 2015.12
				 * @category Developer
				 * @see mshop/tag/manager/standard/update
				 * @see mshop/tag/manager/standard/newid
				 * @see mshop/tag/manager/standard/delete
				 * @see mshop/tag/manager/standard/search
				 * @see mshop/tag/manager/standard/count
				 */
				$path = 'mshop/tag/manager/standard/insert';
			}
			else
			{
				/** mshop/tag/manager/standard/update
				 ...
				 * @since 2015.12
				 * @category Developer
				 * @see mshop/tag/manager/standard/insert
				 * @see mshop/tag/manager/standard/newid
				 * @see mshop/tag/manager/standard/delete
				 * @see mshop/tag/manager/standard/search
				 * @see mshop/tag/manager/standard/count
			...
			{
				/** mshop/tag/manager/standard/newid
	...
	{
		/** mshop/tag/manager/standard/delete
	...
	public function searchItems( \Aimeos\MW\Criteria\Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			...
			/** mshop/tag/manager/standard/search
			...
			/** mshop/tag/manager/standard/count
