	...
	implements \Aimeos\MShop\Tag\Manager\Type\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		return $this->cleanupBase( $siteids, 'mshop/tag/manager/type/standard/delete' );
	}
	...
	protected function getConfigPath()
	{
		 ...
		 *
		 * @see mshop/tag/manager/type/standard/insert/ansi
		 */
		 ...
		 * @since 2015.12
		 * @category Developer
		 * @see mshop/tag/manager/type/standard/update/ansi
		 * @see mshop/tag/manager/type/standard/newid/ansi
		 * @see mshop/tag/manager/type/standard/delete/ansi
		 * @see mshop/tag/manager/type/standard/search/ansi
		 * @see mshop/tag/manager/type/standard/count/ansi
		 */
		...
		/** mshop/tag/manager/type/standard/newid/mysql
