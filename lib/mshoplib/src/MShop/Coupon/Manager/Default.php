	...
	implements MShop_Coupon_Manager_Interface
{
	...
	public function getSearchAttributes( $withsub = true )
	{
		...
		return $this->_getSearchAttributes( $this->_searchConfig, $path, array( 'code' ), $withsub );
	}
	...
	public function getSubManager( $manager, $name = null )
	{
		 ...
		 *
		 * Each default coupon manager can be replaced by an alternative imlementation.
		 ...
		 *
		 *  MShop_Coupon_Manager_Mycoupon
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/coupon/manager/name = Mycoupon
		 *
