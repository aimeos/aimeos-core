 ...
 * @subpackage Coupon
 */
class MShop_Coupon_Manager_Standard
	...
	implements MShop_Coupon_Manager_Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/coupon/manager/standard/item/delete' );
	}
	...
	public function saveItem( MShop_Common_Item_Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/coupon/manager/standard/item/insert
				 ...
				 * @since 2014.03
				 * @category Developer
				 * @see mshop/coupon/manager/standard/item/update
				 * @see mshop/coupon/manager/standard/item/newid
				 * @see mshop/coupon/manager/standard/item/delete
				 * @see mshop/coupon/manager/standard/item/search
				 * @see mshop/coupon/manager/standard/item/count
				 */
				$path = 'mshop/coupon/manager/standard/item/insert';
			}
			else
			{
				/** mshop/coupon/manager/standard/item/update
				 ...
				 * @since 2014.03
				 * @category Developer
				 * @see mshop/coupon/manager/standard/item/insert
				 * @see mshop/coupon/manager/standard/item/newid
				 * @see mshop/coupon/manager/standard/item/delete
				 * @see mshop/coupon/manager/standard/item/search
				 * @see mshop/coupon/manager/standard/item/count
				 */
				$path = 'mshop/coupon/manager/standard/item/update';
			}
			...
			{
				/** mshop/coupon/manager/standard/item/newid
				 ...
				 * @see mshop/coupon/manager/standard/item/count
				 */
				$path = 'mshop/coupon/manager/standard/item/newid';
	...
	{
		/** mshop/coupon/manager/standard/item/delete
		 ...
		 * @see mshop/coupon/manager/standard/item/count
		 */
		$path = 'mshop/coupon/manager/standard/item/delete';
	...
	public function searchItems( MW_Common_Criteria_Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			...
			/** mshop/coupon/manager/standard/item/search
			 ...
			 * @see mshop/coupon/manager/standard/item/count
			 */
			$cfgPathSearch = 'mshop/coupon/manager/standard/item/search';

			/** mshop/coupon/manager/standard/item/count
			 ...
			 * @see mshop/coupon/manager/standard/item/search
			 */
			$cfgPathCount = 'mshop/coupon/manager/standard/item/count';
	 ...
	 * @return MShop_Coupon_Item_Standard Returns a new created coupon item instance
	 */
	protected function createItemBase( array $values = array() )
	{
		return new MShop_Coupon_Item_Standard( $values );
	}
}