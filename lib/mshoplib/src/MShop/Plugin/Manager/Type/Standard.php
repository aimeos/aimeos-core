	...
	implements \Aimeos\MShop\Plugin\Manager\Type\Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/plugin/manager/type/standard/item/delete' );
	}
	...
	{
		/** mshop/plugin/manager/type/standard/item/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/plugin/manager/type/standard/item/update
		 * @see mshop/plugin/manager/type/standard/item/newid
		 * @see mshop/plugin/manager/type/standard/item/delete
		 * @see mshop/plugin/manager/type/standard/item/search
		 * @see mshop/plugin/manager/type/standard/item/count
		 */

		/** mshop/plugin/manager/type/standard/item/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/plugin/manager/type/standard/item/insert
		 * @see mshop/plugin/manager/type/standard/item/newid
		 * @see mshop/plugin/manager/type/standard/item/delete
		 * @see mshop/plugin/manager/type/standard/item/search
		 * @see mshop/plugin/manager/type/standard/item/count
		...
		/** mshop/plugin/manager/type/standard/item/newid
		...
		/** mshop/plugin/manager/type/standard/item/delete
		...
		/** mshop/plugin/manager/type/standard/item/search
		...
		/** mshop/plugin/manager/type/standard/item/count
		...
		return 'mshop/plugin/manager/type/standard/item/';
	}
