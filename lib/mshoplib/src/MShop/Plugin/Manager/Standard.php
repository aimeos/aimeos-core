	...
	implements \Aimeos\MShop\Plugin\Manager\Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/plugin/manager/standard/item/delete' );
	}
	...
	{
		/** mshop/plugin/manager/standard/item/delete
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/plugin/manager/standard/item/insert
		 * @see mshop/plugin/manager/standard/item/update
		 * @see mshop/plugin/manager/standard/item/newid
		 * @see mshop/plugin/manager/standard/item/search
		 * @see mshop/plugin/manager/standard/item/count
		 */
		$path = 'mshop/plugin/manager/standard/item/delete';
	...
	public function saveItem( \Aimeos\MShop\Common\Item\Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/plugin/manager/standard/item/insert
				 ...
				 * @see mshop/plugin/manager/standard/item/update
				 * @see mshop/plugin/manager/standard/item/newid
				 * @see mshop/plugin/manager/standard/item/delete
				 * @see mshop/plugin/manager/standard/item/search
				 * @see mshop/plugin/manager/standard/item/count
				 */
				$path = 'mshop/plugin/manager/standard/item/insert';
			}
			else
			{
				/** mshop/plugin/manager/standard/item/update
				 ...
				 * @see mshop/plugin/manager/standard/item/count
				 */
				$path = 'mshop/plugin/manager/standard/item/update';
			}
			...
			{
				/** mshop/plugin/manager/standard/item/newid
				 ...
				 * @see mshop/plugin/manager/standard/item/count
				 */
				$path = 'mshop/plugin/manager/standard/item/newid';
	...
	public function searchItems( \Aimeos\MW\Common\Criteria\Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			 ...
			 * @see mshop/plugin/manager/standard/item/count
			 */
			$cfgPathSearch = 'mshop/plugin/manager/standard/item/search';

			/** mshop/plugin/manager/standard/item/count
			 ...
			 * @see mshop/plugin/manager/standard/item/search
			 */
			$cfgPathCount = 'mshop/plugin/manager/standard/item/count';
