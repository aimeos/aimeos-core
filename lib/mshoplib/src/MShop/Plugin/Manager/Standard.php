	...
	implements \Aimeos\MShop\Plugin\Manager\Iface
{
	...
	{
		/** mshop/plugin/manager/standard/delete
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/plugin/manager/standard/insert
		 * @see mshop/plugin/manager/standard/update
		 * @see mshop/plugin/manager/standard/newid
		 * @see mshop/plugin/manager/standard/search
		 * @see mshop/plugin/manager/standard/count
		 */
	...
	public function saveItem( \Aimeos\MShop\Common\Item\Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/plugin/manager/standard/insert
				 ...
				 * @see mshop/plugin/manager/standard/update
				 * @see mshop/plugin/manager/standard/newid
				 * @see mshop/plugin/manager/standard/delete
				 * @see mshop/plugin/manager/standard/search
				 * @see mshop/plugin/manager/standard/count
				 */
			...
			{
				/** mshop/plugin/manager/standard/update
			...
			{
				/** mshop/plugin/manager/standard/newid
	...
	public function searchItems( \Aimeos\MW\Criteria\Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			...
			/** mshop/plugin/manager/standard/search
			...
			/** mshop/plugin/manager/standard/count
