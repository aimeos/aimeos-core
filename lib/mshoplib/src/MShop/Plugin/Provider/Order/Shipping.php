...
class MShop_Plugin_Provider_Order_Shipping implements MShop_Plugin_Provider_Interface
{
	...
	public function update( MW_Observer_Publisher_Interface $order, $action, $value = null )
	{
		...
		{
			$this->_context->getLogger()->log( sprintf( 'An error occured in a plugin. Threshold for free shipping for currency ID "%1$s" not available.', $currency ), MW_Logger_Abstract::WARN );
			return true;
		}
