 ...
 * @subpackage Service
 */
class MShop_Service_Manager_Lists_Type_Standard
	...
	implements MShop_Service_Manager_Lists_Type_Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/service/manager/lists/type/standard/item/delete' );
	}
	...
	public function getSubManager( $manager, $name = null )
	{
		 ...
		 *
		 *  MShop_Service_Manager_Lists_Type_Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  MShop_Service_Manager_Lists_Type_Mytype
		 *
	...
	{
		/** mshop/service/manager/lists/type/standard/item/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/service/manager/lists/type/standard/item/update
		 * @see mshop/service/manager/lists/type/standard/item/newid
		 * @see mshop/service/manager/lists/type/standard/item/delete
		 * @see mshop/service/manager/lists/type/standard/item/search
		 * @see mshop/service/manager/lists/type/standard/item/count
		 */

		/** mshop/service/manager/lists/type/standard/item/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/service/manager/lists/type/standard/item/insert
		 * @see mshop/service/manager/lists/type/standard/item/newid
		 * @see mshop/service/manager/lists/type/standard/item/delete
		 * @see mshop/service/manager/lists/type/standard/item/search
		 * @see mshop/service/manager/lists/type/standard/item/count
		...
		/** mshop/service/manager/lists/type/standard/item/newid
		...
		/** mshop/service/manager/lists/type/standard/item/delete
		...
		/** mshop/service/manager/lists/type/standard/item/search
		...
		/** mshop/service/manager/lists/type/standard/item/count
		...
		return 'mshop/service/manager/lists/type/standard/item/';
	}
