	...
	implements MShop_Service_Manager_Lists_Iface
{
	...
	{
		$path = 'classes/service/manager/lists/submanagers';
		foreach( $this->getContext()->getConfig()->get( $path, array( 'type' ) ) as $domain ) {
			$this->getSubManager( $domain )->cleanup( $siteids );
		}

		$this->cleanupBase( $siteids, 'mshop/service/manager/lists/standard/item/delete' );
	}
	...
	{
		/** classes/service/manager/lists/submanagers
	...
	{
		/** classes/service/manager/lists/name
		 ...
		 *
		 *  classes/service/manager/lists/name = Mylist
		 *
	...
	{
		/** mshop/service/manager/lists/standard/item/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/service/manager/lists/standard/item/update
		 * @see mshop/service/manager/lists/standard/item/newid
		 * @see mshop/service/manager/lists/standard/item/delete
		 * @see mshop/service/manager/lists/standard/item/search
		 * @see mshop/service/manager/lists/standard/item/count
		 * @see mshop/service/manager/lists/standard/item/aggregate
		 * @see mshop/service/manager/lists/standard/item/getposmax
		 * @see mshop/service/manager/lists/standard/item/move
		 * @see mshop/service/manager/lists/standard/item/updatepos
		 */

		/** mshop/service/manager/lists/standard/item/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/service/manager/lists/standard/item/insert
		 * @see mshop/service/manager/lists/standard/item/newid
		 * @see mshop/service/manager/lists/standard/item/delete
		 * @see mshop/service/manager/lists/standard/item/search
		 * @see mshop/service/manager/lists/standard/item/count
		...
		/** mshop/service/manager/lists/standard/item/newid
		...
		/** mshop/service/manager/lists/standard/item/delete
		...
		/** mshop/service/manager/lists/standard/item/search
		...
		/** mshop/service/manager/lists/standard/item/count
		...
		/** mshop/service/manager/lists/standard/item/aggregate
		...
		/** mshop/service/manager/lists/standard/item/getposmax
		...
		/** mshop/service/manager/lists/standard/item/move
		...
		/** mshop/service/manager/lists/standard/item/updatepos
		...
		return 'mshop/service/manager/lists/standard/item/';
	}
