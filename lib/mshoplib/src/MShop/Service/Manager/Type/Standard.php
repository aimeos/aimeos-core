	...
	implements \Aimeos\MShop\Service\Manager\Type\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		return $this->cleanupBase( $siteids, 'mshop/service/manager/type/standard/delete' );
	}
	...
	protected function getConfigPath()
	{
		 ...
		 *
		 * @see mshop/service/manager/type/standard/insert/ansi
		 */
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/service/manager/type/standard/update/ansi
		 * @see mshop/service/manager/type/standard/newid/ansi
		 * @see mshop/service/manager/type/standard/delete/ansi
		 * @see mshop/service/manager/type/standard/search/ansi
		 * @see mshop/service/manager/type/standard/count/ansi
		 */
		...
		/** mshop/service/manager/type/standard/newid/mysql
