 ...
 * @subpackage Service
 */
class MShop_Service_Manager_List_Type_Standard
	extends MShop_Common_Manager_Type_Base
	implements MShop_Service_Manager_List_Type_Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/service/manager/list/type/default/item/delete' );
	}
	...
	{
		/** classes/service/manager/list/type/submanagers
	...
	{
		/** classes/service/manager/list/type/name
		 ...
		 *
		 *  MShop_Service_Manager_List_Type_Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  MShop_Service_Manager_List_Type_Mytype
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/service/manager/list/type/name = Mytype
		 *
		...
		/** mshop/service/manager/list/type/decorators/excludes
		 ...
		 *
		 *  mshop/service/manager/list/type/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see mshop/service/manager/list/type/decorators/global
		 * @see mshop/service/manager/list/type/decorators/local
		 */

		/** mshop/service/manager/list/type/decorators/global
		 ...
		 * ("MShop_Common_Manager_Decorator_*") around the service list type manager.
		 *
		 *  mshop/service/manager/list/type/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see mshop/common/manager/decorators/default
		 * @see mshop/service/manager/list/type/decorators/excludes
		 * @see mshop/service/manager/list/type/decorators/local
		 */

		/** mshop/service/manager/list/type/decorators/local
		 ...
		 * ("MShop_Common_Manager_Decorator_*") around the service list type manager.
		 *
		 *  mshop/service/manager/list/type/decorators/local = array( 'decorator2' )
		 *
		...
		return $this->getSubManagerBase( 'service', 'list/type/' . $manager, $name );
	}
	...
	{
		/** mshop/service/manager/list/type/default/item/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/service/manager/list/type/default/item/update
		 * @see mshop/service/manager/list/type/default/item/newid
		 * @see mshop/service/manager/list/type/default/item/delete
		 * @see mshop/service/manager/list/type/default/item/search
		 * @see mshop/service/manager/list/type/default/item/count
		 */

		/** mshop/service/manager/list/type/default/item/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/service/manager/list/type/default/item/insert
		 * @see mshop/service/manager/list/type/default/item/newid
		 * @see mshop/service/manager/list/type/default/item/delete
		 * @see mshop/service/manager/list/type/default/item/search
		 * @see mshop/service/manager/list/type/default/item/count
		...
		/** mshop/service/manager/list/type/default/item/newid
		...
		/** mshop/service/manager/list/type/default/item/delete
		...
		/** mshop/service/manager/list/type/default/item/search
		...
		/** mshop/service/manager/list/type/default/item/count
