 ...
 * @subpackage Service
 */
class MShop_Service_Manager_List_Standard
	extends MShop_Common_Manager_List_Base
	implements MShop_Service_Manager_List_Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/service/manager/list/default/item/delete' );
	}
	...
	public function getSubManager( $manager, $name = null )
	{
		 ...
		 *
		 *  MShop_Service_Manager_List_Standard
		 *
	...
	protected function getConfigPath()
	{
		 ...
		 * @see mshop/service/manager/list/default/item/aggregate
		 * @see mshop/service/manager/list/default/item/getposmax
		 * @see mshop/service/manager/list/default/item/move
		 * @see mshop/service/manager/list/default/item/updatepos
		 */
		...
		/** mshop/service/manager/list/default/item/aggregate
		...
		/** mshop/service/manager/list/default/item/getposmax
		...
		/** mshop/service/manager/list/default/item/move
		...
		/** mshop/service/manager/list/default/item/updatepos
