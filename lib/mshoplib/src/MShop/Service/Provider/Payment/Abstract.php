...
implements MShop_Service_Provider_Payment_Interface
{
	...
	{
		throw new MShop_Service_Exception( sprintf( 'An error occured in a service. Method "%1$s" for provider not available.', 'cancel' ) );
	}
	...
	{
		throw new MShop_Service_Exception( sprintf( 'An error occured in a service. Method "%1$s" for provider not available.', 'capture' ) );
	}
	...
	{
		throw new MShop_Service_Exception( sprintf( 'An error occured in a service. Method "%1$s" for provider not available.', 'refund' ) );
	}
