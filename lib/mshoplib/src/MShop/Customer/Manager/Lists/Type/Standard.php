	...
	implements MShop_Customer_Manager_Lists_Type_Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/customer/manager/lists/type/standard/item/delete' );
	}
	...
	{
		/** classes/customer/manager/lists/type/submanagers
	...
	{
		/** classes/customer/manager/lists/type/name
		 ...
		 *
		 *  classes/customer/manager/lists/type/name = Mytype
		 *
	...
	{
		/** mshop/customer/manager/lists/type/standard/item/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/customer/manager/lists/type/standard/item/update
		 * @see mshop/customer/manager/lists/type/standard/item/newid
		 * @see mshop/customer/manager/lists/type/standard/item/delete
		 * @see mshop/customer/manager/lists/type/standard/item/search
		 * @see mshop/customer/manager/lists/type/standard/item/count
		 */

		/** mshop/customer/manager/lists/type/standard/item/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/customer/manager/lists/type/standard/item/insert
		 * @see mshop/customer/manager/lists/type/standard/item/newid
		 * @see mshop/customer/manager/lists/type/standard/item/delete
		 * @see mshop/customer/manager/lists/type/standard/item/search
		 * @see mshop/customer/manager/lists/type/standard/item/count
		...
		/** mshop/customer/manager/lists/type/standard/item/newid
		...
		/** mshop/customer/manager/lists/type/standard/item/delete
		...
		/** mshop/customer/manager/lists/type/standard/item/search
		...
		/** mshop/customer/manager/lists/type/standard/item/count
		...
		return 'mshop/customer/manager/lists/type/standard/item/';
	}
