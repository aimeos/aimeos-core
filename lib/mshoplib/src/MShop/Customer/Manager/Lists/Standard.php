 ...
 * @subpackage Customer
 */
class MShop_Customer_Manager_Lists_Standard
	extends MShop_Common_Manager_Lists_Base
	implements MShop_Customer_Manager_Lists_Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/customer/manager/lists/standard/item/delete' );
	}
	...
	{
		/** classes/customer/manager/lists/submanagers
	...
	{
		/** classes/customer/manager/lists/name
		 ...
		 *
		 *  MShop_Customer_Manager_Lists_Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  MShop_Customer_Manager_Lists_Mylist
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/customer/manager/lists/name = Mylist
		 *
	...
	{
		/** mshop/customer/manager/lists/standard/item/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/customer/manager/lists/standard/item/update
		 * @see mshop/customer/manager/lists/standard/item/newid
		 * @see mshop/customer/manager/lists/standard/item/delete
		 * @see mshop/customer/manager/lists/standard/item/search
		 * @see mshop/customer/manager/lists/standard/item/count
		 * @see mshop/customer/manager/lists/standard/item/aggregate
		 * @see mshop/customer/manager/lists/standard/item/getposmax
		 * @see mshop/customer/manager/lists/standard/item/move
		 * @see mshop/customer/manager/lists/standard/item/updatepos
		 */

		/** mshop/customer/manager/lists/standard/item/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/customer/manager/lists/standard/item/insert
		 * @see mshop/customer/manager/lists/standard/item/newid
		 * @see mshop/customer/manager/lists/standard/item/delete
		 * @see mshop/customer/manager/lists/standard/item/search
		 * @see mshop/customer/manager/lists/standard/item/count
		...
		/** mshop/customer/manager/lists/standard/item/newid
		...
		/** mshop/customer/manager/lists/standard/item/delete
		...
		/** mshop/customer/manager/lists/standard/item/search
		...
		/** mshop/customer/manager/lists/standard/item/count
		...
		/** mshop/customer/manager/lists/standard/item/aggregate
		...
		/** mshop/customer/manager/lists/standard/item/getposmax
		...
		/** mshop/customer/manager/lists/standard/item/move
		...
		/** mshop/customer/manager/lists/standard/item/updatepos
		...
		return 'mshop/customer/manager/lists/standard/item/';
	}
