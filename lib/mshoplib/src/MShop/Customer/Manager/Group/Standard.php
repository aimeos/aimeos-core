	...
	implements \Aimeos\MShop\Customer\Manager\Group\Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/customer/manager/group/standard/item/delete' );
	}
	...
	{
		/** mshop/customer/manager/group/standard/item/delete
		 ...
		 * @since 2015.08
		 * @category Developer
		 * @see mshop/customer/manager/group/standard/item/insert
		 * @see mshop/customer/manager/group/standard/item/update
		 * @see mshop/customer/manager/group/standard/item/newid
		 * @see mshop/customer/manager/group/standard/item/search
		 * @see mshop/customer/manager/group/standard/item/count
		 */
		$path = 'mshop/customer/manager/group/standard/item/delete';
	...
	public function saveItem( \Aimeos\MShop\Common\Item\Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/customer/manager/group/standard/item/insert
				 ...
				 * @see mshop/customer/manager/group/standard/item/update
				 * @see mshop/customer/manager/group/standard/item/newid
				 * @see mshop/customer/manager/group/standard/item/delete
				 * @see mshop/customer/manager/group/standard/item/search
				 * @see mshop/customer/manager/group/standard/item/count
				 */
				$path = 'mshop/customer/manager/group/standard/item/insert';
			}
			else
			{
				/** mshop/customer/manager/group/standard/item/update
				 ...
				 * @see mshop/customer/manager/group/standard/item/count
				 */
				$path = 'mshop/customer/manager/group/standard/item/update';
			}
			...
			{
				/** mshop/customer/manager/group/standard/item/newid
				 ...
				 * @see mshop/customer/manager/group/standard/item/count
				 */
				$path = 'mshop/customer/manager/group/standard/item/newid';
	...
	public function searchItems( \Aimeos\MW\Common\Criteria\Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			 ...
			 * @see mshop/customer/manager/group/standard/item/count
			 */
			$cfgPathSearch = 'mshop/customer/manager/group/standard/item/search';

			/** mshop/customer/manager/group/standard/item/count
			 ...
			 * @see mshop/customer/manager/group/standard/item/search
			 */
			$cfgPathCount = 'mshop/customer/manager/group/standard/item/count';
