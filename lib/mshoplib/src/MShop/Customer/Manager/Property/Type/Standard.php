	...
	implements \Aimeos\MShop\Customer\Manager\Property\Type\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	 ...
	 * @return \Aimeos\MShop\Customer\Manager\Property\Type\Iface Manager object for chaining method calls
	 */
	public function clear( iterable $siteids ) : \Aimeos\MShop\Common\Manager\Iface
	{
		...
		return $this->clearBase( $siteids, 'mshop/customer/manager/property/type/delete' );
	}
	...
	protected function getConfigPath() : string
	{
		...
		return 'mshop/customer/manager/property/type/';
	}
