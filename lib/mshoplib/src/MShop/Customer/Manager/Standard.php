	...
	implements \Aimeos\MShop\Customer\Manager\Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/customer/manager/standard/item/delete' );
	}
	...
	{
		/** mshop/customer/manager/standard/item/delete
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/customer/manager/standard/item/insert
		 * @see mshop/customer/manager/standard/item/update
		 * @see mshop/customer/manager/standard/item/newid
		 * @see mshop/customer/manager/standard/item/search
		 * @see mshop/customer/manager/standard/item/count
		 */
		$path = 'mshop/customer/manager/standard/item/delete';
	...
	public function saveItem( \Aimeos\MShop\Common\Item\Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/customer/manager/standard/item/insert
				 ...
				 * @see mshop/customer/manager/standard/item/update
				 * @see mshop/customer/manager/standard/item/newid
				 * @see mshop/customer/manager/standard/item/delete
				 * @see mshop/customer/manager/standard/item/search
				 * @see mshop/customer/manager/standard/item/count
				 */
				$path = 'mshop/customer/manager/standard/item/insert';
			}
			else
			{
				/** mshop/customer/manager/standard/item/update
				 ...
				 * @see mshop/customer/manager/standard/item/count
				 */
				$path = 'mshop/customer/manager/standard/item/update';
			}
			...
			{
				/** mshop/customer/manager/standard/item/newid
				 ...
				 * @see mshop/customer/manager/standard/item/count
				 */
				$path = 'mshop/customer/manager/standard/item/newid';
	...
	public function searchItems( \Aimeos\MW\Common\Criteria\Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			 ...
			 * @see mshop/customer/manager/standard/item/count
			 */
			$cfgPathSearch = 'mshop/customer/manager/standard/item/search';

			/** mshop/customer/manager/standard/item/count
			 ...
			 * @see mshop/customer/manager/standard/item/search
			 */
			$cfgPathCount = 'mshop/customer/manager/standard/item/count';
