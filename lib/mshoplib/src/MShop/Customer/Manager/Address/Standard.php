	...
	implements \Aimeos\MShop\Customer\Manager\Address\Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/customer/manager/address/standard/item/delete' );
	}
	...
	{
		/** mshop/customer/manager/address/standard/item/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/customer/manager/address/standard/item/update
		 * @see mshop/customer/manager/address/standard/item/newid
		 * @see mshop/customer/manager/address/standard/item/delete
		 * @see mshop/customer/manager/address/standard/item/search
		 * @see mshop/customer/manager/address/standard/item/count
		 */

		/** mshop/customer/manager/address/standard/item/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/customer/manager/address/standard/item/insert
		 * @see mshop/customer/manager/address/standard/item/newid
		 * @see mshop/customer/manager/address/standard/item/delete
		 * @see mshop/customer/manager/address/standard/item/search
		 * @see mshop/customer/manager/address/standard/item/count
		...
		/** mshop/customer/manager/address/standard/item/newid
		...
		/** mshop/customer/manager/address/standard/item/delete
		...
		/** mshop/customer/manager/address/standard/item/search
		...
		/** mshop/customer/manager/address/standard/item/count
		...
		return 'mshop/customer/manager/address/standard/item';
	}
