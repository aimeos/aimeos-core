	...
	implements \Aimeos\MShop\Attribute\Manager\Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/attribute/manager/standard/item/delete' );
	}
	...
	public function saveItem( \Aimeos\MShop\Common\Item\Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/attribute/manager/standard/item/insert
				 ...
				 * @since 2014.03
				 * @category Developer
				 * @see mshop/attribute/manager/standard/item/update
				 * @see mshop/attribute/manager/standard/item/newid
				 * @see mshop/attribute/manager/standard/item/delete
				 * @see mshop/attribute/manager/standard/item/search
				 * @see mshop/attribute/manager/standard/item/count
				 */
				$path = 'mshop/attribute/manager/standard/item/insert';
			}
			else
			{
				/** mshop/attribute/manager/standard/item/update
				 ...
				 * @since 2014.03
				 * @category Developer
				 * @see mshop/attribute/manager/standard/item/insert
				 * @see mshop/attribute/manager/standard/item/newid
				 * @see mshop/attribute/manager/standard/item/delete
				 * @see mshop/attribute/manager/standard/item/search
				 * @see mshop/attribute/manager/standard/item/count
				 */
				$path = 'mshop/attribute/manager/standard/item/update';
			}
			...
			{
				/** mshop/attribute/manager/standard/item/newid
				 ...
				 * @see mshop/attribute/manager/standard/item/count
				 */
				$path = 'mshop/attribute/manager/standard/item/newid';
	...
	{
		/** mshop/attribute/manager/standard/item/delete
		 ...
		 * @see mshop/attribute/manager/standard/item/count
		 */
		$path = 'mshop/attribute/manager/standard/item/delete';
	...
	public function searchItems( \Aimeos\MW\Common\Criteria\Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			...
			/** mshop/attribute/manager/standard/item/search
			 ...
			 * @see mshop/attribute/manager/standard/item/count
			 */
			$cfgPathSearch = 'mshop/attribute/manager/standard/item/search';

			/** mshop/attribute/manager/standard/item/count
			 ...
			 * @see mshop/attribute/manager/standard/item/search
			 */
			$cfgPathCount = 'mshop/attribute/manager/standard/item/count';
