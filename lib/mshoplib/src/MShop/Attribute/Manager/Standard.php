	...
	implements \Aimeos\MShop\Attribute\Manager\Iface
{
	...
	{
		return $this->getItemBase( array( 'attribute.id', 'attribute.code' ), $value, $ref );
	}
	...
	public function saveItem( \Aimeos\MShop\Common\Item\Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/attribute/manager/standard/insert
				 ...
				 * @since 2014.03
				 * @category Developer
				 * @see mshop/attribute/manager/standard/update
				 * @see mshop/attribute/manager/standard/newid
				 * @see mshop/attribute/manager/standard/delete
				 * @see mshop/attribute/manager/standard/search
				 * @see mshop/attribute/manager/standard/count
				 */
				$path = 'mshop/attribute/manager/standard/insert';
			}
			else
			{
				/** mshop/attribute/manager/standard/update
				 ...
				 * @since 2014.03
				 * @category Developer
				 * @see mshop/attribute/manager/standard/insert
				 * @see mshop/attribute/manager/standard/newid
				 * @see mshop/attribute/manager/standard/delete
				 * @see mshop/attribute/manager/standard/search
				 * @see mshop/attribute/manager/standard/count
			...
			{
				/** mshop/attribute/manager/standard/newid
	...
	{
		/** mshop/attribute/manager/standard/delete
	...
	public function searchItems( \Aimeos\MW\Criteria\Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			...
			/** mshop/attribute/manager/standard/search
			...
			/** mshop/attribute/manager/standard/count
