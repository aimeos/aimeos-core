	...
	implements \Aimeos\MShop\Attribute\Manager\Property\Type\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	private $searchConfig = array(
		...
		'attribute.property.type.siteid' => array(
		...
		'attribute.property.type.label' => array(
			'code' => 'attribute.property.type.label',
		...
		'attribute.property.type.code' => array(
			'code' => 'attribute.property.type.code',
		...
		'attribute.property.type.domain' => array(
			'code' => 'attribute.property.type.domain',
			'internalcode' => 'mattprty."domain"',
			'label' => 'Property type domain',
			'type' => 'string',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_STR,
		),
		'attribute.property.type.position' => array(
			'code' => 'attribute.property.type.position',
		...
		'attribute.property.type.status' => array(
			'code' => 'attribute.property.type.status',
			'internalcode' => 'mattprty."status"',
			'label' => 'Property type status',
			'type' => 'integer',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_INT,
		),
		'attribute.property.type.ctime' => array(
			'code' => 'attribute.property.type.ctime',
		...
		'attribute.property.type.mtime' => array(
			'code' => 'attribute.property.type.mtime',
		...
		'attribute.property.type.editor' => array(
			'code' => 'attribute.property.type.editor',
	...
	{
		$path = 'mshop/attribute/manager/property/type/submanagers';
		foreach( $this->getContext()->getConfig()->get( $path, [] ) as $domain ) {
			$this->getObject()->getSubManager( $domain )->clear( $siteids );
		}

		return $this->clearBase( $siteids, 'mshop/attribute/manager/property/type/standard/delete' );
	}
	...
	public function getResourceType( bool $withsub = true ) : array
	{
		...
		return $this->getResourceTypeBase( 'attribute/property/type', $path, [], $withsub );
	}
	...
	protected function getConfigPath() : string
	{
		 ...
		 *
		 * @see mshop/attribute/manager/property/type/standard/insert/ansi
		 */
		 ...
		 * @since 2018.01
		 * @category Developer
		 * @see mshop/attribute/manager/property/type/standard/update/ansi
		 * @see mshop/attribute/manager/property/type/standard/newid/ansi
		 * @see mshop/attribute/manager/property/type/standard/delete/ansi
		 * @see mshop/attribute/manager/property/type/standard/search/ansi
		 * @see mshop/attribute/manager/property/type/standard/count/ansi
		 */
		...
		/** mshop/attribute/manager/property/type/standard/newid/mysql
		...
		return 'mshop/attribute/manager/property/type/standard/';
	}
