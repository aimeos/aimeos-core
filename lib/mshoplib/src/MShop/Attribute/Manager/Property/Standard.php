	...
	implements \Aimeos\MShop\Attribute\Manager\Property\Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/attribute/manager/property/standard/delete' );
	}
	...
	public function getSubManager( $manager, $name = null )
	{
		 ...
		 * ("\Aimeos\MShop\Common\Manager\Decorator\*") around the attribute property manager.
		 *
	...
	protected function getConfigPath()
	{
		 ...
		 *
		 * @see mshop/attribute/manager/property/standard/insert/ansi
		 */
		 ...
		 * @since 2018.01
		 * @category Developer
		 * @see mshop/attribute/manager/property/standard/update/ansi
		 * @see mshop/attribute/manager/property/standard/newid/ansi
		 * @see mshop/attribute/manager/property/standard/delete/ansi
		 * @see mshop/attribute/manager/property/standard/search/ansi
		 * @see mshop/attribute/manager/property/standard/count/ansi
		 */
		...
		/** mshop/attribute/manager/property/standard/newid/mysql
		...
		return 'mshop/attribute/manager/property/standard/';
	}
