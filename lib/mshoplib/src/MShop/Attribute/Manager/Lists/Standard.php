	...
	implements \Aimeos\MShop\Attribute\Manager\Lists\Iface
{
	...
	{
		$path = 'classes/attribute/manager/lists/submanagers';
		foreach( $this->getContext()->getConfig()->get( $path, array( 'type' ) ) as $domain ) {
			$this->getSubManager( $domain )->cleanup( $siteids );
		}

		$this->cleanupBase( $siteids, 'mshop/attribute/manager/lists/standard/item/delete' );
	}
	...
	{
		/** classes/attribute/manager/lists/submanagers
	...
	{
		/** classes/attribute/manager/lists/name
		 ...
		 *
		 *  classes/attribute/manager/lists/name = Mylist
		 *
	...
	{
		/** mshop/attribute/manager/lists/standard/item/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/attribute/manager/lists/standard/item/update
		 * @see mshop/attribute/manager/lists/standard/item/newid
		 * @see mshop/attribute/manager/lists/standard/item/delete
		 * @see mshop/attribute/manager/lists/standard/item/search
		 * @see mshop/attribute/manager/lists/standard/item/count
		 * @see mshop/attribute/manager/lists/standard/item/aggregate
		 * @see mshop/attribute/manager/lists/standard/item/getposmax
		 * @see mshop/attribute/manager/lists/standard/item/move
		 * @see mshop/attribute/manager/lists/standard/item/updatepos
		 */

		/** mshop/attribute/manager/lists/standard/item/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/attribute/manager/lists/standard/item/insert
		 * @see mshop/attribute/manager/lists/standard/item/newid
		 * @see mshop/attribute/manager/lists/standard/item/delete
		 * @see mshop/attribute/manager/lists/standard/item/search
		 * @see mshop/attribute/manager/lists/standard/item/count
		...
		/** mshop/attribute/manager/lists/standard/item/newid
		...
		/** mshop/attribute/manager/lists/standard/item/delete
		...
		/** mshop/attribute/manager/lists/standard/item/search
		...
		/** mshop/attribute/manager/lists/standard/item/count
		...
		/** mshop/attribute/manager/lists/standard/item/aggregate
		...
		/** mshop/attribute/manager/lists/standard/item/getposmax
		...
		/** mshop/attribute/manager/lists/standard/item/move
		...
		/** mshop/attribute/manager/lists/standard/item/updatepos
		...
		return 'mshop/attribute/manager/lists/standard/item/';
	}
