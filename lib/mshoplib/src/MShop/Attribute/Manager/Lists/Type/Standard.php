 ...
 * @subpackage Attribute
 */
class MShop_Attribute_Manager_Lists_Type_Standard
	extends MShop_Common_Manager_Type_Base
	implements MShop_Attribute_Manager_Lists_Type_Iface
{
	private $searchConfig = array(
		'attribute.lists.type.id' => array(
			'code'=>'attribute.lists.type.id',
		...
		'attribute.lists.type.siteid' => array(
			'code'=>'attribute.lists.type.siteid',
		...
		'attribute.lists.type.domain' => array(
			'code'=>'attribute.lists.type.domain',
		...
		'attribute.lists.type.status' => array(
			'code' => 'attribute.lists.type.status',
		...
		'attribute.lists.type.ctime'=> array(
			'code'=>'attribute.lists.type.ctime',
		...
		'attribute.lists.type.mtime'=> array(
			'code'=>'attribute.lists.type.mtime',
		...
		'attribute.lists.type.editor'=> array(
			'code'=>'attribute.lists.type.editor',
	...
	{
		$path = 'classes/attribute/manager/lists/type/submanagers';
		foreach( $this->getContext()->getConfig()->get( $path, array() ) as $domain ) {
			$this->getSubManager( $domain )->cleanup( $siteids );
		}

		$this->cleanupBase( $siteids, 'mshop/attribute/manager/lists/type/standard/item/delete' );
	}
	...
	{
		/** classes/attribute/manager/lists/type/submanagers
	...
	{
		/** classes/attribute/manager/lists/type/name
		 ...
		 *
		 *  MShop_Attribute_Manager_Lists_Type_Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  MShop_Attribute_Manager_Lists_Type_Mytype
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/attribute/manager/lists/type/name = Mytype
		 *
	...
	{
		/** mshop/attribute/manager/lists/type/standard/item/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/attribute/manager/lists/type/standard/item/update
		 * @see mshop/attribute/manager/lists/type/standard/item/newid
		 * @see mshop/attribute/manager/lists/type/standard/item/delete
		 * @see mshop/attribute/manager/lists/type/standard/item/search
		 * @see mshop/attribute/manager/lists/type/standard/item/count
		 */

		/** mshop/attribute/manager/lists/type/standard/item/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/attribute/manager/lists/type/standard/item/insert
		 * @see mshop/attribute/manager/lists/type/standard/item/newid
		 * @see mshop/attribute/manager/lists/type/standard/item/delete
		 * @see mshop/attribute/manager/lists/type/standard/item/search
		 * @see mshop/attribute/manager/lists/type/standard/item/count
		...
		/** mshop/attribute/manager/lists/type/standard/item/newid
		...
		/** mshop/attribute/manager/lists/type/standard/item/delete
		...
		/** mshop/attribute/manager/lists/type/standard/item/search
		...
		/** mshop/attribute/manager/lists/type/standard/item/count
		...
		return 'mshop/attribute/manager/lists/type/standard/item/';
	}
