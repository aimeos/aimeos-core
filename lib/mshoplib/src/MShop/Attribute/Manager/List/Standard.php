 ...
 * @subpackage Attribute
 */
class MShop_Attribute_Manager_List_Standard
	extends MShop_Common_Manager_List_Base
	implements MShop_Attribute_Manager_List_Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/attribute/manager/list/default/item/delete' );
	}
	...
	{
		/** classes/attribute/manager/list/submanagers
	...
	public function getSubManager( $manager, $name = null )
	{
		 ...
		 *
		 *  MShop_Attribute_Manager_List_Standard
		 *
	...
	{
		/** mshop/attribute/manager/list/default/item/insert
