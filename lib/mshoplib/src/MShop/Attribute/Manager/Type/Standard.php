 ...
 * @subpackage Attribute
 */
class MShop_Attribute_Manager_Type_Standard
	extends MShop_Common_Manager_Type_Base
	implements MShop_Attribute_Manager_Type_Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/attribute/manager/type/standard/item/delete' );
	}
	...
	{
		/** classes/attribute/manager/type/submanagers
	...
	public function getSubManager( $manager, $name = null )
	{
		 ...
		 *
		 *  MShop_Attribute_Manager_Type_Standard
		 *
	...
	{
		/** mshop/attribute/manager/type/standard/item/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/attribute/manager/type/standard/item/update
		 * @see mshop/attribute/manager/type/standard/item/newid
		 * @see mshop/attribute/manager/type/standard/item/delete
		 * @see mshop/attribute/manager/type/standard/item/search
		 * @see mshop/attribute/manager/type/standard/item/count
		 */

		/** mshop/attribute/manager/type/standard/item/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/attribute/manager/type/standard/item/insert
		 * @see mshop/attribute/manager/type/standard/item/newid
		 * @see mshop/attribute/manager/type/standard/item/delete
		 * @see mshop/attribute/manager/type/standard/item/search
		 * @see mshop/attribute/manager/type/standard/item/count
		...
		/** mshop/attribute/manager/type/standard/item/newid
		...
		/** mshop/attribute/manager/type/standard/item/delete
		...
		/** mshop/attribute/manager/type/standard/item/search
		...
		/** mshop/attribute/manager/type/standard/item/count
		...
		return 'mshop/attribute/manager/type/standard/item/';
	}
