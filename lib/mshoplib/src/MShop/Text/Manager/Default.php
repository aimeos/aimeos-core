	...
	implements MShop_Text_Manager_Interface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/text/manager/default/item/delete' );
	}
	...
	public function saveItem( MShop_Common_Item_Interface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/text/manager/default/item/insert
				 ...
				 * @since 2014.03
				 * @category Developer
				 * @see mshop/text/manager/default/item/update
				 * @see mshop/text/manager/default/item/newid
				 * @see mshop/text/manager/default/item/delete
				 * @see mshop/text/manager/default/item/search
				 * @see mshop/text/manager/default/item/count
				 */
				$path = 'mshop/text/manager/default/item/insert';
			}
			else
			{
				/** mshop/text/manager/default/item/update
				 ...
				 * @since 2014.03
				 * @category Developer
				 * @see mshop/text/manager/default/item/insert
				 * @see mshop/text/manager/default/item/newid
				 * @see mshop/text/manager/default/item/delete
				 * @see mshop/text/manager/default/item/search
				 * @see mshop/text/manager/default/item/count
				 */
				$path = 'mshop/text/manager/default/item/update';
			}
			...
			{
				/** mshop/text/manager/default/item/newid
	...
	{
		/** mshop/text/manager/default/item/delete
	...
	public function searchItems( MW_Common_Criteria_Interface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			...
			/** mshop/text/manager/default/item/count
