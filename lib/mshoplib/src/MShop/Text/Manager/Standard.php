	...
	implements \Aimeos\MShop\Text\Manager\Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/text/manager/standard/item/delete' );
	}
	...
	public function saveItem( \Aimeos\MShop\Common\Item\Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/text/manager/standard/item/insert
				 ...
				 * @since 2014.03
				 * @category Developer
				 * @see mshop/text/manager/standard/item/update
				 * @see mshop/text/manager/standard/item/newid
				 * @see mshop/text/manager/standard/item/delete
				 * @see mshop/text/manager/standard/item/search
				 * @see mshop/text/manager/standard/item/count
				 */
				$path = 'mshop/text/manager/standard/item/insert';
			}
			else
			{
				/** mshop/text/manager/standard/item/update
				 ...
				 * @since 2014.03
				 * @category Developer
				 * @see mshop/text/manager/standard/item/insert
				 * @see mshop/text/manager/standard/item/newid
				 * @see mshop/text/manager/standard/item/delete
				 * @see mshop/text/manager/standard/item/search
				 * @see mshop/text/manager/standard/item/count
				 */
				$path = 'mshop/text/manager/standard/item/update';
			}
			...
			{
				/** mshop/text/manager/standard/item/newid
				 ...
				 * @see mshop/text/manager/standard/item/count
				 */
				$path = 'mshop/text/manager/standard/item/newid';
	...
	{
		/** mshop/text/manager/standard/item/delete
		 ...
		 * @see mshop/text/manager/standard/item/count
		 */
		$path = 'mshop/text/manager/standard/item/delete';
	...
	public function searchItems( \Aimeos\MW\Common\Criteria\Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			 ...
			 * @see mshop/text/manager/standard/item/count
			 */
			$cfgPathSearch = 'mshop/text/manager/standard/item/search';

			/** mshop/text/manager/standard/item/count
			 ...
			 * @see mshop/text/manager/standard/item/search
			 */
			$cfgPathCount = 'mshop/text/manager/standard/item/count';
