 ...
 * @subpackage Text
 */
class MShop_Text_Manager_List_Type_Standard
	extends MShop_Common_Manager_Type_Base
	implements MShop_Text_Manager_List_Type_Iface
{
	...
	{
		/** classes/text/manager/list/type/submanagers
	...
	public function getSubManager( $manager, $name = null )
	{
		 ...
		 *
		 *  MShop_Text_Manager_List_Type_Standard
		 *
		...
		return $this->getSubManagerBase( 'text', 'list/type/' . $manager, $name );
	}
	...
	{
		/** mshop/text/manager/list/type/default/item/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/text/manager/list/type/default/item/update
		 * @see mshop/text/manager/list/type/default/item/newid
		 * @see mshop/text/manager/list/type/default/item/delete
		 * @see mshop/text/manager/list/type/default/item/search
		 * @see mshop/text/manager/list/type/default/item/count
		 */

		/** mshop/text/manager/list/type/default/item/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/text/manager/list/type/default/item/insert
		 * @see mshop/text/manager/list/type/default/item/newid
		 * @see mshop/text/manager/list/type/default/item/delete
		 * @see mshop/text/manager/list/type/default/item/search
		 * @see mshop/text/manager/list/type/default/item/count
		...
		/** mshop/text/manager/list/type/default/item/newid
		...
		/** mshop/text/manager/list/type/default/item/delete
		...
		/** mshop/text/manager/list/type/default/item/search
		...
		/** mshop/text/manager/list/type/default/item/count
