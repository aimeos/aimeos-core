	...
	implements \Aimeos\MShop\Text\Manager\Lists\Type\Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/text/manager/lists/type/standard/delete' );
	}
	...
	public function getResourceType( $withsub = true )
	{
		...
		return $this->getResourceTypeBase( 'text/lists/type', $path, array(), $withsub );
	}
	...
	{
		/** mshop/text/manager/lists/type/standard/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/text/manager/lists/type/standard/update
		 * @see mshop/text/manager/lists/type/standard/newid
		 * @see mshop/text/manager/lists/type/standard/delete
		 * @see mshop/text/manager/lists/type/standard/search
		 * @see mshop/text/manager/lists/type/standard/count
		 */

		/** mshop/text/manager/lists/type/standard/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/text/manager/lists/type/standard/insert
		 * @see mshop/text/manager/lists/type/standard/newid
		 * @see mshop/text/manager/lists/type/standard/delete
		 * @see mshop/text/manager/lists/type/standard/search
		 * @see mshop/text/manager/lists/type/standard/count
		...
		/** mshop/text/manager/lists/type/standard/newid
		...
		/** mshop/text/manager/lists/type/standard/delete
		...
		/** mshop/text/manager/lists/type/standard/search
		...
		/** mshop/text/manager/lists/type/standard/count
