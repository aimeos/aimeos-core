...
class Standard
	...
	implements \Aimeos\MShop\Text\Manager\Lists\Type\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	private $searchConfig = array(
		...
		'text.lists.type.position' => array(
			'code' => 'text.lists.type.position',
			'internalcode' => 'mtexlity."pos"',
	 ...
	 * @return \Aimeos\MShop\Text\Manager\Lists\Type\Iface Manager object for chaining method calls
	 */
	public function cleanup( array $siteids )
	{
		$path = 'mshop/text/manager/lists/type/submanagers';
		foreach( $this->getContext()->getConfig()->get( $path, [] ) as $domain ) {
			$this->getObject()->getSubManager( $domain )->cleanup( $siteids );
		}

		return $this->cleanupBase( $siteids, 'mshop/text/manager/lists/type/standard/delete' );
	}
	...
	{
		$path = 'mshop/text/manager/lists/type/submanagers';
		return $this->getResourceTypeBase( 'text/lists/type', $path, [], $withsub );
	}
	...
	protected function getConfigPath()
	{
		 ...
		 *
		 * @see mshop/text/manager/lists/type/standard/insert/ansi
		 */
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/text/manager/lists/type/standard/update/ansi
		 * @see mshop/text/manager/lists/type/standard/newid/ansi
		 * @see mshop/text/manager/lists/type/standard/delete/ansi
		 * @see mshop/text/manager/lists/type/standard/search/ansi
		 * @see mshop/text/manager/lists/type/standard/count/ansi
		 */
		...
		/** mshop/text/manager/lists/type/standard/newid/mysql
		...
		return 'mshop/text/manager/lists/type/standard/';
	}
