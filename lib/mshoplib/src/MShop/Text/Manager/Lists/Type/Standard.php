 ...
 * @subpackage Text
 */
class MShop_Text_Manager_Lists_Type_Standard
	extends MShop_Common_Manager_Type_Base
	implements MShop_Text_Manager_Lists_Type_Iface
{
	private $searchConfig = array(
		'text.lists.type.id' => array(
			'code'=>'text.lists.type.id',
		...
		'text.lists.type.siteid' => array(
			'code'=>'text.lists.type.siteid',
		...
		'text.lists.type.status' => array(
			'code'=>'text.lists.type.status',
			'internalcode'=>'mtexlity."status"',
			'label'=>'Text list type status',
			'type'=> 'integer',
			'internaltype' => MW_DB_Statement_Base::PARAM_INT,
		),
		'text.lists.type.ctime'=> array(
			'code'=>'text.lists.type.ctime',
	...
	{
		$path = 'classes/text/manager/lists/type/submanagers';
		foreach( $this->getContext()->getConfig()->get( $path, array() ) as $domain ) {
			$this->getSubManager( $domain )->cleanup( $siteids );
		}

		$this->cleanupBase( $siteids, 'mshop/text/manager/lists/type/standard/item/delete' );
	}
	...
	{
		/** classes/text/manager/lists/type/submanagers
	...
	{
		/** classes/text/manager/lists/type/name
		 ...
		 *
		 *  MShop_Text_Manager_Lists_Type_Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  MShop_Text_Manager_Lists_Type_Mytype
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/text/manager/lists/type/name = Mytype
		 *
	...
	{
		/** mshop/text/manager/lists/type/standard/item/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/text/manager/lists/type/standard/item/update
		 * @see mshop/text/manager/lists/type/standard/item/newid
		 * @see mshop/text/manager/lists/type/standard/item/delete
		 * @see mshop/text/manager/lists/type/standard/item/search
		 * @see mshop/text/manager/lists/type/standard/item/count
		 */

		/** mshop/text/manager/lists/type/standard/item/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/text/manager/lists/type/standard/item/insert
		 * @see mshop/text/manager/lists/type/standard/item/newid
		 * @see mshop/text/manager/lists/type/standard/item/delete
		 * @see mshop/text/manager/lists/type/standard/item/search
		 * @see mshop/text/manager/lists/type/standard/item/count
		...
		/** mshop/text/manager/lists/type/standard/item/newid
		...
		/** mshop/text/manager/lists/type/standard/item/delete
		...
		/** mshop/text/manager/lists/type/standard/item/search
		...
		/** mshop/text/manager/lists/type/standard/item/count
		...
		return 'mshop/text/manager/lists/type/standard/item/';
	}
