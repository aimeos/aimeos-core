 ...
 * @subpackage Locale
 */
class MShop_Locale_Manager_Standard
	...
	implements MShop_Locale_Manager_Iface
{
	...
	{
		/** mshop/locale/manager/standard/item/delete
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/locale/manager/standard/item/insert
		 * @see mshop/locale/manager/standard/item/update
		 * @see mshop/locale/manager/standard/item/newid
		 * @see mshop/locale/manager/standard/item/search
		 * @see mshop/locale/manager/standard/item/count
		 */
		$path = 'mshop/locale/manager/standard/item/delete';
	...
	public function saveItem( MShop_Common_Item_Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/locale/manager/standard/item/insert
				 ...
				 * @see mshop/locale/manager/standard/item/update
				 * @see mshop/locale/manager/standard/item/newid
				 * @see mshop/locale/manager/standard/item/delete
				 * @see mshop/locale/manager/standard/item/search
				 * @see mshop/locale/manager/standard/item/count
				 */
				$path = 'mshop/locale/manager/standard/item/insert';
			}
			else
			{
				/** mshop/locale/manager/standard/item/update
				 ...
				 * @see mshop/locale/manager/standard/item/count
				 */
				$path = 'mshop/locale/manager/standard/item/update';
			}
			...
			{
				/** mshop/locale/manager/standard/item/newid
	 ...
	 * @param array $sitePath List of site IDs up to the root site
	 * @param array $siteSubTree List of site IDs below and including the current site
	 * @return MShop_Locale_Item_Standard Locale item
	 */
	...
	{
		return new MShop_Locale_Item_Standard( $values, $site, $sitePath, $siteSubTree );
	}
	...
	protected function search( MW_Common_Criteria_Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			...
			/** mshop/locale/manager/standard/item/search
			 ...
			 * @see mshop/locale/manager/standard/item/count
			 */
			$path = 'mshop/locale/manager/standard/item/search';
			...
			if( $total !== null )
			{
				/** mshop/locale/manager/standard/item/count
				 ...
				 * @see mshop/locale/manager/standard/item/search
				 */
				$path = 'mshop/locale/manager/standard/item/count';
