	...
	implements \Aimeos\MShop\Locale\Manager\Iface
{
	...
	{
		/** mshop/locale/manager/standard/delete
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/locale/manager/standard/insert
		 * @see mshop/locale/manager/standard/update
		 * @see mshop/locale/manager/standard/newid
		 * @see mshop/locale/manager/standard/search
		 * @see mshop/locale/manager/standard/count
		 */
	...
	public function saveItem( \Aimeos\MShop\Common\Item\Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/locale/manager/standard/insert
				 ...
				 * @see mshop/locale/manager/standard/update
				 * @see mshop/locale/manager/standard/newid
				 * @see mshop/locale/manager/standard/delete
				 * @see mshop/locale/manager/standard/search
				 * @see mshop/locale/manager/standard/count
				 */
			...
			{
				/** mshop/locale/manager/standard/update
			...
			{
				/** mshop/locale/manager/standard/newid
	...
	protected function search( \Aimeos\MW\Common\Criteria\Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			...
			/** mshop/locale/manager/standard/search
			...
			if( $total !== null )
			{
				/** mshop/locale/manager/standard/count
