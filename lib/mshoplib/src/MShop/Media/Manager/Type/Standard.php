	...
	implements \Aimeos\MShop\Media\Manager\Type\Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/media/manager/type/standard/delete' );
	}
	...
	public function getResourceType( $withsub = true )
	{
		...
		return $this->getResourceTypeBase( 'media/type', $path, array(), $withsub );
	}
	...
	{
		/** mshop/media/manager/type/standard/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/media/manager/type/standard/update
		 * @see mshop/media/manager/type/standard/newid
		 * @see mshop/media/manager/type/standard/delete
		 * @see mshop/media/manager/type/standard/search
		 * @see mshop/media/manager/type/standard/count
		 */

		/** mshop/media/manager/type/standard/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/media/manager/type/standard/insert
		 * @see mshop/media/manager/type/standard/newid
		 * @see mshop/media/manager/type/standard/delete
		 * @see mshop/media/manager/type/standard/search
		 * @see mshop/media/manager/type/standard/count
		...
		/** mshop/media/manager/type/standard/newid
		...
		/** mshop/media/manager/type/standard/delete
		...
		/** mshop/media/manager/type/standard/search
		...
		/** mshop/media/manager/type/standard/count
