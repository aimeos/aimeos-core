 ...
 * @subpackage Media
 */
class MShop_Media_Manager_Type_Standard
	extends MShop_Common_Manager_Type_Base
	implements MShop_Media_Manager_Type_Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/media/manager/type/standard/item/delete' );
	}
	...
	{
		/** classes/media/manager/type/submanagers
	...
	public function getSubManager( $manager, $name = null )
	{
		 ...
		 *
		 *  MShop_Media_Manager_Type_Standard
		 *
	...
	{
		/** mshop/media/manager/type/standard/item/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/media/manager/type/standard/item/update
		 * @see mshop/media/manager/type/standard/item/newid
		 * @see mshop/media/manager/type/standard/item/delete
		 * @see mshop/media/manager/type/standard/item/search
		 * @see mshop/media/manager/type/standard/item/count
		 */

		/** mshop/media/manager/type/standard/item/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/media/manager/type/standard/item/insert
		 * @see mshop/media/manager/type/standard/item/newid
		 * @see mshop/media/manager/type/standard/item/delete
		 * @see mshop/media/manager/type/standard/item/search
		 * @see mshop/media/manager/type/standard/item/count
		...
		/** mshop/media/manager/type/standard/item/newid
		...
		/** mshop/media/manager/type/standard/item/delete
		...
		/** mshop/media/manager/type/standard/item/search
		...
		/** mshop/media/manager/type/standard/item/count
		...
		return 'mshop/media/manager/type/standard/item/';
	}
