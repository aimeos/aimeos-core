	...
	implements \Aimeos\MShop\Media\Manager\Property\Type\Iface
{
	private $searchConfig = array(
		'media.property.type.id' => array(
			...
			'internaldeps' => array( 'LEFT JOIN "mshop_media_property_type" AS mmedprty ON ( mmedpr."typeid" = mmedprty."id" )' ),
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/media/manager/property/type/standard/delete' );
	}
	 ...
	 * @return array List of media items implementing \Aimeos\MW\Criteria\Media\Iface
	 */
	...
	public function getSubManager( $manager, $name = null )
	{
		 ...
		 * ("\Aimeos\MShop\Common\Manager\Decorator\*") around the media property type manager.
		 *
