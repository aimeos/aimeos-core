	...
	implements \Aimeos\MShop\Media\Manager\Property\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	private $searchConfig = array(
		...
		'media.property.parentid' => array(
			'code' => 'media.property.parentid',
			'internalcode' => 'mmedpr."parentid"',
			'label' => 'Property parent ID',
			'type' => 'integer',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_INT,
			'public' => false,
		),
		'media.property.siteid' => array(
		...
		'media.property.ctime' => array(
			...
			'internalcode' => 'mmedpr."ctime"',
			'label' => 'Property create date/time',
			'type' => 'datetime',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_STR,
			'public' => false,
		),
		'media.property.mtime' => array(
			'code' => 'media.property.mtime',
			'internalcode' => 'mmedpr."mtime"',
			'label' => 'Property modify date',
			'type' => 'datetime',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_STR,
			'public' => false,
		),
		'media.property.editor' => array(
	...
	protected function getConfigPath()
	{
		 ...
		 *
		 * @see mshop/media/manager/property/standard/insert/ansi
		 */
		 ...
		 * @since 2018.01
		 * @category Developer
		 * @see mshop/media/manager/property/standard/update/ansi
		 * @see mshop/media/manager/property/standard/newid/ansi
		 * @see mshop/media/manager/property/standard/delete/ansi
		 * @see mshop/media/manager/property/standard/search/ansi
		 * @see mshop/media/manager/property/standard/count/ansi
		 */
		...
		/** mshop/media/manager/property/standard/newid/mysql
		...
		return 'mshop/media/manager/property/standard/';
	}
