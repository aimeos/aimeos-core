	...
	implements \Aimeos\MShop\Media\Manager\Iface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->cleanupBase( $siteids, 'mshop/media/manager/standard/item/delete' );
	}
	...
	{
		/** mshop/media/manager/standard/item/delete
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/media/manager/standard/item/insert
		 * @see mshop/media/manager/standard/item/update
		 * @see mshop/media/manager/standard/item/newid
		 * @see mshop/media/manager/standard/item/search
		 * @see mshop/media/manager/standard/item/count
		 */
		$path = 'mshop/media/manager/standard/item/delete';
	...
	public function saveItem( \Aimeos\MShop\Common\Item\Iface $item, $fetch = true )
	{
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/media/manager/standard/item/insert
				 ...
				 * @see mshop/media/manager/standard/item/update
				 * @see mshop/media/manager/standard/item/newid
				 * @see mshop/media/manager/standard/item/delete
				 * @see mshop/media/manager/standard/item/search
				 * @see mshop/media/manager/standard/item/count
				 */
				$path = 'mshop/media/manager/standard/item/insert';
			}
			else
			{
				/** mshop/media/manager/standard/item/update
				 ...
				 * @see mshop/media/manager/standard/item/count
				 */
				$path = 'mshop/media/manager/standard/item/update';
			}
			...
			{
				/** mshop/media/manager/standard/item/newid
				 ...
				 * @see mshop/media/manager/standard/item/count
				 */
				$path = 'mshop/media/manager/standard/item/newid';
	...
	public function searchItems( \Aimeos\MW\Common\Criteria\Iface $search, array $ref = array(), &$total = null )
	{
		...
		try
		{
			 ...
			 * @see mshop/media/manager/standard/item/count
			 */
			$cfgPathSearch = 'mshop/media/manager/standard/item/search';

			/** mshop/media/manager/standard/item/count
			 ...
			 * @see mshop/media/manager/standard/item/search
			 */
			$cfgPathCount = 'mshop/media/manager/standard/item/count';
