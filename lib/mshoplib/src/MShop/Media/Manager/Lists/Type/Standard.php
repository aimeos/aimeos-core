 ...
 * @subpackage Media
 */
class MShop_Media_Manager_Lists_Type_Standard
	extends MShop_Common_Manager_Type_Base
	implements MShop_Media_Manager_Lists_Type_Iface
{
	private $searchConfig = array(
		'media.lists.type.id' => array(
			'code'=>'media.lists.type.id',
		...
		'media.lists.type.domain' => array(
			'code'=>'media.lists.type.domain',
		...
		'media.lists.type.ctime'=> array(
			'code'=>'media.lists.type.ctime',
	...
	{
		$path = 'classes/media/manager/lists/type/submanagers';
		foreach( $this->getContext()->getConfig()->get( $path, array() ) as $domain ) {
			$this->getSubManager( $domain )->cleanup( $siteids );
		}

		$this->cleanupBase( $siteids, 'mshop/media/manager/lists/type/standard/item/delete' );
	}
	...
	{
		/** classes/media/manager/lists/type/submanagers
	...
	{
		/** classes/media/manager/lists/type/name
		 ...
		 *
		 *  MShop_Media_Manager_Lists_Type_Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  MShop_Media_Manager_Lists_Type_Mytype
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/media/manager/lists/type/name = Mytype
		 *
		...
		return $this->getSubManagerBase( 'media', 'lists/type/' . $manager, $name );
	}
	...
	{
		/** mshop/media/manager/lists/type/standard/item/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/media/manager/lists/type/standard/item/update
		 * @see mshop/media/manager/lists/type/standard/item/newid
		 * @see mshop/media/manager/lists/type/standard/item/delete
		 * @see mshop/media/manager/lists/type/standard/item/search
		 * @see mshop/media/manager/lists/type/standard/item/count
		 */

		/** mshop/media/manager/lists/type/standard/item/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/media/manager/lists/type/standard/item/insert
		 * @see mshop/media/manager/lists/type/standard/item/newid
		 * @see mshop/media/manager/lists/type/standard/item/delete
		 * @see mshop/media/manager/lists/type/standard/item/search
		 * @see mshop/media/manager/lists/type/standard/item/count
		...
		/** mshop/media/manager/lists/type/standard/item/newid
		...
		/** mshop/media/manager/lists/type/standard/item/delete
		...
		/** mshop/media/manager/lists/type/standard/item/search
		...
		/** mshop/media/manager/lists/type/standard/item/count
		...
		return 'mshop/media/manager/lists/type/standard/item/';
	}
