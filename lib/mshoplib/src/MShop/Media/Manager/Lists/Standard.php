	...
	implements MShop_Media_Manager_Lists_Iface
{
	...
	{
		$path = 'classes/media/manager/lists/submanagers';
		foreach( $this->getContext()->getConfig()->get( $path, array( 'type' ) ) as $domain ) {
			$this->getSubManager( $domain )->cleanup( $siteids );
		}

		$this->cleanupBase( $siteids, 'mshop/media/manager/lists/standard/item/delete' );
	}
	...
	{
		/** classes/media/manager/lists/submanagers
	...
	{
		/** classes/media/manager/lists/name
		 ...
		 *
		 *  classes/media/manager/lists/name = Mylist
		 *
	...
	{
		/** mshop/media/manager/lists/standard/item/insert
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/media/manager/lists/standard/item/update
		 * @see mshop/media/manager/lists/standard/item/newid
		 * @see mshop/media/manager/lists/standard/item/delete
		 * @see mshop/media/manager/lists/standard/item/search
		 * @see mshop/media/manager/lists/standard/item/count
		 * @see mshop/media/manager/lists/standard/item/aggregate
		 * @see mshop/media/manager/lists/standard/item/getposmax
		 * @see mshop/media/manager/lists/standard/item/move
		 * @see mshop/media/manager/lists/standard/item/updatepos
		 */

		/** mshop/media/manager/lists/standard/item/update
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see mshop/media/manager/lists/standard/item/insert
		 * @see mshop/media/manager/lists/standard/item/newid
		 * @see mshop/media/manager/lists/standard/item/delete
		 * @see mshop/media/manager/lists/standard/item/search
		 * @see mshop/media/manager/lists/standard/item/count
		...
		/** mshop/media/manager/lists/standard/item/newid
		...
		/** mshop/media/manager/lists/standard/item/delete
		...
		/** mshop/media/manager/lists/standard/item/search
		...
		/** mshop/media/manager/lists/standard/item/count
		...
		/** mshop/media/manager/lists/standard/item/aggregate
		...
		/** mshop/media/manager/lists/standard/item/getposmax
		...
		/** mshop/media/manager/lists/standard/item/move
		...
		/** mshop/media/manager/lists/standard/item/updatepos
		...
		return 'mshop/media/manager/lists/standard/item/';
	}
