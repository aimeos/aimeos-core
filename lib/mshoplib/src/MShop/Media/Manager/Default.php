	...
	implements MShop_Media_Manager_Interface
{
	...
	public function cleanup( array $siteids )
	{
		...
		$this->_cleanup( $siteids, 'mshop/media/manager/default/item/delete' );
	}
	...
	public function getSubManager( $manager, $name = null )
	{
		 ...
		 *
		 * Each default media manager can be replaced by an alternative imlementation.
		 ...
		 *
		 *  MShop_Media_Manager_Default
		 *
		 * and you want to replace it with your own version named
		 *
		 *  MShop_Media_Manager_Mymedia
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/media/manager/name = Mymedia
		 *
