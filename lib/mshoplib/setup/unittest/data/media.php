...
return array(
	...
	'media' => array(
		...
		'media/path/to/folder/example2.jpg' => array( 'langid' => 'de', 'type' => 'prod_123x103', 'domain' => 'catalog', 'label' => 'path/to/folder/example2.jpg', 'link' => 'path/to/folder/example2.jpg', 'preview' => [1 => 'path/to/folder/example2.jpg'], 'status' => 0, 'mimetype' => 'image/jpeg' ),
		...
		'media/service_image1' => array( 'langid' => null, 'type' => 'default', 'domain' => 'service', 'label' => 'service_image1', 'link' => 'path/to/service.png', 'preview' => [1 => 'path/to/service.png'], 'status' => 1, 'mimetype' => 'image/png' ),
