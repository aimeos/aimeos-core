...
// cat description
		'text/new' => array( 'langid' => 'de', 'typeid' => 'catalog/name', 'domain' => 'catalog', 'label' => 'new', 'content' => 'Neu', 'status' => 1 ),
		'text/new_long_desc' => array( 'langid' => 'de', 'typeid' => 'catalog/long', 'domain' => 'catalog', 'label' => 'new_long_desc', 'content' => 'Neue Produkte', 'status' => 1 ),
		'text/new_metatitle' => array( 'langid' => 'de', 'typeid' => 'catalog/url', 'domain' => 'catalog', 'label' => 'new_metatitle', 'content' => 'Neu_im_Shop', 'status' => 1 ),
		'text/new_metakey' => array( 'langid' => 'de', 'typeid' => 'catalog/meta-keyword', 'domain' => 'catalog', 'label' => 'new_metakey', 'content' => 'neu', 'status' => 1 ),
		'text/new_metadesc' => array( 'langid' => 'de', 'typeid' => 'catalog/meta-description', 'domain' => 'catalog', 'label' => 'new_metadesc', 'content' => 'Neue Produkte im Shop', 'status' => 1 ),
		'text/online' => array( 'langid' => 'de', 'typeid' => 'catalog/name', 'domain' => 'catalog', 'label' => 'online', 'content' => 'Nur online', 'status' => 1 ),
		'text/online_long_desc' => array( 'langid' => 'de', 'typeid' => 'catalog/long', 'domain' => 'catalog', 'label' => 'online_long_desc', 'content' => 'Ausschliesslich online erhältlich', 'status' => 1 ),
		'text/online_metatitle' => array( 'langid' => 'de', 'typeid' => 'catalog/url', 'domain' => 'catalog', 'label' => 'online_metatitle', 'content' => 'Nur_im_Internet', 'status' => 1 ),
		'text/online_metakey' => array( 'langid' => 'de', 'typeid' => 'catalog/meta-keyword', 'domain' => 'catalog', 'label' => 'online_metakey', 'content' => 'internet', 'status' => 1 ),
		'text/online_metadesc' => array( 'langid' => 'de', 'typeid' => 'catalog/meta-description', 'domain' => 'catalog', 'label' => 'online_metadesc', 'content' => 'Nur online erhältlich', 'status' => 1 ),
//MEDIA
...
//shop texts
		...
		'text/cne_long_desc' => array( 'langid' => 'de', 'typeid' => 'product/long', 'domain' => 'product', 'label' => 'cne_long_desc', 'content' => 'Dieser kurze Kaffee mit seinem reichen Geschmack, delikaten Aroma und feinen Schaum ist das ultimative Getränk für jede Tageszeit.<br> Erhältlich in Packungen mit 16 T-DISCs (Hypermärkte) oder 8 T-DISCs (Supermärkte).', 'status' => 1 ),
		'text/cne_metatitle' => array( 'langid' => 'de', 'typeid' => 'product/url', 'domain' => 'product', 'label' => 'cne_metatitle', 'content' => 'Cafe_Noire_Expresso', 'status' => 1 ),
		'text/cne_metakey' => array( 'langid' => 'de', 'typeid' => 'product/meta-keyword', 'domain' => 'product', 'label' => 'cne_metakey', 'content' => 'Kaffee', 'status' => 1 ),
		'text/cne_metadesc' => array( 'langid' => 'de', 'typeid' => 'product/meta-description', 'domain' => 'product', 'label' => 'cne_metadesc', 'content' => 'Expresso', 'status' => 1 ),
		...
		'text/cnc_long_desc' => array( 'langid' => 'de', 'typeid' => 'product/long', 'domain' => 'product', 'label' => 'cnc_long_desc', 'content' => 'Cafe Noire gehört zu den beliebtesten Kaffeemarken in Frankreich.', 'status' => 1 ),
		'text/cnc_metatitle' => array( 'langid' => 'de', 'typeid' => 'product/url', 'domain' => 'product', 'label' => 'cnc_metatitle', 'content' => 'Cafe_Noire_Cappuccino', 'status' => 1 ),
		'text/cnc_metakey' => array( 'langid' => 'de', 'typeid' => 'product/meta-keyword', 'domain' => 'product', 'label' => 'cnc_metakey', 'content' => 'Cappuccino', 'status' => 1 ),
		'text/cnc_metadesc' => array( 'langid' => 'de', 'typeid' => 'product/meta-description', 'domain' => 'product', 'label' => 'cnc_metadesc', 'content' => 'Cafe Noire Cappuccino online kaufen', 'status' => 1 ),
//payment
...
//SERVICE
		'text/service_text1' => array( 'langid' => 'de', 'typeid' => 'service/serviceinformation', 'domain' => 'service', 'label' => 'service_text1', 'content' => 'Unittest: Service text 1 de', 'status' => 1 ),
		'text/service_text2' => array( 'langid' => 'de', 'typeid' => 'service/serviceinformation', 'domain' => 'service', 'label' => 'service_text2', 'content' => 'Unittest: Service text 2 de', 'status' => 1 ),
		'text/service_text3' => array( 'langid' => 'de', 'typeid' => 'service/serviceinformation', 'domain' => 'service', 'label' => 'service_text3', 'content' => 'Unittest: Service text 3 de', 'status' => 0 ),
		'text/service_text4' => array( 'langid' => 'de', 'typeid' => 'service/name', 'domain' => 'service', 'label' => 'service_text4', 'content' => 'Unittest service name', 'status' => 1 ),
		'text/service_text5' => array( 'langid' => 'de', 'typeid' => 'service/short', 'domain' => 'service', 'label' => 'service_text5', 'content' => 'Short service description', 'status' => 1 ),
		'text/service_text6' => array( 'langid' => 'de', 'typeid' => 'service/long', 'domain' => 'service', 'label' => 'service_text6', 'content' => 'A long description for the service item', 'status' => 1 ),
	),
);