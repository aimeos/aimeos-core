...
class MW_Setup_Task_CustomerAddColumns extends MW_Setup_Task_Abstract
{
	private $_mysql = array(
		...
		'vatno' => 'ALTER TABLE "mshop_customer" ADD "vatno" varchar(64) NOT NULL AFTER "company"',
		'title' => 'ALTER TABLE "mshop_customer" ADD "title" varchar(64) NOT NULL AFTER "vatno"',
