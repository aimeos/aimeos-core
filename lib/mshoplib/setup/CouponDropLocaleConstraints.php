 ...
 */
class MW_Setup_Task_CouponDropLocaleConstraints extends MW_Setup_Task_Abstract
{
	...
	{
		$this->_msg( 'Removing locale constraints from coupon tables', 0 );
		$this->_status( '' );

		$schema = $this->_getSchema( 'db-coupon' );
