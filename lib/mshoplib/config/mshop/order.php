						...
						'aggregate' => array(
							'ansi' => '
								...
								FROM (
									...
									:joins
									WHERE :cond
									GROUP BY mordbaprat.id, :key, :val
						...
						'aggregate' => array(
							'ansi' => '
								...
								FROM (
									...
									:joins
									WHERE :cond
									GROUP BY mordbaseat.id, :key, :val
