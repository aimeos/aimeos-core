					...
					'aggregate' => array(
						'ansi' => '
							...
							FROM (
								...
								:joins
								WHERE :cond
								GROUP BY mordbaprat.id, :keys, :val
					...
					'aggregate' => array(
						'ansi' => '
							...
							FROM (
								...
								:joins
								WHERE :cond
								GROUP BY mordbaseat.id, :keys, :val
