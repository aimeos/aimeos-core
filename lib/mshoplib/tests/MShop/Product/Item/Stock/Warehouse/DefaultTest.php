 ...
 */
class MShop_Product_Item_Stock_Warehouse_DefaultTest extends PHPUnit_Framework_TestCase
{
	private $object;
	private $values;
	...
	protected function setUp()
	{
		...
		$this->object = new MShop_Product_Item_Stock_Warehouse_Default( $this->values );
	}
