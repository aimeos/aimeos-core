 ...
 */
class MShop_Product_Manager_List_DefaultTest extends PHPUnit_Framework_TestCase
{
	private $object;
	private $context;
	private $editor = '';
	...
	protected function setUp()
	{
		...
		$productManager = MShop_Product_Manager_Factory::createManager( $this->context, 'Default' );
		$this->object = $productManager->getSubManager( 'list', 'Default' );
	}
	...
	{
		$manager = MShop_Product_Manager_Factory::createManager( $this->context, 'Default' );
