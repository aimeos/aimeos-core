 ...
 */
class MShop_Product_Manager_List_StandardTest extends PHPUnit_Framework_TestCase
{
	private $object;
	private $context;
	private $editor = '';
	...
	protected function setUp()
	{
		...
		$productManager = MShop_Product_Manager_Factory::createManager( $this->context, 'Standard' );
		$this->object = $productManager->getSubManager( 'list', 'Standard' );
	}
	...
	{
		$manager = MShop_Product_Manager_Factory::createManager( $this->context, 'Standard' );
