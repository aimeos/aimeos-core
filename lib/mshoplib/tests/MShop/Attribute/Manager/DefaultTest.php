 ...
 */
class MShop_Attribute_Manager_DefaultTest extends PHPUnit_Framework_TestCase
{
	private $object;
	private $editor = '';
	...
	{
		$this->assertInstanceOf( 'MShop_Attribute_Item_Interface', $this->object->createItem() );
	}
