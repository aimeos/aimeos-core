 ...
 */
class MShop_Text_Manager_List_Type_DefaultTest extends MW_Unittest_Testcase
{
	private $_object;
	...
	public static function main()
	{
		...
		$suite  = new PHPUnit_Framework_TestSuite('MShop_Text_Item_List_Type_DefaultTest');
	...
	public function testGetItem()
	{
		...
		$search->setConditions( $search->compare( '==', 'text.list.type.editor', $this->_editor ) );
	...
	public function testSearchItems()
	{
		...
		$conditions = array(
			...
			$search->compare( '==', 'text.list.type.editor', $this->_editor ),
		);
