...
/**
 * Test class for MShop_Customer_Manager_List_Type_Standard.
 */
class MShop_Customer_Manager_List_Type_StandardTest extends PHPUnit_Framework_TestCase
{
	private $object;
	private $editor = '';
	...
	protected function setUp()
	{
		...
		$listManager = $manager->getSubManager( 'list', 'Standard' );
