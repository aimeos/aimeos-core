...
class FactoryTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		$manager = \Aimeos\MShop\Catalog\Manager\Factory::createManager( \TestHelperMShop::getContext() );
	...
	{
		$manager = \Aimeos\MShop\Catalog\Manager\Factory::createManager( \TestHelperMShop::getContext(), 'Standard' );
		$this->assertInstanceOf( '\\Aimeos\\MShop\\Common\\Manager\\Iface', $manager );
	}
