 ...
 */
class MShop_Catalog_Manager_List_DefaultTest extends PHPUnit_Framework_TestCase
{
	private $object;
	private $context;
	private $editor = '';
	...
	protected function setUp()
	{
		...
		$manager = MShop_Catalog_Manager_Factory::createManager( $this->context, 'Default' );
