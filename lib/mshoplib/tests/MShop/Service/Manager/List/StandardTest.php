...
/**
 * Test class for MShop_Service_Manager_List_Standard.
 */
class MShop_Service_Manager_List_StandardTest extends PHPUnit_Framework_TestCase
{
	private $object;
	private $context;
	private $editor = '';
	...
	protected function setUp()
	{
		...
		$serviceManager = MShop_Service_Manager_Factory::createManager( $this->context, 'Standard' );
		$this->object = $serviceManager->getSubManager( 'list', 'Standard' );
	}
	...
	{
		$manager = MShop_Service_Manager_Factory::createManager( $this->context, 'Standard' );
