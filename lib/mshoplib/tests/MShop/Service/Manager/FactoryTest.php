...
class FactoryTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		$manager = \Aimeos\MShop\Service\Manager\Factory::createManager( \TestHelper::getContext(), 'Standard' );
		$this->assertInstanceOf( '\\Aimeos\\MShop\\Common\\Manager\\Iface', $manager );
	}
	...
	public function testCreateManagerInvalidName()
	{
		...
		\Aimeos\MShop\Service\Manager\Factory::createManager( \TestHelper::getContext(), '%^&' );
	}
	...
	public function testCreateManagerNotExisting()
	{
		...
		\Aimeos\MShop\Service\Manager\Factory::createManager( \TestHelper::getContext(), 'unknown' );
	}
}