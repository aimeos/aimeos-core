 ...
 */
class MShop_Service_Item_DefaultTest extends PHPUnit_Framework_TestCase
{
	private $object;
	...
	protected function setUp()
	{
		...
		$this->object = new MShop_Service_Item_Default( $this->values );
	}
	...
	{
		$this->assertEquals( 'Default', $this->object->getProvider() );
	}
