...
/**
 * Test class for MShop_Supplier_Item_Address_Standard.
 */
class MShop_Supplier_Item_Address_StandardTest extends PHPUnit_Framework_TestCase
{
	private $object;
	private $values;
	...
	protected function setUp()
	{
		...
		$this->object = new MShop_Supplier_Item_Address_Standard( 'supplier.address.', $this->values );
	}
	...
	{
		$object = new MShop_Common_Item_Address_Standard( 'supplier.address.' );
