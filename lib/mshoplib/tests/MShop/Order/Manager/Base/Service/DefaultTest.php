 ...
 */
class MShop_Order_Manager_Base_Service_DefaultTest extends PHPUnit_Framework_TestCase
{
	private $context;
	private $object;
	private $editor = '';
	...
	protected function setUp()
	{
		...
		$this->object = new MShop_Order_Manager_Base_Service_Default( $this->context );
	}
	...
	{
		$this->assertInstanceOf( 'MShop_Common_Manager_Interface', $this->object->getSubManager( 'attribute' ) );
		$this->assertInstanceOf( 'MShop_Common_Manager_Interface', $this->object->getSubManager( 'attribute', 'Default' ) );
