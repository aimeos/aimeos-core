...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	{
		$search = $this->object->filter()->add( ['order.editor' => 'core:lib/mshoplib', 'order.base.address.type' => 'payment'] );
	...
	public function testAggregateAddressMultiple()
	{
		...
		$search = $this->object->filter()->add( ['order.editor' => 'core:lib/mshoplib', 'order.base.address.type' => 'payment'] )->order( $cols );
