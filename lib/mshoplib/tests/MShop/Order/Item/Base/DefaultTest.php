 ...
 */
class MShop_Order_Item_Base_DefaultTest extends PHPUnit_Framework_TestCase
{
	private $object;
	private $values;
	private $locale;
	...
	protected function setUp()
	{
		...
		$this->object = new MShop_Order_Item_Base_Default( $priceManager->createItem(), $this->locale, $this->values );
