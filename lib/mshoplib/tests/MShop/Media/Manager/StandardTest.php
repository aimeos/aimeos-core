...
/**
 * Test class for MShop_Media_Manager_Standard
 */
class MShop_Media_Manager_StandardTest extends PHPUnit_Framework_TestCase
{
	private $object = null;
	private $editor = '';
	...
	public function testCreateItem()
	{
		...
		$this->assertInstanceOf( 'MShop_Media_Item_Iface', $item );
	}
