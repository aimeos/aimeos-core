 ...
 */
class MShop_Coupon_Manager_Code_DefaultTest extends PHPUnit_Framework_TestCase
{
	private $object;
	private $code;
	...
	{
		$this->assertInstanceOf( 'MShop_Coupon_Item_Code_Interface', $this->object->createItem() );
	}
