...
class MShop_Common_Item_Address_DefaultTest extends PHPUnit_Framework_TestCase
{
	...
	protected function setUp()
	{
		...
		$this->object = new MShop_Common_Item_Address_Default( 'common.address.', $this->values );
	}
	...
	public function testCopyFrom()
	{
		...
		$address = new MShop_Order_Item_Base_Address_Default( $this->values );
	...
	public function testToArray()
	{
		...
		$this->assertEquals( $this->object->getRefID(), $arrayObject['common.address.refid'] );
