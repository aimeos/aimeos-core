...
/**
 * Test class for MShop_Common_Item_List_Standard
 */
class MShop_Common_Item_List_StandardTest extends PHPUnit_Framework_TestCase
{
	private $object;
	...
	protected function setUp()
	{
		...
		$this->object = new MShop_Common_Item_List_Standard( 'common.list.', $values );
	}
	...
	{
		$obj = new MShop_Common_Item_List_Standard( 'reftest', array() );
	...
	{
		$item = new MShop_Common_Item_List_Standard( 'common.list.' );
