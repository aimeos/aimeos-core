...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	protected function setUp() : void
	{
		...
		$customer = new \Aimeos\MShop\Customer\Manager\Standard( \TestHelper::context() );
		...
		$this->fixture = array(
			...
			'customer.address.siteid' => \TestHelper::context()->locale()->getSiteId(),
		);
