...
class ListsTest extends \PHPUnit\Framework\TestCase
{
	...
	protected function setUp() : void
	{
		...
		$this->object = new \Aimeos\MShop\Common\Manager\Decorator\Lists( $this->stub, $this->context );
	}
	...
	public function testSearchRefs()
	{
		...
		$entries = $this->object->searchRefs( $entries, ['product'] );

		$this->assertEquals( 2, count( current( $entries )['.listitems'] ) );
	}
}
