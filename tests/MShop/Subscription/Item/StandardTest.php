...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	{
		$return = $this->object->setInterval( 'P0Y1M0W0DT0H' );

		$this->assertInstanceOf( \Aimeos\MShop\Subscription\Item\Iface::class, $return );
		$this->assertEquals( 'P0Y1M0W0DT0H', $this->object->getInterval() );
		$this->assertTrue( $this->object->isModified() );
	}
	...
	public function testFromArray()
	{
		...
		$list = $entries = array(
			...
			'subscription.interval' => 'P1Y0M0W0DT0H',
			'subscription.period' => 2,
			'subscription.reason' => 0,
			'subscription.status' => 1,
		);
	...
	public function testToArray()
	{
		...
		$this->assertEquals( $this->object->editor(), $list['subscription.editor'] );
	}
}
