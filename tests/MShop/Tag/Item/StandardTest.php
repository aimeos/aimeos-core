...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	protected function setUp() : void
	{
		...
		$this->object = new \Aimeos\MShop\Tag\Item\Standard( 'tag.', $this->values );
	}
	...
	{
		$item = new \Aimeos\MShop\Tag\Item\Standard( 'tag.', [] );
	...
	public function testToArray()
	{
		...
		$this->assertEquals( $this->object->editor(), $arrayObject['tag.editor'] );
	}
