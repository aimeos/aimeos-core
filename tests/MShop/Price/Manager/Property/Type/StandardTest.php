...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	protected function setUp() : void
	{
		...
		$this->object = new \Aimeos\MShop\Price\Manager\Property\Type\Standard( \TestHelper::context() );
	}
	...
	public function testGetSearchAttributes()
	{
		foreach( $this->object->getSearchAttributes() as $price ) {
			$this->assertInstanceOf( \Aimeos\Base\Criteria\Attribute\Iface::class, $price );
		}
	}
	...
	{
		$search = $this->object->filter()->add( 'price.property.type.editor', '==', $this->editor );
	...
	public function testSearch()
	{
		...
		$expr[] = $search->compare( '==', 'price.property.type.domain', 'price/property' );
