...
<?php foreach( (array) $this->get( 'textData/langid', array() ) as $idx => $langid ) : ?>
			...
			<div class="group-item card panel">
				<div id="product-item-text-group-item-<?php echo $enc->attr( $idx ); ?>" class="card-header header" role="tab">
					<select name="text[langid][]" class="combobox text-language">
				...
				<div id="product-item-text-group-data-<?php echo $enc->attr( $idx ); ?>" class="card-block"
					...
					<div class="col-sm-6">
						...
						<div class="form-group row optional">
							...
							<div class="col-sm-9">
								...
								<textarea class="form-control" rows="2" name="text[short][content][]" placeholder="<?php echo $enc->attr( $this->translate( 'admin', 'Short description' ) ); ?>" ><?php echo $enc->attr( $this->get( 'textData/short/content/' . $idx ) ); ?></textarea>
							</div>
						</div>
						<div class="form-group row optional">
					...
					<div class="col-sm-6">
						...
						<div class="form-group row optional">
							...
							<div class="col-sm-9">
								...
								<textarea class="form-control" rows="2" name="text[meta-keyword][content][]" placeholder="<?php echo $enc->attr( $this->translate( 'admin', 'Meta keywords' ) ); ?>" ><?php echo $enc->attr( $this->get( 'textData/meta-keyword/content/' . $idx ) ); ?></textarea>
							</div>
						</div>
						<div class="form-group row optional">
							...
							<div class="col-sm-9">
								...
								<textarea class="form-control" rows="6" name="text[meta-description][content][]" placeholder="<?php echo $enc->attr( $this->translate( 'admin', 'Meta description' ) ); ?>"><?php echo $enc->attr( $this->get( 'textData/meta-description/content/' . $idx ) ); ?></textarea>
							</div>
						</div>
					</div>
				</div>
