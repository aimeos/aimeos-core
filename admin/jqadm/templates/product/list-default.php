...
<?php echo $this->csrf()->formfield(); ?>
	...
	<div class="list-fields">
		...
		<ul class="fields-items search-item">
			<li class="fields-item"><label><input type="checkbox" name="fields[]" value="<?php echo $enc->attr( $this->formparam( array( 'product.id' ) ) ); ?>" <?php echo $checked( $fields, 'product.id' ); ?>> <?php echo $enc->html( $this->translate( 'admin', 'ID' ) ); ?></label></li>
			<li class="fields-item"><label><input type="checkbox" name="fields[]" value="<?php echo $enc->attr( $this->formparam( array( 'product.status' ) ) ); ?>" <?php echo $checked( $fields, 'product.status' ); ?>> <?php echo $enc->html( $this->translate( 'admin', 'Status' ) ); ?></label></li>
			<li class="fields-item"><label><input type="checkbox" name="fields[]" value="<?php echo $enc->attr( $this->formparam( array( 'product.typeid' ) ) ); ?>" <?php echo $checked( $fields, 'product.typeid' ); ?>> <?php echo $enc->html( $this->translate( 'admin', 'Type' ) ); ?></label></li>
			<li class="fields-item"><label><input type="checkbox" name="fields[]" value="<?php echo $enc->attr( $this->formparam( array( 'product.code' ) ) ); ?>" <?php echo $checked( $fields, 'product.code' ); ?>> <?php echo $enc->html( $this->translate( 'admin', 'Code' ) ); ?></label></li>
			<li class="fields-item"><label><input type="checkbox" name="fields[]" value="<?php echo $enc->attr( $this->formparam( array( 'product.label' ) ) ); ?>" <?php echo $checked( $fields, 'product.label' ); ?>> <?php echo $enc->html( $this->translate( 'admin', 'Label' ) ); ?></label></li>
			<li class="fields-item"><label><input type="checkbox" name="fields[]" value="<?php echo $enc->attr( $this->formparam( array( 'product.datestart' ) ) ); ?>" <?php echo $checked( $fields, 'product.datestart' ); ?>> <?php echo $enc->html( $this->translate( 'admin', 'Start date' ) ); ?></label></li>
			<li class="fields-item"><label><input type="checkbox" name="fields[]" value="<?php echo $enc->attr( $this->formparam( array( 'product.dateend' ) ) ); ?>" <?php echo $checked( $fields, 'product.dateend' ); ?>> <?php echo $enc->html( $this->translate( 'admin', 'End date' ) ); ?></label></li>
			<li class="fields-item"><label><input type="checkbox" name="fields[]" value="<?php echo $enc->attr( $this->formparam( array( 'product.ctime' ) ) ); ?>" <?php echo $checked( $fields, 'product.ctime' ); ?>> <?php echo $enc->html( $this->translate( 'admin', 'Created' ) ); ?></label></li>
			<li class="fields-item"><label><input type="checkbox" name="fields[]" value="<?php echo $enc->attr( $this->formparam( array( 'product.mtime' ) ) ); ?>" <?php echo $checked( $fields, 'product.mtime' ); ?>> <?php echo $enc->html( $this->translate( 'admin', 'Last modified' ) ); ?></label></li>
			<li class="fields-item"><label><input type="checkbox" name="fields[]" value="<?php echo $enc->attr( $this->formparam( array( 'product.editor' ) ) ); ?>" <?php echo $checked( $fields, 'product.editor' ); ?>> <?php echo $enc->html( $this->translate( 'admin', 'Editor' ) ); ?></label></li>
		</ul>
	</div>
...
<?php endif; ?>
				<td class="actions"><!--
					...
					--><form class="delete" action="<?php echo $enc->attr( $this->url( $delTarget, $delCntl, $delAction, array( 'id' => $id ) + $params, array(), $delConfig ) ); ?>" method="POST"><!--
						--><?php echo $this->csrf()->formfield(); ?><!--
						--><input type="hidden" name="<?php echo $enc->attr( $this->formparam( array( 'resource' ) ) ); ?>" value="<?php echo $enc->attr( $this->value( $params, 'resource' ) ); ?>" /><!--
