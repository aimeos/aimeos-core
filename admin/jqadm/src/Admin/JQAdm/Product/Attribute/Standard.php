...
{
	/** admin/jqadm/product/attribute/standard/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'admin/jqadm/product/attribute/standard/subparts';
	...
	public function copy()
	{
		...
		$tplconf = 'admin/jqadm/product/attribute/template-item';
		$default = 'product/item-attribute-default.php';
	...
	public function save()
	{
		...
		{
			$error = array( 'product-item-attribute' => $context->getI18n()->dt( 'mshop', $e->getMessage() ) );
		...
		catch( \Exception $e )
		{
			...
			$error = array( 'product-item-attribute' => $e->getMessage() );
			$view->errors = $view->get( 'errors', array() ) + $error;
			$manager->rollback();
		}
	...
	{
		/** admin/jqadm/product/attribute/decorators/excludes
		 ...
		 *
		 *  admin/jqadm/product/attribute/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see admin/jqadm/product/attribute/decorators/global
		 * @see admin/jqadm/product/attribute/decorators/local
		 */

		/** admin/jqadm/product/attribute/decorators/global
		 ...
		 *
		 *  admin/jqadm/product/attribute/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/product/attribute/decorators/excludes
		 * @see admin/jqadm/product/attribute/decorators/local
		 */

		/** admin/jqadm/product/attribute/decorators/local
		 ...
		 *
		 *  admin/jqadm/product/attribute/decorators/local = array( 'decorator2' )
		 *
		 ...
		 * @see admin/jqadm/product/attribute/decorators/global
		 */
		return $this->createSubClient( 'product/attribute/' . $type, $name );
	}
	...
	{
		$data = (array) $view->param( 'attribute', array() );
	...
	protected function updateItems( \Aimeos\MW\View\Iface $view )
	{
		...
		$listIds = (array) $view->param( 'attribute/product.lists.id', array() );
		...
		{
			$item->setId( null );
			$item->setRefId( $view->param( 'attribute/product.lists.refid/' . $pos ) );
