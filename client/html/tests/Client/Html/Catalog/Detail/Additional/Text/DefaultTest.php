...
class Client_Html_Catalog_Detail_Additional_Text_DefaultTest extends MW_Unittest_Testcase
{
	private $_object;
	...
	public static function main()
	{
		...
		$suite = new PHPUnit_Framework_TestSuite('Client_Html_Catalog_Detail_Additional_Text_DefaultTest');
