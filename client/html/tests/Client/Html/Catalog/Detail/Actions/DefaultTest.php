...
class Client_Html_Catalog_Detail_Actions_DefaultTest extends MW_Unittest_Testcase
{
	private $_object;
	...
	protected function setUp()
	{
		...
		$this->_object = new Client_Html_Catalog_Detail_Actions_Default( TestHelper::getContext(), $paths );
