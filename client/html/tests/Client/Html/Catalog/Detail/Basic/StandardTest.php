...
class Client_Html_Catalog_Detail_Basic_StandardTest extends PHPUnit_Framework_TestCase
{
	private $object;
	...
	protected function setUp()
	{
		...
		$this->object = new Client_Html_Catalog_Detail_Basic_Standard( TestHelper::getContext(), $paths );
