...
class Client_Html_Catalog_Detail_Suggest_DefaultTest extends MW_Unittest_Testcase
{
	private $_object;
	...
	public static function main()
	{
		...
		$suite = new PHPUnit_Framework_TestSuite('Client_Html_Catalog_Detail_Suggest_DefaultTest');
	...
	protected function setUp()
	{
		...
		$this->_object = new Client_Html_Catalog_Detail_Suggest_Default( TestHelper::getContext(), $paths );
