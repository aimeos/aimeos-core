...
class Client_Html_Catalog_Lists_Quote_StandardTest extends PHPUnit_Framework_TestCase
{
	private $object;
	...
	protected function setUp()
	{
		...
		$this->object = new Client_Html_Catalog_Lists_Quote_Standard( $context, $paths );
