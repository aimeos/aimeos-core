...
class Client_Html_Catalog_List_Quote_StandardTest extends PHPUnit_Framework_TestCase
{
	private $object;
	...
	protected function setUp()
	{
		...
		$this->object = new Client_Html_Catalog_List_Quote_Standard( $context, $paths );
