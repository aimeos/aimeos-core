...
class Client_Html_Catalog_List_Items_StandardTest extends PHPUnit_Framework_TestCase
{
	private $object;
	...
	protected function setUp()
	{
		...
		$this->object = new Client_Html_Catalog_List_Items_Standard( $context, $paths );
