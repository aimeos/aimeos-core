...
class Client_Html_Catalog_List_StandardTest extends PHPUnit_Framework_TestCase
{
	private $object;
	private $context;
	...
	protected function setUp()
	{
		...
		$this->object = new Client_Html_Catalog_List_Standard( $this->context, $paths );
	...
	public function testGetBodyDefaultCat()
	{
		...
		$paths = TestHelper::getHtmlTemplatePaths();
		$this->object = new Client_Html_Catalog_List_Standard( $context, $paths );
		$this->object->setView( TestHelper::getView() );
