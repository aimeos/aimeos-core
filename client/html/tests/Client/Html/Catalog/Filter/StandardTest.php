...
class Client_Html_Catalog_Filter_StandardTest extends PHPUnit_Framework_TestCase
{
	private $object;
	...
	protected function setUp()
	{
		...
		$this->object = new Client_Html_Catalog_Filter_Standard( TestHelper::getContext(), $paths );
