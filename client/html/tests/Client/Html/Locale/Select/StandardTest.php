...
class Client_Html_Locale_Select_StandardTest extends PHPUnit_Framework_TestCase
{
	private $object;
	...
	protected function setUp()
	{
		...
		$this->object = new Client_Html_Locale_Select_Standard( TestHelper::getContext(), $paths );
