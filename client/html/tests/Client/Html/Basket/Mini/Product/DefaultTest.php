...
class Client_Html_Basket_Mini_Product_DefaultTest extends PHPUnit_Framework_TestCase
{
	private $_object;
	private $_context;
	...
	protected function setUp()
	{
		...
		$this->_object = new Client_Html_Basket_Mini_Product_Default( $this->_context, $paths );
