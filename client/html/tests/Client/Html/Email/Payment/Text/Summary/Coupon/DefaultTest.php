...
class Client_Html_Email_Payment_Text_Summary_Coupon_DefaultTest
	extends MW_Unittest_Testcase
{
	...
	protected function setUp()
	{
		...
		$this->_object = new Client_Html_Email_Payment_Text_Summary_Coupon_Default( $this->_context, $paths );
