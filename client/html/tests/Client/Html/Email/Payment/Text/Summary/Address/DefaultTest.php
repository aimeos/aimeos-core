...
class Client_Html_Email_Payment_Text_Summary_Address_DefaultTest extends PHPUnit_Framework_TestCase
{
	...
	protected function setUp()
	{
		...
		$this->_object = new Client_Html_Email_Payment_Text_Summary_Address_Default( $this->_context, $paths );
