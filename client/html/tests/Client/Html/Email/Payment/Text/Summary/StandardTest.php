...
class Client_Html_Email_Payment_Text_Summary_StandardTest extends PHPUnit_Framework_TestCase
{
	...
	protected function setUp()
	{
		...
		$this->object = new Client_Html_Email_Payment_Text_Summary_Standard( $this->context, $paths );
