...
class Client_Html_Email_Payment_Text_DefaultTest extends PHPUnit_Framework_TestCase
{
	...
	protected function setUp()
	{
		...
		$this->object = new Client_Html_Email_Payment_Text_Default( $this->context, $paths );
