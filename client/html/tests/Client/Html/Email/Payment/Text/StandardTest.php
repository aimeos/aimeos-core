...
class Client_Html_Email_Payment_Text_StandardTest extends PHPUnit_Framework_TestCase
{
	...
	protected function setUp()
	{
		...
		$this->object = new Client_Html_Email_Payment_Text_Standard( $this->context, $paths );
