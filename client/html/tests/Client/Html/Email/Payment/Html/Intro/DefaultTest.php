...
class Client_Html_Email_Payment_Html_Intro_DefaultTest extends MW_Unittest_Testcase
{
	...
	protected function setUp()
	{
		...
		$this->_object = new Client_Html_Email_Payment_Html_Intro_Default( $this->_context, $paths );
