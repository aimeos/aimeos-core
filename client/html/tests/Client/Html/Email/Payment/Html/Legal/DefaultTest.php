...
class Client_Html_Email_Payment_Html_Legal_DefaultTest extends PHPUnit_Framework_TestCase
{
	...
	protected function setUp()
	{
		...
		$this->_object = new Client_Html_Email_Payment_Html_Legal_Default( $this->_context, $paths );
