...
class Client_Html_Email_Confirm_Main_Text_Detail_DefaultTest extends MW_Unittest_Testcase
{
	private $_object;
	private $_context;
	...
	public static function main()
	{
		...
		$suite = new PHPUnit_Framework_TestSuite('Client_Html_Email_Confirm_Main_Text_Detail_DefaultTest');
