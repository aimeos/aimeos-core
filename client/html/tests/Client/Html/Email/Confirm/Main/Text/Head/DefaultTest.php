...
class Client_Html_Email_Confirm_Main_Text_Head_DefaultTest extends MW_Unittest_Testcase
{
	protected $_object;
	protected $_context;
	...
	public static function main()
	{
		...
		$suite = new PHPUnit_Framework_TestSuite('Client_Html_Email_Confirm_Main_Text_Head_DefaultTest');
	...
	protected function setUp()
	{
		...
		$this->_object = new Client_Html_Email_Confirm_Main_Text_Head_Default( $this->_context, $paths );
