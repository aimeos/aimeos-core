...
class Client_Html_Email_Delivery_Html_Summary_DefaultTest extends PHPUnit_Framework_TestCase
{
	...
	protected function setUp()
	{
		...
		$this->object = new Client_Html_Email_Delivery_Html_Summary_Default( $this->context, $paths );
