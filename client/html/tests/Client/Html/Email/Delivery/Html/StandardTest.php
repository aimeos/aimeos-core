...
class Client_Html_Email_Delivery_Html_StandardTest extends PHPUnit_Framework_TestCase
{
	...
	protected function setUp()
	{
		...
		$this->object = new Client_Html_Email_Delivery_Html_Standard( $this->context, $paths );
