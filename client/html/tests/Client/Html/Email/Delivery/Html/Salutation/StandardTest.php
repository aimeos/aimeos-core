...
class Client_Html_Email_Delivery_Html_Salutation_StandardTest extends PHPUnit_Framework_TestCase
{
	...
	protected function setUp()
	{
		...
		$this->object = new Client_Html_Email_Delivery_Html_Salutation_Standard( $this->context, $paths );
