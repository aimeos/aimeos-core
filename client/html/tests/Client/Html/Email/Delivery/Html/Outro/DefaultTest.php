...
class Client_Html_Email_Delivery_Html_Outro_DefaultTest extends PHPUnit_Framework_TestCase
{
	...
	protected function setUp()
	{
		...
		$this->_object = new Client_Html_Email_Delivery_Html_Outro_Default( $this->_context, $paths );
