...
class Client_Html_Email_Delivery_Text_Legal_DefaultTest extends MW_Unittest_Testcase
{
	...
	protected function setUp()
	{
		...
		$this->_object = new Client_Html_Email_Delivery_Text_Legal_Default( $this->_context, $paths );
