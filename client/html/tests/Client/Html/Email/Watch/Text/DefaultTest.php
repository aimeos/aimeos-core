...
class Client_Html_Email_Watch_Text_DefaultTest extends PHPUnit_Framework_TestCase
{
	...
	protected function setUp()
	{
		...
		$this->_object = new Client_Html_Email_Watch_Text_Default( $this->_context, $paths );
