...
class Client_Html_Email_Watch_Text_Detail_DefaultTest extends PHPUnit_Framework_TestCase
{
	...
	protected function setUp()
	{
		...
		$this->object = new Client_Html_Email_Watch_Text_Detail_Default( $this->context, $paths );
