...
class Client_Html_Email_Account_Text_Outro_StandardTest extends PHPUnit_Framework_TestCase
{
	...
	protected function setUp()
	{
		...
		$this->object = new Client_Html_Email_Account_Text_Outro_Standard( $this->context, $paths );
