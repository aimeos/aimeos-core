...
class Client_Html_Email_Account_Html_Intro_DefaultTest extends PHPUnit_Framework_TestCase
{
	...
	protected function setUp()
	{
		...
		$this->_object = new Client_Html_Email_Account_Html_Intro_Default( $this->_context, $paths );
