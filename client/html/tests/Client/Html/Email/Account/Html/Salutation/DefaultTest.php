...
class Client_Html_Email_Account_Html_Salutation_DefaultTest extends PHPUnit_Framework_TestCase
{
	...
	protected function setUp()
	{
		...
		$this->_object = new Client_Html_Email_Account_Html_Salutation_Default( $this->_context, $paths );
