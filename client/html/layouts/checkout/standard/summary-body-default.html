...
<section class="checkout-standard-summary common-summary">
	<h1><?php echo $enc->html( $this->translate( 'client/html', 'summary' ), $enc::TRUST ); ?></h1>
	<p class="note"><?php echo $enc->html( $this->translate( 'client/html', 'Please check your order' ), $enc::TRUST ); ?></p>
...
<?php echo $this->get( 'summaryBody' ); ?>
	<div class="button-group">
		...
		<button class="standardbutton btn-action"><?php echo $enc->html( $this->translate( 'client/html', 'Buy now' ), $enc::TRUST ); ?></button>
	</div>
</section>
