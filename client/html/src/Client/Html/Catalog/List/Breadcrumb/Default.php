...
/**
 * Default implementation of catalog list breadcrumb section for HTML clients.
 *
 * @package Client
 * @subpackage Html
 */
class Client_Html_Catalog_List_Breadcrumb_Default
	extends Client_Html_Abstract
	implements Client_Html_Interface
{
	private $_subPartNames = array();
	private $_subPartPath = 'client/html/catalog/list/breadcrumb/default/subparts';
	...
	{
		return $this->_createSubClient( 'catalog/list/breadcrumb/' . $type, $name );
	}
