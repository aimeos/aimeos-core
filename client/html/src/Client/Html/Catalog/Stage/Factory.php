	...
	implements Client_Html_Common_Factory_Interface
{
	...
	{
		/** classes/client/html/catalog/stage/name
		 ...
		 *
		 *  Client_Html_Catalog_Stage_Default
		 *
		 * and you want to replace it with your own version named
		 *
		 *  Client_Html_Catalog_Stage_Mystage
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/client/html/catalog/stage/name = Mystage
		 *
		...
		return self::_addClientDecorators( $context, $client, $templatePaths, 'catalog/stage' );
	}
}
