 ...
 * @subpackage Html
 */
class Client_Html_Catalog_Count_Tree_Standard
	...
	implements Client_Html_Common_Client_Factory_Iface
{
	...
	public function getBody( $uid = '', array &$tags = array(), &$expire = null )
	{
		...
		/** client/html/catalog/count/tree/default/template-body
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see client/html/catalog/count/tree/default/template-header
		 */
	...
	public function getHeader( $uid = '', array &$tags = array(), &$expire = null )
	{
		...
		/** client/html/catalog/count/tree/default/template-header
		 * Relative path to the HTML header template of the catalog count tree client.
		 *
		 * The template file contains the HTML code and processing instructions
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see client/html/catalog/count/tree/default/template-body
		 */
