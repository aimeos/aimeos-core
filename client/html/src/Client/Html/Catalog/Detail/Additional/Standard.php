...
{
	/** client/html/catalog/detail/additional/standard/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/catalog/detail/additional/standard/subparts';
	...
	public function getBody( $uid = '', array &$tags = array(), &$expire = null )
	{
		...
		/** client/html/catalog/detail/additional/standard/template-body
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see client/html/catalog/detail/additional/standard/template-header
		 */
		$tplconf = 'client/html/catalog/detail/additional/standard/template-body';
		$default = 'catalog/detail/additional-body-default.php';
	...
	public function getHeader( $uid = '', array &$tags = array(), &$expire = null )
	{
		...
		/** client/html/catalog/detail/additional/standard/template-header
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see client/html/catalog/detail/additional/standard/template-body
		 */
		$tplconf = 'client/html/catalog/detail/additional/standard/template-header';
		$default = 'catalog/detail/additional-header-default.php';
	...
	{
		/** client/html/catalog/detail/additional/decorators/excludes
		 * Excludes decorators added by the "common" option from the catalog detail additional html client
		 *
		 ...
		 * @see client/html/catalog/detail/additional/decorators/local
		 */

		/** client/html/catalog/detail/additional/decorators/global
		 * Adds a list of globally available decorators only to the catalog detail additional html client
		 *
		 * Decorators extend the functionality of a class by adding new aspects
		 * (e.g. log what is currently done), executing the methods of the underlying
		 * class only in certain conditions (e.g. only for logged in users) or
		 ...
		 * @category Developer
		 * @see client/html/common/decorators/default
		 * @see client/html/catalog/detail/additional/decorators/excludes
		 * @see client/html/catalog/detail/additional/decorators/local
		 */

		/** client/html/catalog/detail/additional/decorators/local
		 * Adds a list of local decorators only to the catalog detail additional html client
		 *
		 * Decorators extend the functionality of a class by adding new aspects
		 * (e.g. log what is currently done), executing the methods of the underlying
		 * class only in certain conditions (e.g. only for logged in users) or
