 ...
 * @subpackage Html
 */
class Client_Html_Catalog_Filter_Search_Standard
	extends Client_Html_Common_Client_Factory_Base
	implements Client_Html_Common_Client_Factory_Iface
{
	/** client/html/catalog/filter/search/default/subparts
	...
	public function getBody( $uid = '', array &$tags = array(), &$expire = null )
	{
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see client/html/catalog/filter/search/default/template-header
		 */
	...
	public function getHeader( $uid = '', array &$tags = array(), &$expire = null )
	{
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see client/html/catalog/filter/search/default/template-body
		 */
