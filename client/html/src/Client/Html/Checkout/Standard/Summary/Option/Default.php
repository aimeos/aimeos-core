	...
	implements Client_Html_Interface
{
	...
	public function getBody( $uid = '', array &$tags = array(), &$expire = null )
	{
		...
		/** client/html/checkout/standard/summary/option/default/template-body
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see client/html/checkout/standard/summary/option/default/template-header
		 */
	...
	public function getHeader( $uid = '', array &$tags = array(), &$expire = null )
	{
		...
		/** client/html/checkout/standard/summary/option/default/template-header
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see client/html/checkout/standard/summary/option/default/template-body
		 */
