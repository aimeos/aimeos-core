 ...
 * @subpackage Html
 */
class Client_Html_Checkout_Confirm_Retry_Standard
	extends Client_Html_Common_Client_Factory_Base
	implements Client_Html_Common_Client_Factory_Iface
{
	/** client/html/checkout/confirm/retry/default/subparts
	...
	public function getBody( $uid = '', array &$tags = array(), &$expire = null )
	{
		...
		/** client/html/checkout/confirm/retry/default/template-body
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see client/html/checkout/confirm/retry/default/template-header
		 */
	...
	public function getHeader( $uid = '', array &$tags = array(), &$expire = null )
	{
		...
		/** client/html/checkout/confirm/retry/default/template-header
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see client/html/checkout/confirm/retry/default/template-body
		 */
