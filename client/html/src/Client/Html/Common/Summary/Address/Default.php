	...
	implements Client_Html_Common_Client_Factory_Interface
{
	...
	public function getBody( $uid = '', array &$tags = array(), &$expire = null )
	{
		...
		/** client/html/common/summary/address/default/template-body
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see client/html/common/summary/address/default/template-header
		 */
	...
	public function getHeader( $uid = '', array &$tags = array(), &$expire = null )
	{
		...
		/** client/html/common/summary/address/default/template-header
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see client/html/common/summary/address/default/template-body
		 */
	...
	{
		return $this->createSubClient( 'common/summary/address/' . $type, $name );
	}
