 ...
 * @subpackage Html
 */
class Client_Html_Basket_Mini_Factory
	...
	implements Client_Html_Common_Factory_Interface
{
	...
	{
		/** classes/client/html/basket/mini/name
		 ...
		 *
		 *  Client_Html_Basket_Mini_Default
		 *
		 * and you want to replace it with your own version named
		 *
		 *  Client_Html_Basket_Mini_Mybasket
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/client/html/basket/mini/name = Mybasket
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'classes/client/html/basket/mini/name', 'Default' );
		}

		if( ctype_alnum( $name ) === false )
		{
			$classname = is_string( $name ) ? 'Client_Html_Basket_Mini_' . $name : '<not a string>';
		 ...
		 * @see client/html/basket/mini/decorators/global
		 */
		return self::_addClientDecorators( $context, $client, 'basket/mini' );
	}
