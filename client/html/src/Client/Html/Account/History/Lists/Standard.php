 ...
 * @subpackage Html
 */
class Client_Html_Account_History_Lists_Standard
	...
	implements Client_Html_Common_Client_Factory_Iface
{
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/account/history/list/default/subparts';
	...
	{
		/** client/html/account/history/list/decorators/excludes
		 ...
		 *
		 *  client/html/account/history/list/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see client/html/account/history/list/decorators/global
		 * @see client/html/account/history/list/decorators/local
		 */

		/** client/html/account/history/list/decorators/global
		 ...
		 *
		 *  client/html/account/history/list/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see client/html/common/decorators/default
		 * @see client/html/account/history/list/decorators/excludes
		 * @see client/html/account/history/list/decorators/local
		 */

		/** client/html/account/history/list/decorators/local
		 ...
		 *
		 *  client/html/account/history/list/decorators/local = array( 'decorator2' )
		 *
		...
		return $this->createSubClient( 'account/history/list/' . $type, $name );
	}
