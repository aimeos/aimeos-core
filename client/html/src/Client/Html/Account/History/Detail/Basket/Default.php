...
{
	private $_cache;
	private $_subPartPath = 'client/html/account/history/detail/basket/default/subparts';
	...
	public function getBody()
	{
		...
		$tplconf = 'client/html/account/history/detail/basket/default/template-body';
		$default = 'account/history/detail-basket-body-default.html';
	...
	public function getHeader()
	{
		...
		$tplconf = 'client/html/account/history/detail/basket/default/template-header';
		$default = 'account/history/detail-basket-header-default.html';
	...
	{
		return $this->_createSubClient( 'account/history/detail/basket/' . $type, $name );
	}
