	...
	extends Client_Html_Abstract
{
	...
	public function getBody()
	{
		...
		$tplconf = 'client/html/email/delivery/text/summary/service/default/template-body';
	...
	public function getHeader()
	{
		...
		$status = $view->extOrderItem->getDeliveryStatus();
		$tplconf = 'client/html/email/delivery/text/summary/service/default/template-header';
	...
	{
		return $this->_createSubClient( 'email/delivery/text/summary/service/' . $type, $name );
	}
