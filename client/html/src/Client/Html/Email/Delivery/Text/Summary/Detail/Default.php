 ...
 * @subpackage Html
 */
class Client_Html_Email_Delivery_Text_Summary_Detail_Default
	extends Client_Html_Common_Summary_Detail_Default
{
	private $_subPartPath = 'client/html/email/delivery/text/summary/detail/default/subparts';
	...
	public function getBody()
	{
		...
		$tplconf = 'client/html/email/delivery/text/summary/detail/default/template-body';
	...
	public function getHeader()
	{
		...
		$status = $view->extOrderItem->getDeliveryStatus();
		$tplconf = 'client/html/email/delivery/text/summary/detail/default/template-header';
	...
	{
		return $this->_createSubClient( 'email/delivery/text/summary/detail/' . $type, $name );
	}
