...
{
	private $_cache;
	private $_subPartPath = 'client/html/email/delivery/text/default/subparts';
	...
	public function getBody()
	{
		...
		$tplconf = 'client/html/email/delivery/text/default/template-body';
	...
	public function getHeader()
	{
		...
		$status = $view->extOrderItem->getDeliveryStatus();
		$tplconf = 'client/html/email/delivery/text/default/template-header';
	...
	{
		return $this->_createSubClient( 'email/delivery/text/' . $type, $name );
	}
