 ...
 * @subpackage Html
 */
class Client_Html_Email_Delivery_Text_Summary_Default
	extends Client_Html_Abstract
	implements Client_Html_Interface
{
	private $_subPartPath = 'client/html/email/delivery/text/summary/default/subparts';
	...
	public function getBody()
	{
		...
		$tplconf = 'client/html/email/delivery/text/summary/default/template-body';
	...
	public function getHeader()
	{
		...
		$status = $view->extOrderItem->getDeliveryStatus();
		$tplconf = 'client/html/email/delivery/text/summary/default/template-header';
	...
	{
		return $this->_createSubClient( 'email/delivery/text/summary/' . $type, $name );
	}
