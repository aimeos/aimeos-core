	...
	extends Client_Html_Abstract
{
	...
	public function getBody()
	{
		...
		$default = array( 'email/delivery/' . $status . '/html-outro-body-default.html', 'email/delivery/html-outro-body-default.html' );
	...
	public function getHeader()
	{
		...
		$default = array( 'email/delivery/' . $status . '/html-outro-header-default.html', 'email/delivery/html-outro-header-default.html' );
