	...
	extends Client_Html_Abstract
{
	 ...
	 * @category Developer
	 */
	private $_subPartPath = 'client/html/email/watch/text/intro/default/subparts';
	...
	public function getBody( $uid = '', array &$tags = array(), &$expire = null )
	{
		...
		return $view->render( $this->_getTemplate( $tplconf, 'email/watch/text-intro-body-default.html' ) );
	}
	...
	public function getHeader( $uid = '', array &$tags = array(), &$expire = null )
	{
		...
		return $view->render( $this->_getTemplate( $tplconf, 'email/watch/text-intro-header-default.html' ) );
	}
	...
	{
		return $this->_createSubClient( 'email/watch/text/intro/' . $type, $name );
	}
