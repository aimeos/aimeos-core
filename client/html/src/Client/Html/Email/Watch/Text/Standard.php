	...
	implements Client_Html_Common_Client_Factory_Iface
{
	 ...
	 *
	 * Use "Myname" if your class is named "Client_Html_Email_Watch_Text_Salutation_Myname".
	...
	/** client/html/email/watch/text/intro/name
	 * Name of the introduction part used by the product notification email text client implementation
	 *
	 * Use "Myname" if your class is named "Client_Html_Email_Watch_Text_Intro_Myname".
	 * The name is case-sensitive and you should avoid camel case names like "MyName".
	 *
	 * @param string Last part of the client class name
	 * @since 2014.09
	...
	/** client/html/email/watch/text/detail/name
	 * Name of the summary part used by the product notification email text client implementation
	 *
	 * Use "Myname" if your class is named "Client_Html_Email_Watch_Text_Detail_Myname".
	 * The name is case-sensitive and you should avoid camel case names like "MyName".
	 *
	 * @param string Last part of the client class name
	 * @since 2014.09
	...
	/** client/html/email/watch/text/outro/name
	 * Name of the footer part used by the product notification email text client implementation
	 *
	 * Use "Myname" if your class is named "Client_Html_Email_Watch_Text_Outro_Myname".
	 * The name is case-sensitive and you should avoid camel case names like "MyName".
	 *
	 * @param string Last part of the client class name
	 * @since 2014.09
	...
	public function getBody( $uid = '', array &$tags = array(), &$expire = null )
	{
		...
		/** client/html/email/watch/text/default/template-body
		 ...
		 * @since 2014.09
		 * @category Developer
		 * @see client/html/email/watch/text/default/template-header
		 */
	...
	public function getHeader( $uid = '', array &$tags = array(), &$expire = null )
	{
		...
		/** client/html/email/watch/text/default/template-header
		 * Relative path to the text header template of the product notification email text client.
		 *
		 * The template file contains the text and processing instructions
		 ...
		 * @since 2014.09
		 * @category Developer
		 * @see client/html/email/watch/text/default/template-body
		 */
