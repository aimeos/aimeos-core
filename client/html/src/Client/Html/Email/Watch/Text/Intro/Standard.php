...
{
	/** client/html/email/watch/text/intro/standard/subparts
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/email/watch/text/intro/standard/subparts';
	...
	public function getBody( $uid = '', array &$tags = array(), &$expire = null )
	{
		...
		/** client/html/email/watch/text/intro/standard/template-body
		 ...
		 * @since 2014.09
		 * @category Developer
		 * @see client/html/email/watch/text/intro/standard/template-header
		 */
		$tplconf = 'client/html/email/watch/text/intro/standard/template-body';

		return $view->render( $this->getTemplate( $tplconf, 'email/watch/text-intro-body-default.php' ) );
	}
	...
	public function getHeader( $uid = '', array &$tags = array(), &$expire = null )
	{
		...
		/** client/html/email/watch/text/intro/standard/template-header
		 ...
		 * @since 2014.09
		 * @category Developer
		 * @see client/html/email/watch/text/intro/standard/template-body
		 */
		$tplconf = 'client/html/email/watch/text/intro/standard/template-header';

		return $view->render( $this->getTemplate( $tplconf, 'email/watch/text-intro-header-default.php' ) );
	}
