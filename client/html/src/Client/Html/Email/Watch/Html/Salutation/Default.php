...
/**
 * Default implementation of product notification e-mail html salutation part.
 *
 * @package Client
 * @subpackage Html
 */
class Client_Html_Email_Watch_Html_Salutation_Default
	extends Client_Html_Abstract
	implements Client_Html_Common_Client_Factory_Interface
{
	/** client/html/email/watch/html/salutation/default/subparts
	 ...
	 * @category Developer
	 */
	private $_subPartPath = 'client/html/email/watch/html/salutation/default/subparts';
	...
	public function getBody( $uid = '', array &$tags = array(), &$expire = null )
	{
		...
		/** client/html/email/watch/html/salutation/default/template-body
		 ...
		 * @since 2014.09
		 * @category Developer
		 * @see client/html/email/watch/html/salutation/default/template-header
		 */
		$tplconf = 'client/html/email/watch/html/salutation/default/template-body';
	...
	public function getHeader( $uid = '', array &$tags = array(), &$expire = null )
	{
		...
		/** client/html/email/watch/html/salutation/default/template-header
		 ...
		 * @since 2014.09
		 * @category Developer
		 * @see client/html/email/watch/html/salutation/default/template-body
		 */
		$tplconf = 'client/html/email/watch/html/salutation/default/template-header';
	...
	{
		/** client/html/email/watch/html/salutation/decorators/excludes
		 * Excludes decorators added by the "common" option from the email watch html salutation html client
		 *
		 ...
		 *
		 *  client/html/email/watch/html/salutation/decorators/excludes = array( 'decorator1' )
		 *
		...
		/** client/html/email/watch/html/salutation/decorators/global
		...
		return $this->_createSubClient( 'email/watch/html/salutation/' . $type, $name );
	}
