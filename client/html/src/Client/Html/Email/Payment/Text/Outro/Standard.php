 ...
 * @subpackage Html
 */
class Client_Html_Email_Payment_Text_Outro_Standard
	extends Client_Html_Common_Client_Factory_Base
	implements Client_Html_Common_Client_Factory_Iface
{
	/** client/html/email/payment/text/outro/default/subparts
	...
	public function getBody( $uid = '', array &$tags = array(), &$expire = null )
	{
		...
		/** client/html/email/payment/text/outro/default/template-body
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see client/html/email/payment/text/outro/default/template-header
		 */
	...
	public function getHeader( $uid = '', array &$tags = array(), &$expire = null )
	{
		...
		/** client/html/email/payment/text/outro/default/template-header
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see client/html/email/payment/text/outro/default/template-body
		 */
