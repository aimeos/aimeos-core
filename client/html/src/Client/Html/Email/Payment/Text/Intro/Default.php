 ...
 * @subpackage Html
 */
class Client_Html_Email_Payment_Text_Intro_Default
	extends Client_Html_Abstract
{
	private $_subPartPath = 'client/html/email/payment/text/intro/default/subparts';
	...
	public function getBody()
	{
		...
		$tplconf = 'client/html/email/payment/text/intro/default/template-body';
	...
	public function getHeader()
	{
		...
		$status = $view->extOrderItem->getPaymentStatus();
		$tplconf = 'client/html/email/payment/text/intro/default/template-header';
	...
	{
		return $this->_createSubClient( 'email/payment/text/intro/' . $type, $name );
	}
