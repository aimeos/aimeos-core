	...
	implements \Aimeos\Client\Html\Common\Client\Factory\Iface
{
	 ...
	 * @category Developer
	 */
	private $subPartPath = 'client/html/email/payment/text/default/subparts';
	...
	public function getBody( $uid = '', array &$tags = array(), &$expire = null )
	{
		...
		/** client/html/email/payment/text/default/template-body
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see client/html/email/payment/text/default/template-header
		 */
	...
	public function getHeader( $uid = '', array &$tags = array(), &$expire = null )
	{
		...
		/** client/html/email/payment/text/default/template-header
		 ...
		 * @since 2014.03
		 * @category Developer
		 * @see client/html/email/payment/text/default/template-body
		 */
