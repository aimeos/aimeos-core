	...
	implements \Aimeos\Client\Html\Common\Client\Factory\Iface
{
	...
	*/
	...
	public function getHeader( $uid = '', array &$tags = array(), &$expire = null )
	{
		...
		/** client/html/email/payment/html/summary/detail/standard/template-header
		 * Relative path to the HTML header template of the summary detail section of the payment HTML e-mail client.
		 *
		 * The template file contains the HTML code and processing instructions
		 ...
		 * @since 2015.11
		 * @category Developer
		 * @see client/html/email/payment/html/summary/detail/standard/template-body
		 */
		$tplconf = 'client/html/email/payment/html/summary/detail/standard/template-header';
