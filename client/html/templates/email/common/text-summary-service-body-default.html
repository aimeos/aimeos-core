...
<?php	echo strip_tags( $this->translate( 'client/html', 'Delivery' ) ); ?>: <?php echo strip_tags( $service->getName() ); ?>
...
<?php	echo strip_tags( $this->translate( 'client/html', 'Payment' ) ); ?>: <?php echo strip_tags( $service->getName() ); ?>
