...
<?php	echo $this->partial( 'client/html/common/partials/price', 'common/partials/price-default.php', array( 'prices' => $this->detailProductItem->getRefItems( 'price', 'default', 'default' ) ) ); ?>
	</div>
<?php endif; ?>
...
<?php echo $this->get( 'basketBody' ); ?>
		...
		<div class="addbasket">
			<div class="group">
				...
				<input name="<?php echo $enc->attr( $this->formparam( array( 'b_prod', 0, 'prodid' ) ) ); ?>" type="hidden" value="<?php echo $enc->attr( $this->param( 'd_prodid' ) ); ?>" />
