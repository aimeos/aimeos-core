...
<div class="catalog-detail-basket-service">
	<span class=""><?php echo $enc->html( $this->translate( 'client', '+ shipping costs' ) ); ?></span>
<?php if( !empty( $items ) ) : ?>
	<ul class="service-list">
<?php	foreach( $items as $item ) : ?>
		<li class="service-item">
			<span class="service-name"><?php echo $enc->html( $item->getName() ); ?></span>
<?php		echo $this->partial( $this->config( 'client/html/common/partials/price', 'common/partials/price-default.php' ), array( 'prices' => $item->getRefItems( 'price', null, 'default' ) ) ); ?>
