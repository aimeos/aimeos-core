 ...
 * be relative to the layouts/ folder, e.g. "common/partials/media-default.php". 
 *
...
<?php			echo '-->' . $this->partial( 'client/html/common/partials/media', 'common/partials/media-default.php', $values ) . '<!--'; ?>
<?php		endif; ?>
<?php	endforeach; ?>
			--></div><!--
