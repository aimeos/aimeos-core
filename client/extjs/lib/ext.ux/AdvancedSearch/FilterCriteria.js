 ...
 */
Ext.ux.AdvancedSearch.FilterCriteria = Ext
                .extend(
                    Ext.Container,
                    {
                        ...
                        createFilter : function(r) {
                            var def = r.get('definition'), filter = Ext.ComponentMgr.create(def), defValue = filter
                                            .getValue(), defOp = filter.getOperator();
                        ...
                        onCriteriaSelect : function(combo, newRecord, newKey) {
                            var newFilter = this.createFilter(newRecord), defValue = newFilter.getValue(), defOp = newFilter
                                            .getOperator(), oldValue = this.filter.getValue(), oldOp = this.filter
                                            .getOperator();
