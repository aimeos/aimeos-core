...
MShop.I18n = {
    ...
    getPluralIndex : function( num, locale ) {
        ...
        case 'ar':
            return ( num === 0 ) ? 0 : ( ( num === 1 ) ? 1 : ( ( num === 2 ) ? 2 : ( ( ( num >= 3 ) && ( num <= 10 ) )
                ? 3 : ( ( ( num >= 11 ) && ( num <= 99 ) ) ? 4 : 5 ) ) ) );
        ...
        case 'lt':
            return ( ( num % 10 === 1 ) && ( num % 100 !== 11 ) ) ? 0
                : ( ( ( num % 10 >= 2 ) && ( ( num % 100 < 10 ) || ( num % 100 >= 20 ) ) ) ? 1 : 2 );
        ...
        case 'mt':
            return ( num === 1 ) ? 0 : ( ( ( num === 0 ) || ( ( num % 100 > 1 ) && ( num % 100 < 11 ) ) ) ? 1
                : ( ( ( num % 100 > 10 ) && ( num % 100 < 20 ) ) ? 2 : 3 ) );

        case 'pl':
            return ( num === 1 ) ? 0
                : ( ( ( num % 10 >= 2 ) && ( num % 10 <= 4 ) && ( ( num % 100 < 12 ) || ( num % 100 > 14 ) ) ) ? 1 : 2 );

        case 'ro':
            return ( num === 1 ) ? 0 : ( ( ( num === 0 ) || ( ( num % 100 > 0 ) && ( num % 100 < 20 ) ) ) ? 1 : 2 );

        case 'sl':
            return ( num % 100 === 1 ) ? 0 : ( ( num % 100 === 2 ) ? 1
                : ( ( ( num % 100 === 3 ) || ( num % 100 === 4 ) ) ? 2 : 3 ) );
