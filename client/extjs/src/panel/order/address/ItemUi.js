...
MShop.panel.order.base.address.ItemUi = Ext.extend(Ext.Panel, {
	...
	itemId : 'MShop.panel.order.base.address.ItemUi.AddressPanel',
...
Ext.ux.ItemRegistry.registerItem('MShop.panel.order.ItemUi', MShop.panel.order.base.address.ItemUi, 20);