	...
	implements Controller_ExtJS_Common_Factory_Iface
{
	...
	{
		/** classes/controller/extjs/order/base/service/attribute/name
		 ...
		 *
		 *  Controller_ExtJS_Order_Base_Service_Attribute_Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  Controller_ExtJS_Order_Base_Service_Attribute_Myattribute
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/controller/extjs/order/base/service/attribute/name = Myattribute
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'classes/controller/extjs/order/base/service/attribute/name', 'Standard' );
		}
		 ...
		 * ("Controller_ExtJS_Order_Base_Service_Attribute_Decorator_*") around the ExtJS controller.
		 *
		 *  controller/extjs/order/base/service/attribute/decorators/local = array( 'decorator2' )
		 *
		 * This would add the decorator named "decorator2" defined by
		 * "Controller_ExtJS_Order_Base_Service_Attribute_Decorator_Decorator2" only to the ExtJS
		 * controller.
		 *
		 * @param array List of decorator names
		 * @since 2015.09
