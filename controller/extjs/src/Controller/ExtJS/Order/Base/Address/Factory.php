	...
	implements Controller_ExtJS_Common_Factory_Interface
{
	public static function createController( MShop_Context_Item_Interface $context, $name = null )
	{
		 ...
		 *
		 *  Controller_ExtJS_Order_Base_Address_Default
		 *
		 ...
		 *
		 *  classes/controller/extjs/order/base/address/name = Myaddress
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'classes/controller/extjs/order/base/address/name', 'Default' );
		}
		 ...
		 * @see controller/extjs/order/base/address/decorators/global
		 */
		return self::_addControllerDecorators( $context, $controller, 'order/base/address' );
	}
}
