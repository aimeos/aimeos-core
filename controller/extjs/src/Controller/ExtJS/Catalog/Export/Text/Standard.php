	...
	implements \Aimeos\Controller\ExtJS\Common\Load\Text\Iface
{
	...
	public function exportFile( \stdClass $params )
	{
		...
		/** controller/extjs/catalog/export/text/standard/exportdir
		 ...
		 */
		$dir = $config->get( 'controller/extjs/catalog/export/text/standard/exportdir', 'uploads' );

		/** controller/extjs/catalog/export/text/standard/dirperms
		 ...
		 * @category User
		 */
		$perms = $config->get( 'controller/extjs/catalog/export/text/standard/dirperms', 0700 );
