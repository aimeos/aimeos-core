 ...
 * @subpackage ExtJS
 */
class Controller_ExtJS_Catalog_Factory
	...
	implements Controller_ExtJS_Common_Factory_Iface
{
	...
	{
		/** classes/controller/extjs/catalog/name
		 ...
		 *
		 *  Controller_ExtJS_Catalog_Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  Controller_ExtJS_Catalog_Mycatalog
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/controller/extjs/catalog/name = Mycatalog
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'classes/controller/extjs/catalog/name', 'Standard' );
		}

		if( ctype_alnum( $name ) === false )
		{
			$classname = is_string( $name ) ? 'Controller_ExtJS_Catalog_' . $name : '<not a string>';
		 ...
		 * ("Controller_ExtJS_Catalog_Decorator_*") around the ExtJS controller.
		 *
		 *  controller/extjs/catalog/decorators/local = array( 'decorator2' )
		 *
		 * This would add the decorator named "decorator2" defined by
		 * "Controller_ExtJS_Catalog_Decorator_Decorator2" only to the ExtJS
		 * controller.
		 *
		 * @param array List of decorator names
		 * @since 2014.03
