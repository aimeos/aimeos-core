	...
	implements Controller_ExtJS_Common_Factory_Interface
{
	public static function createController( MShop_Context_Item_Interface $context, $name = null )
	{
		 ...
		 *
		 *  Controller_ExtJS_Price_Myprice
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/controller/extjs/price/name = Myprice
		 *
		...
		{
			$classname = is_string($name) ? 'Controller_ExtJS_Price_' . $name : '<not a string>';
		 ...
		 * ("Controller_ExtJS_Price_Decorator_*") around the ExtJS controller.
		 *
		 *  controller/extjs/price/decorators/local = array( 'decorator2' )
		 *
		 * This would add the decorator named "decorator2" defined by
		 * "Controller_ExtJS_Price_Decorator_Decorator2" only to the ExtJS
		 * controller.
		 *
		 * @param array List of decorator names
		 * @since 2014.03
		 ...
		 * @see controller/extjs/price/decorators/global
		 */
		return self::_addControllerDecorators( $context, $manager, 'price' );
	}
}
