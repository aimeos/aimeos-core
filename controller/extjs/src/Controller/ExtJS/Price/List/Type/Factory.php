	...
	implements Controller_ExtJS_Common_Factory_Interface
{
	public static function createController( MShop_Context_Item_Interface $context, $name = null )
	{
		 ...
		 *
		 *  Controller_ExtJS_Price_List_Type_Default
		 *
		 * and you want to replace it with your own version named
		 *
		 *  Controller_ExtJS_Price_List_Type_Mytype
		 *
		 ...
		 * ("Controller_ExtJS_Price_List_Type_Decorator_*") around the ExtJS controller.
		 *
		 *  controller/extjs/price/list/type/decorators/local = array( 'decorator2' )
		 *
		 * This would add the decorator named "decorator2" defined by
		 * "Controller_ExtJS_Price_List_Type_Decorator_Decorator2" only to the ExtJS
		 * controller.
		 *
		 * @param array List of decorator names
		 * @since 2015.09
		 ...
		 * @see controller/extjs/price/list/type/decorators/global
		 */
		return self::_addControllerDecorators( $context, $controller, 'price/list/type' );
	}
}