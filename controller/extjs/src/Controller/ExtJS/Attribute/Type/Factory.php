 ...
 * @subpackage ExtJS
 */
class Controller_ExtJS_Attribute_Type_Factory
	...
	implements Controller_ExtJS_Common_Factory_Iface
{
	...
	{
		/** classes/controller/extjs/attribute/type/name
		 ...
		 *
		 *  Controller_ExtJS_Attribute_Type_Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  Controller_ExtJS_Attribute_Type_Mytype
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/controller/extjs/attribute/type/name = Mytype
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'classes/controller/extjs/attribute/type/name', 'Standard' );
		}

		if( ctype_alnum( $name ) === false )
		{
			$classname = is_string( $name ) ? 'Controller_ExtJS_Attribute_Type_' . $name : '<not a string>';
		 ...
		 * ("Controller_ExtJS_Attribute_Type_Decorator_*") around the ExtJS controller.
		 *
		 *  controller/extjs/attribute/type/decorators/local = array( 'decorator2' )
		 *
		 * This would add the decorator named "decorator2" defined by
		 * "Controller_ExtJS_Attribute_Type_Decorator_Decorator2" only to the ExtJS
		 * controller.
		 *
		 * @param array List of decorator names
		 * @since 2015.09
