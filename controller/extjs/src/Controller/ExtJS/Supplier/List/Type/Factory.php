 ...
 * @subpackage ExtJS
 */
class Controller_ExtJS_Supplier_List_Type_Factory
	...
	implements Controller_ExtJS_Common_Factory_Iface
{
	public static function createController( MShop_Context_Item_Iface $context, $name = null )
	{
		 ...
		 *
		 *  Controller_ExtJS_Supplier_List_Type_Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  Controller_ExtJS_Supplier_List_Type_Mytype
		 *
		...
		{
			$classname = is_string( $name ) ? 'Controller_ExtJS_Supplier_List_Type_' . $name : '<not a string>';
		 ...
		 * ("Controller_ExtJS_Supplier_List_Type_Decorator_*") around the ExtJS controller.
		 *
		 *  controller/extjs/supplier/list/type/decorators/local = array( 'decorator2' )
		 *
		 * This would add the decorator named "decorator2" defined by
		 * "Controller_ExtJS_Supplier_List_Type_Decorator_Decorator2" only to the ExtJS
		 * controller.
		 *
		 * @param array List of decorator names
		 * @since 2015.09
