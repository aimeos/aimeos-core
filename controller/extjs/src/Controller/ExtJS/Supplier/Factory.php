 ...
 * @subpackage ExtJS
 */
class Controller_ExtJS_Supplier_Factory
	...
	implements Controller_ExtJS_Common_Factory_Iface
{
	...
	{
		/** classes/controller/extjs/supplier/name
		 ...
		 *
		 *  Controller_ExtJS_Supplier_Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  Controller_ExtJS_Supplier_Mysupplier
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/controller/extjs/supplier/name = Mysupplier
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'classes/controller/extjs/supplier/name', 'Standard' );
		}

		if( ctype_alnum( $name ) === false )
		{
			$classname = is_string( $name ) ? 'Controller_ExtJS_Supplier_' . $name : '<not a string>';
		 ...
		 * ("Controller_ExtJS_Supplier_Decorator_*") around the ExtJS controller.
		 *
		 *  controller/extjs/supplier/decorators/local = array( 'decorator2' )
		 *
		 * This would add the decorator named "decorator2" defined by
		 * "Controller_ExtJS_Supplier_Decorator_Decorator2" only to the ExtJS
		 * controller.
		 *
		 * @param array List of decorator names
		 * @since 2014.03
