 ...
 * @subpackage ExtJS
 */
class Controller_ExtJS_Product_Stock_Factory
	...
	implements Controller_ExtJS_Common_Factory_Iface
{
	...
	{
		/** classes/controller/extjs/product/stock/name
		 ...
		 *
		 *  Controller_ExtJS_Product_Stock_Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  Controller_ExtJS_Product_Stock_Mystock
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/controller/extjs/product/stock/name = Mystock
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'classes/controller/extjs/product/stock/name', 'Standard' );
		}

		if( ctype_alnum( $name ) === false )
		{
			$classname = is_string( $name ) ? 'Controller_ExtJS_Product_Stock_' . $name : '<not a string>';
