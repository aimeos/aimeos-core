	...
	implements Controller_ExtJS_Common_Factory_Interface
{
	public static function createController( MShop_Context_Item_Interface $context, $name = null )
	{
		...
		/** controller/extjs/product/export/text/decorators/excludes
		 * Excludes decorators added by the "common" option from the product export text ExtJS controllers
		 *
		 ...
		 *
		 *  controller/extjs/product/export/text/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see controller/extjs/product/export/text/decorators/global
		 * @see controller/extjs/product/export/text/decorators/local
		 */

		/** controller/extjs/product/export/text/decorators/global
		 * Adds a list of globally available decorators only to the product export text ExtJS controllers
		 *
		 * Decorators extend the functionality of a class by adding new aspects
		 * (e.g. log what is currently done), executing the methods of the underlying
		 * class only in certain conditions (e.g. only for logged in users) or
		 ...
		 *
		 *  controller/extjs/product/export/text/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see controller/extjs/common/decorators/default
		 * @see controller/extjs/product/export/text/decorators/excludes
		 * @see controller/extjs/product/export/text/decorators/local
		 */

		/** controller/extjs/product/export/text/decorators/local
		 * Adds a list of local decorators only to the product export text ExtJS controllers
		 *
		 * Decorators extend the functionality of a class by adding new aspects
		 * (e.g. log what is currently done), executing the methods of the underlying
		 * class only in certain conditions (e.g. only for logged in users) or
		 ...
		 * ("Controller_ExtJS_Product_Export_Text_Decorator_*") around the ExtJS controller.
		 *
		 *  controller/extjs/product/export/text/decorators/local = array( 'decorator2' )
		 *
		 * This would add the decorator named "decorator2" defined by
		 * "Controller_ExtJS_Product_Export_Text_Decorator_Decorator2" only to the ExtJS
		 * controller.
		 *
		 * @param array List of decorator names
		 * @since 2015.09
		 ...
		 * @see controller/extjs/product/export/text/decorators/global
		 */
		return self::_addControllerDecorators( $context, $controller, 'product/export/text' );
	}
}
