	...
	implements Controller_ExtJS_Common_Factory_Iface
{
	public static function createController( MShop_Context_Item_Iface $context, $name = null )
	{
		 ...
		 *
		 *  Controller_ExtJS_Product_Property_Type_Standard
		 *
		 ...
		 */
		if ( $name === null ) {
			$name = $context->getConfig()->get('classes/controller/extjs/product/property/type/name', 'Standard');
		}
		 ...
		 * ("Controller_ExtJS_Product_Property_Type_Decorator_*") around the ExtJS controller.
		 *
		 *  controller/extjs/product/property/type/decorators/local = array( 'decorator2' )
		 *
		 * This would add the decorator named "decorator2" defined by
		 * "Controller_ExtJS_Product_Property_Type_Decorator_Decorator2" only to the ExtJS
		 * controller.
		 *
		 * @param array List of decorator names
		 * @since 2015.09
