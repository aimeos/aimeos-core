	...
	implements Controller_ExtJS_Common_Factory_Iface
{
	...
	{
		/** classes/controller/extjs/admin/job/name
		 ...
		 *
		 *  Controller_ExtJS_Admin_Job_Myjob
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/controller/extjs/admin/job/name = Myjob
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'classes/controller/extjs/admin/job/name', 'Standard' );
		}
