	...
	implements Controller_ExtJS_Common_Factory_Interface
{
	public static function createController( MShop_Context_Item_Interface $context, $name = null )
	{
		 ...
		 *
		 *  Controller_ExtJS_Admin_Log_Default
		 *
		 * and you want to replace it with your own version named
		 *
		 *  Controller_ExtJS_Admin_Log_Mylog
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/controller/extjs/admin/log/name = Mylog
		 *
		...
		$classname = 'Controller_ExtJS_Admin_Log_' . $name;
		 ...
		 * ("Controller_Extjs_Admin_Log_Decorator_*") around the extjs controller.
		 *
		 *  controller/extjs/admin/log/decorators/local = array( 'decorator2' )
		 *
		 * This would add the decorator named "decorator2" defined by
		 * "Controller_Extjs_Admin_Log_Decorator_Decorator2" only to the extjs
		 * controller.
		 *
		 * @param array List of decorator names
		 * @since 2014.03
