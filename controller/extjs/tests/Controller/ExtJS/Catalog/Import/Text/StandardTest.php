...
class Controller_ExtJS_Catalog_Import_Text_StandardTest extends PHPUnit_Framework_TestCase
{
	private $object;
	private $testdir;
	private $testfile;
	...
	protected function setUp()
	{
		...
		$this->object = new Controller_ExtJS_Catalog_Import_Text_Standard( $this->context );
	}
