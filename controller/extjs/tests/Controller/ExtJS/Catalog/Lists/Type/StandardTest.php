...
class Controller_ExtJS_Catalog_Lists_Type_StandardTest extends PHPUnit_Framework_TestCase
{
	private $object;
	...
	{
		$this->object = new Controller_ExtJS_Catalog_Lists_Type_Standard( TestHelper::getContext() );
	}
