...
class Controller_ExtJS_Catalog_Export_Text_CSVTest extends MW_Unittest_Testcase
{
	private $_object;
	...
	public static function main()
	{
		...
		$suite  = new PHPUnit_Framework_TestSuite( 'Controller_ExtJS_Catalog_Export_Text_CSVTest' );
	...
	{
		$this->_object = new Controller_ExtJS_Catalog_Export_Text_CSV( TestHelper::getContext() );
	}
