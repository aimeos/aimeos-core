...
class Controller_ExtJS_Price_Type_DefaultTest extends MW_Unittest_Testcase
{
	private $_object;
	...
	public static function main()
	{
		...
		$suite  = new PHPUnit_Framework_TestSuite( 'Controller_ExtJS_Price_Type_DefaultTest' );
	...
	{
		$this->_object = new Controller_ExtJS_Price_Type_Default( TestHelper::getContext() );
	}
