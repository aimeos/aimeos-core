...
class Controller_ExtJS_Price_List_StandardTest extends PHPUnit_Framework_TestCase
{
	private $object;
	...
	{
		$this->object = new Controller_ExtJS_Price_List_Standard( TestHelper::getContext() );
	}
