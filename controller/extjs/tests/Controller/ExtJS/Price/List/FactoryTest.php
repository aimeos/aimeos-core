...
class Controller_ExtJS_Price_List_FactoryTest extends MW_Unittest_Testcase
{
	private $_object;
	...
	public static function main()
	{
		...
		$suite  = new PHPUnit_Framework_TestSuite( 'Controller_ExtJS_Price_List_FactoryTest' );
	...
	{
		$obj = Controller_ExtJS_Price_List_Factory::createController( TestHelper::getContext() );
