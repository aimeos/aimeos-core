...
class Controller_ExtJS_Admin_Cache_DefaultTest extends PHPUnit_Framework_TestCase
{
	private $object;
	...
	{
		$this->object = new Controller_ExtJS_Admin_Cache_Default( TestHelper::getContext() );
	}
