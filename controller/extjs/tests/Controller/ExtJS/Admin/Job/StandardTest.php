...
class Controller_ExtJS_Admin_Job_StandardTest extends PHPUnit_Framework_TestCase
{
	private $object;
	...
	{
		$this->object = new Controller_ExtJS_Admin_Job_Standard( TestHelper::getContext() );
	}
