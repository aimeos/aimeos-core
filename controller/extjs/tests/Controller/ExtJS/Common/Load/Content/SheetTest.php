...
class Controller_ExtJS_Common_Load_Content_SheetTest extends MW_Unittest_Testcase
{
	private $_content;
	private $_testfile;
	private $_testdir;
	...
	public static function main()
	{
		...
		$suite  = new PHPUnit_Framework_TestSuite( 'Controller_ExtJS_Common_Load_Content_SheetTest' );
	...
	protected function setUp()
	{
		...
		$container = new Controller_ExtJS_Common_Load_Container_PHPExcel($this->_testfile, 'unittest' );
		$this->_content = $container->createContent('en');
	...
	public function testNext()
	{
		...
		$this->assertEquals( 2, $this->_content->key() );
	}
