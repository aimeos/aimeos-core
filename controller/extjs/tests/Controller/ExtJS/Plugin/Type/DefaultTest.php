...
class Controller_ExtJS_Plugin_Type_DefaultTest extends PHPUnit_Framework_TestCase
{
	private $object;
	...
	{
		$this->object = new Controller_ExtJS_Plugin_Type_Default( TestHelper::getContext() );
	}
