...
class Controller_ExtJS_Order_Base_Service_FactoryTest extends MW_Unittest_Testcase
{
	private $_object;
	...
	public static function main()
	{
		...
		$suite  = new PHPUnit_Framework_TestSuite( 'Controller_ExtJS_Order_Base_Service_FactoryTest' );
