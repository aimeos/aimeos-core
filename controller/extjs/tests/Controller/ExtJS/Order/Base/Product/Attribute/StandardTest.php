...
class Controller_ExtJS_Order_Base_Product_Attribute_StandardTest extends PHPUnit_Framework_TestCase
{
	private $object;
	...
	{
		$this->object = new Controller_ExtJS_Order_Base_Product_Attribute_Standard( TestHelper::getContext() );
	}
