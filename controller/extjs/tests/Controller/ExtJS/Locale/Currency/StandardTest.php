...
class Controller_ExtJS_Locale_Currency_StandardTest extends PHPUnit_Framework_TestCase
{
	private $object;
	...
	{
		$this->object = new Controller_ExtJS_Locale_Currency_Standard( TestHelper::getContext() );
	}
