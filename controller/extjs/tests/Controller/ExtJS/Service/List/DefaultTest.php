...
class Controller_ExtJS_Service_List_DefaultTest extends PHPUnit_Framework_TestCase
{
	private $object;
	...
	{
		$this->object = new Controller_ExtJS_Service_List_Default( TestHelper::getContext() );
	}
