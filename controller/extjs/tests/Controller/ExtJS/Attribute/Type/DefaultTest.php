...
class Controller_ExtJS_Attribute_Type_DefaultTest extends PHPUnit_Framework_TestCase
{
	private $object;
	...
	{
		$this->object = new Controller_ExtJS_Attribute_Type_Default( TestHelper::getContext() );
	}
