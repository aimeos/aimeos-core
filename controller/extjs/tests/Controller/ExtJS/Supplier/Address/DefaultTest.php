...
class Controller_ExtJS_Supplier_Address_DefaultTest extends PHPUnit_Framework_TestCase
{
	private $object;
	...
	{
		$this->object = new Controller_ExtJS_Supplier_Address_Default( TestHelper::getContext() );
	}
