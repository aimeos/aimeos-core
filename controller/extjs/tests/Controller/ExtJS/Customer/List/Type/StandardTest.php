...
class Controller_ExtJS_Customer_List_Type_StandardTest extends PHPUnit_Framework_TestCase
{
	private $object;
	...
	{
		$this->object = new Controller_ExtJS_Customer_List_Type_Standard( TestHelper::getContext() );
	}
