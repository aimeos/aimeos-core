...
class Controller_ExtJS_Customer_Lists_StandardTest extends PHPUnit_Framework_TestCase
{
	private $object;
	...
	{
		$this->object = new Controller_ExtJS_Customer_Lists_Standard( TestHelper::getContext() );
	}
	...
	public function testSaveDeleteItem()
	{
		...
		$listTypeManager = Controller_ExtJS_Customer_Lists_Type_Factory::createController( TestHelper::getContext() );
