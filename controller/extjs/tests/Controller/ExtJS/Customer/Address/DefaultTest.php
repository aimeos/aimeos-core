...
class Controller_ExtJS_Customer_Address_DefaultTest extends MW_Unittest_Testcase
{
	private $_object;
	...
	{
		$this->_object = new Controller_ExtJS_Customer_Address_Default( TestHelper::getContext() );
	}
