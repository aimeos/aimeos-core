...
class Controller_ExtJS_Product_Export_Text_FactoryTest extends MW_Unittest_Testcase
{
	private $_object;
	...
	public static function main()
	{
		...
		$suite  = new PHPUnit_Framework_TestSuite( 'Controller_ExtJS_Product_Export_Text_FactoryTest' );
	...
	{
		$obj = Controller_ExtJS_Product_Export_Text_Factory::createController( TestHelper::getContext() );
