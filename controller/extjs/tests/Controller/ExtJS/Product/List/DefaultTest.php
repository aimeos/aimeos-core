...
class Controller_ExtJS_Product_List_DefaultTest extends PHPUnit_Framework_TestCase
{
	private $object;
	...
	{
		$this->object = new Controller_ExtJS_Product_List_Default( TestHelper::getContext() );
	}
