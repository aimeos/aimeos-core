...
class Controller_ExtJS_Product_Tag_Type_DefaultTest extends PHPUnit_Framework_TestCase
{
	private $object;
	...
	{
		$this->object = new Controller_ExtJS_Product_Tag_Type_Default( TestHelper::getContext() );
	}
