...
class StandardTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testAdd()
	{
		...
		$file = $this->getMockBuilder( '\Aimeos\MW\View\Helper\Request\File\Standard' )
			->setMethods( array( 'moveTo' ) )
	...
	{
		$file = new \Aimeos\MW\View\Helper\Request\File\Standard( '', '', '', 0, UPLOAD_ERR_OK );
	...
	{
		$file = new \Aimeos\MW\View\Helper\Request\File\Standard( '', '', '', 0, UPLOAD_ERR_INI_SIZE );
	...
	{
		$file = new \Aimeos\MW\View\Helper\Request\File\Standard( '', '', '', 0, UPLOAD_ERR_PARTIAL );
	...
	{
		$file = new \Aimeos\MW\View\Helper\Request\File\Standard( '', '', '', 0, UPLOAD_ERR_NO_FILE );
	...
	{
		$file = new \Aimeos\MW\View\Helper\Request\File\Standard( '', '', '', 0, UPLOAD_ERR_NO_TMP_DIR );
	...
	{
		$file = new \Aimeos\MW\View\Helper\Request\File\Standard( '', '', '', 0, UPLOAD_ERR_CANT_WRITE );
	...
	{
		$file = new \Aimeos\MW\View\Helper\Request\File\Standard( '', '', '', 0, UPLOAD_ERR_EXTENSION );
