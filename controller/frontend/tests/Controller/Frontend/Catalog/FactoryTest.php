...
class Controller_Frontend_Catalog_FactoryTest extends PHPUnit_Framework_TestCase
{
	public function testCreateController()
	{
		$target = 'Controller_Frontend_Catalog_Iface';

		$controller = Controller_Frontend_Catalog_Factory::createController( TestHelper::getContext() );
		$this->assertInstanceOf( $target, $controller );

		$controller = Controller_Frontend_Catalog_Factory::createController( TestHelper::getContext(), 'Standard' );
		$this->assertInstanceOf( $target, $controller );
	}
