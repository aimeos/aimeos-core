...
{
	/** controller/jsonadm/customer/decorators/excludes
	 ...
	 * @see controller/jsonadm/customer/decorators/global
	 * @see controller/jsonadm/customer/decorators/local
	 */

	/** controller/jsonadm/customer/decorators/global
	 ...
	 * controller.
	 *
	 *  controller/jsonadm/customer/decorators/global = array( 'decorator1' )
	 *
	 * This would add the decorator named "decorator1" defined by
	 * "\Aimeos\Controller\Jsonadm\Common\Decorator\Decorator1" only to the
	 * "customer" Jsonadm controller.
	 *
	 * @param array List of decorator names
	 * @since 2016.01
	 * @category Developer
	 * @see controller/jsonadm/common/decorators/default
	 * @see controller/jsonadm/customer/decorators/excludes
	 * @see controller/jsonadm/customer/decorators/local
	 */

	/** controller/jsonadm/customer/decorators/local
	 ...
	 * controller.
	 *
	 *  controller/jsonadm/customer/decorators/local = array( 'decorator2' )
	 *
