...
{
	/** controller/jsonadm/media/decorators/excludes
	 ...
	 * @see controller/jsonadm/media/decorators/global
	 * @see controller/jsonadm/media/decorators/local
	 */

	/** controller/jsonadm/media/decorators/global
	 ...
	 * controller.
	 *
	 *  controller/jsonadm/media/decorators/global = array( 'decorator1' )
	 *
	 * This would add the decorator named "decorator1" defined by
	 * "\Aimeos\Controller\Jsonadm\Common\Decorator\Decorator1" only to the
	 * "media" Jsonadm controller.
	 *
	 * @param array List of decorator names
	 * @since 2016.01
	 * @category Developer
	 * @see controller/jsonadm/common/decorators/default
	 * @see controller/jsonadm/media/decorators/excludes
	 * @see controller/jsonadm/media/decorators/local
	 */

	/** controller/jsonadm/media/decorators/local
	 ...
	 * ("\Aimeos\Controller\Jsonadm\Media\Decorator\*") around the Jsonadm
	 * controller.
	 *
	 *  controller/jsonadm/media/decorators/local = array( 'decorator2' )
	 *
	 * This would add the decorator named "decorator2" defined by
	 * "\Aimeos\Controller\Jsonadm\Media\Decorator\Decorator2" only to the
	 * "media" Jsonadm controller.
	 *
	 * @param array List of decorator names
	 * @since 2016.01
