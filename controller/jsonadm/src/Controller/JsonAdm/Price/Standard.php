...
{
	/** controller/jsonadm/price/decorators/excludes
	 ...
	 * @see controller/jsonadm/price/decorators/global
	 * @see controller/jsonadm/price/decorators/local
	 */

	/** controller/jsonadm/price/decorators/global
	 ...
	 * controller.
	 *
	 *  controller/jsonadm/price/decorators/global = array( 'decorator1' )
	 *
	 * This would add the decorator named "decorator1" defined by
	 * "\Aimeos\Controller\Jsonadm\Common\Decorator\Decorator1" only to the
	 * "price" Jsonadm controller.
	 *
	 * @param array List of decorator names
	 * @since 2016.01
	 * @category Developer
	 * @see controller/jsonadm/common/decorators/default
	 * @see controller/jsonadm/price/decorators/excludes
	 * @see controller/jsonadm/price/decorators/local
	 */

	/** controller/jsonadm/price/decorators/local
	 ...
	 * ("\Aimeos\Controller\Jsonadm\Price\Decorator\*") around the Jsonadm
	 * controller.
	 *
	 *  controller/jsonadm/price/decorators/local = array( 'decorator2' )
	 *
	 * This would add the decorator named "decorator2" defined by
	 * "\Aimeos\Controller\Jsonadm\Price\Decorator\Decorator2" only to the
	 * "price" Jsonadm controller.
	 *
	 * @param array List of decorator names
	 * @since 2016.01
