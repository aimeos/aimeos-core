	...
	implements \Aimeos\Controller\JsonAdm\Common\Factory\Iface
{
		...
		\Aimeos\MW\View\Iface $view, array $templatePaths, $path, $name = null )
	{
		 ...
		 * @see controller/jsonadm/decorators/local
		 */

		/** controller/jsonadm/decorators/global
		 ...
		 * @category Developer
		 * @see controller/jsonadm/common/decorators/default
		 * @see controller/jsonadm/decorators/excludes
		 * @see controller/jsonadm/decorators/local
		 */

		/** controller/jsonadm/decorators/local
