...
namespace Aimeos\Controller\JsonAdm\Attribute;


/**
 * JSON API attribute controller
 *
 * @package Controller
 * @subpackage JsonAdm
 */
...
{
	/** controller/jsonadm/attribute/decorators/excludes
	 ...
	 * @see controller/jsonadm/attribute/decorators/global
	 * @see controller/jsonadm/attribute/decorators/local
	 */

	/** controller/jsonadm/attribute/decorators/global
	 ...
	 * controller.
	 *
	 *  controller/jsonadm/attribute/decorators/global = array( 'decorator1' )
	 *
	 * This would add the decorator named "decorator1" defined by
	 * "\Aimeos\Controller\Jsonadm\Common\Decorator\Decorator1" only to the
	 * "attribute" Jsonadm controller.
	 *
	 * @param array List of decorator names
	 * @since 2016.01
	 * @category Developer
	 * @see controller/jsonadm/common/decorators/default
	 * @see controller/jsonadm/attribute/decorators/excludes
	 * @see controller/jsonadm/attribute/decorators/local
	 */

	/** controller/jsonadm/attribute/decorators/local
	 ...
	 * controller.
	 *
	 *  controller/jsonadm/attribute/decorators/local = array( 'decorator2' )
	 *
