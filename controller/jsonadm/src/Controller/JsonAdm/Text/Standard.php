...
{
	/** controller/jsonadm/text/decorators/excludes
	 ...
	 * @see controller/jsonadm/text/decorators/global
	 * @see controller/jsonadm/text/decorators/local
	 */

	/** controller/jsonadm/text/decorators/global
	 ...
	 * controller.
	 *
	 *  controller/jsonadm/text/decorators/global = array( 'decorator1' )
	 *
	 * This would add the decorator named "decorator1" defined by
	 * "\Aimeos\Controller\Jsonadm\Common\Decorator\Decorator1" only to the
	 * "text" Jsonadm controller.
	 *
	 * @param array List of decorator names
	 * @since 2016.01
	 * @category Developer
	 * @see controller/jsonadm/common/decorators/default
	 * @see controller/jsonadm/text/decorators/excludes
	 * @see controller/jsonadm/text/decorators/local
	 */

	/** controller/jsonadm/text/decorators/local
	 ...
	 * ("\Aimeos\Controller\Jsonadm\Text\Decorator\*") around the Jsonadm
	 * controller.
	 *
	 *  controller/jsonadm/text/decorators/local = array( 'decorator2' )
	 *
	 * This would add the decorator named "decorator2" defined by
	 * "\Aimeos\Controller\Jsonadm\Text\Decorator\Decorator2" only to the
	 * "text" Jsonadm controller.
	 *
	 * @param array List of decorator names
	 * @since 2016.01
