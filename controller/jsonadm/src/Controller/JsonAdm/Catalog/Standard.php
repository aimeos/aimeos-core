...
{
	/** controller/jsonadm/catalog/decorators/excludes
	 ...
	 * @see controller/jsonadm/catalog/decorators/global
	 * @see controller/jsonadm/catalog/decorators/local
	 */

	/** controller/jsonadm/catalog/decorators/global
	 ...
	 * controller.
	 *
	 *  controller/jsonadm/catalog/decorators/global = array( 'decorator1' )
	 *
	 * This would add the decorator named "decorator1" defined by
	 * "\Aimeos\Controller\Jsonadm\Common\Decorator\Decorator1" only to the
	 * "catalog" Jsonadm controller.
	 *
	 * @param array List of decorator names
	 * @since 2016.01
	 * @category Developer
	 * @see controller/jsonadm/common/decorators/default
	 * @see controller/jsonadm/catalog/decorators/excludes
	 * @see controller/jsonadm/catalog/decorators/local
	 */

	/** controller/jsonadm/catalog/decorators/local
	 ...
	 * ("\Aimeos\Controller\Jsonadm\Catalog\Decorator\*") around the Jsonadm
	 * controller.
	 *
	 *  controller/jsonadm/catalog/decorators/local = array( 'decorator2' )
	 *
	 * This would add the decorator named "decorator2" defined by
	 * "\Aimeos\Controller\Jsonadm\Catalog\Decorator\Decorator2" only to the
	 * "catalog" Jsonadm controller.
	 *
	 * @param array List of decorator names
	 * @since 2016.01
