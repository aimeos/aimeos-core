...
class TestHelper
{
	...
	{
		return self::getAimeos()->getCustomPaths( 'controller/jsonapi/templates' );
	}
	...
	private static function createContext( $site )
	{
		...
		$ctx->setEditor( 'core:controller/jsonapi' );
	...
	{
		$tmplpaths = self::getAimeos()->getCustomPaths( 'controller/jsonapi/templates' );
