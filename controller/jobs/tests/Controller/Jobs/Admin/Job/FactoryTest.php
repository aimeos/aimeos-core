...
class Controller_Jobs_Admin_Job_FactoryTest extends PHPUnit_Framework_TestCase
{
	...
	public function testFactoryExceptionWrongName()
	{
		...
		Controller_Jobs_Admin_Job_Factory::createController( $context, $arcavias, 'Wrong$$$Name' );
	}
	...
	public function testFactoryExceptionWrongClass()
	{
		...
		$this->setExpectedException( 'Controller_Jobs_Exception' );
		Controller_Jobs_Admin_Job_Factory::createController( $context, $arcavias, 'WrongClass' );
	}
