	...
	extends MW_Unittest_Testcase
{
	...
	public function testFactoryExceptionWrongName()
	{
		...
		Controller_Jobs_Order_Cleanup_Unfinished_Factory::createController( $context, $arcavias, 'Wrong$$$Name' );
	}
	...
	public function testFactoryExceptionWrongClass()
	{
		...
		$this->setExpectedException( 'Controller_Jobs_Exception' );
		Controller_Jobs_Order_Cleanup_Unfinished_Factory::createController( $context, $arcavias, 'WrongClass' );
	}
