...
class Controller_Jobs_Order_Cleanup_Unpaid_StandardTest
	extends PHPUnit_Framework_TestCase
{
	...
	protected function setUp()
	{
		...
		$this->object = new Controller_Jobs_Order_Cleanup_Unpaid_Standard( $context, $aimeos );
	}
	...
	public function testRun()
	{
		...
		$object = new Controller_Jobs_Order_Cleanup_Unpaid_Standard( $context, $aimeos );
		$object->run();
	}
}
