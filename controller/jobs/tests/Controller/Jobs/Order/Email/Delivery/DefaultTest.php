...
class Controller_Jobs_Order_Email_Delivery_DefaultTest extends PHPUnit_Framework_TestCase
{
	private $object;
	...
	protected function setUp()
	{
		...
		$this->object = new Controller_Jobs_Order_Email_Delivery_Default( $context, $aimeos );
	}
