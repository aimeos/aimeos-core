...
class Controller_Jobs_Product_Import_Csv_Cache_Product_DefaultTest extends MW_Unittest_Testcase
{
	private $_object;
	...
	protected function setUp()
	{
		...
		$this->_object = new Controller_Jobs_Product_Import_Csv_Cache_Product_Default( $context );
	}
