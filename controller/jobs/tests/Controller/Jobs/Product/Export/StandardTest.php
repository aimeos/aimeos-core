...
class Controller_Jobs_Product_Export_StandardTest extends PHPUnit_Framework_TestCase
{
	private $object;
	private $context;
	private $aimeos;
	...
	protected function setUp()
	{
		...
		$this->object = new Controller_Jobs_Product_Export_Standard( $this->context, $this->aimeos );
	}
