	...
	implements Controller_Jobs_Common_Factory_Iface
{
	...
	public static function createController( MShop_Context_Item_Iface $context, Aimeos $aimeos, $name = null )
	{
		 ...
		 * ("Controller_Jobs_Order_Cleanup_Unfinished_Decorator_*") around this job controller.
		 *
		 *  controller/jobs/order/cleanup/unfinished/decorators/local = array( 'decorator2' )
		 *
		 * This would add the decorator named "decorator2" defined by
		 * "Controller_Jobs_Order_Cleanup_Unfinished_Decorator_Decorator2" only to this job
		 * controller.
		 *
		 * @param array List of decorator names
		 * @since 2015.09
