 ...
 * @subpackage Jobs
 */
class Controller_Jobs_Order_Service_Payment_Factory
	...
	implements Controller_Jobs_Common_Factory_Iface
{
	...
	{
		/** classes/controller/jobs/order/service/payment/name
		 ...
		 *
		 *  Controller_Jobs_Order_Service_Payment_Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  Controller_Jobs_Order_Service_Payment_Mypayment
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/controller/jobs/order/service/payment/name = Mypayment
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'classes/controller/jobs/order/service/payment/name', 'Standard' );
		}

		if( ctype_alnum( $name ) === false )
		{
			$classname = is_string( $name ) ? 'Controller_Jobs_Order_Service_Payment_' . $name : '<not a string>';
