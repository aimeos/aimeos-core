 ...
 * @subpackage Jobs
 */
class Controller_Jobs_Order_Service_Async_Factory
	...
	implements Controller_Jobs_Common_Factory_Interface
{
	...
	{
		/** classes/controller/jobs/order/service/async/name
		 ...
		 *
		 *  Controller_Jobs_Order_Service_Async_Default
		 *
		 * and you want to replace it with your own version named
		 *
		 *  Controller_Jobs_Order_Service_Async_Myasync
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/controller/jobs/order/service/async/name = Myasync
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'classes/controller/jobs/order/service/async/name', 'Default' );
		}

		if( ctype_alnum( $name ) === false )
		{
			$classname = is_string( $name ) ? 'Controller_Jobs_Order_Service_Async_' . $name : '<not a string>';
		...
		$classname = 'Controller_Jobs_Order_Service_Async_' . $name;
		 ...
		 * ("Controller_Jobs_Order_Service_Async_Decorator_*") around this job controller.
		 *
		 *  controller/jobs/order/service/async/decorators/local = array( 'decorator2' )
		 *
		 * This would add the decorator named "decorator2" defined by
		 * "Controller_Jobs_Order_Service_Async_Decorator_Decorator2" only to this job
		 * controller.
		 *
		 * @param array List of decorator names
		 * @since 2015.09
		 ...
		 * @see controller/jobs/order/service/async/decorators/global
		 */
		return self::_addControllerDecorators( $context, $arcavias, $controller, 'order/service/async' );
	}
}