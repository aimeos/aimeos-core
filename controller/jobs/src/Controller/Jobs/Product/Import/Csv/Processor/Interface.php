 ...
 * @subpackage Jobs
 */
interface Controller_Jobs_Product_Import_Csv_Processor_Interface
{
	/**
	 ...
	 * @param Controller_Jobs_Product_Import_Csv_Processor_Interface $processor Decorated processor
	 */
	public function __construct( MShop_Context_Item_Interface $context, array $mapping,
		Controller_Jobs_Product_Import_Csv_Processor_Interface $processor = null );
