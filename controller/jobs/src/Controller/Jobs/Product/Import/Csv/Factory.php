 ...
 * @subpackage Jobs
 */
class Controller_Jobs_Product_Import_Csv_Factory
	...
	implements Controller_Jobs_Common_Factory_Interface
{
	...
	{
		/** classes/controller/jobs/product/import/csv/name
		 ...
		 *
		 *  Controller_Jobs_Product_Import_Csv_Default
		 *
		 * and you want to replace it with your own version named
		 *
		 *  Controller_Jobs_Product_Import_Csv_Mycsv
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/controller/jobs/product/import/csv/name = Mycsv
		 *
		 ...
		 */
		if ( $name === null ) {
			$name = $context->getConfig()->get('classes/controller/jobs/product/import/csv/name', 'Default');
		}

		if ( ctype_alnum($name) === false )
		{
			$classname = is_string($name) ? 'Controller_Jobs_Product_Import_Csv_' . $name : '<not a string>';
		 ...
		 * ("Controller_Jobs_Product_Import_Csv_Decorator_*") around the job
		 * controller.
		 *
		 *  controller/jobs/product/import/csv/decorators/local = array( 'decorator2' )
		 *
		 * This would add the decorator named "decorator2" defined by
		 * "Controller_Jobs_Product_Import_Csv_Decorator_Decorator2"
		 ...
		 * @see controller/jobs/product/import/csv/decorators/global
		 */
		return self::_addControllerDecorators( $context, $arcavias, $controller, 'product/import/csv' );
	}
}