...
/**
 * Product import controller factory.
 *
 * @package Controller
 * @subpackage Jobs
 */
class Controller_Jobs_Product_Import_Factory
	...
	implements Controller_Jobs_Common_Factory_Interface
{
	...
	{
		/** classes/controller/jobs/product/import/name
		 ...
		 *
		 *  Controller_Jobs_Product_Import_Default
		 *
		 * and you want to replace it with your own version named
		 *
		 *  Controller_Jobs_Product_Import_Myalgorithm
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/controller/jobs/product/import/name = Myalgorithm
		 *
		 ...
		 */
		if ( $name === null ) {
			$name = $context->getConfig()->get('classes/controller/jobs/product/import/name', 'Default');
		}

		if ( ctype_alnum($name) === false )
		{
			$classname = is_string($name) ? 'Controller_Jobs_Product_Import_' . $name : '<not a string>';
		...
		$classname = 'Controller_Jobs_Product_Import_' . $name;
		 ...
		 * @see controller/jobs/product/decorators/global
		 */
		return self::_addControllerDecorators( $context, $arcavias, $controller, 'product/import' );
	}
}