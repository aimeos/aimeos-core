	...
	implements \Aimeos\Controller\Jobs\Common\Factory\Iface
{
	...
	{
		/** classes/controller/jobs/index/optimize/name
		 ...
		 *
		 *  classes/controller/index/optimize/name = Myoptimizer
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'classes/controller/jobs/index/optimize/name', 'Standard' );
		}
