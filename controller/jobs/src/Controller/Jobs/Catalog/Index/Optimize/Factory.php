	...
	implements \Aimeos\Controller\Jobs\Common\Factory\Iface
{
	...
	{
		/** classes/controller/jobs/catalog/index/optimize/name
		 ...
		 *
		 *  \Aimeos\Controller\Jobs\Catalog\Index\Optimize\Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  \Aimeos\Controller\Jobs\Catalog\Index\Optimize\Myoptimizer
		 *
		 * then you have to set the this configuration option:
		 *
		 *  classes/controller/catalog/index/optimize/name = Myoptimizer
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'classes/controller/jobs/catalog/index/optimize/name', 'Standard' );
		}

		if( ctype_alnum( $name ) === false )
		{
			$classname = is_string( $name ) ? '\\Aimeos\\Controller\\Jobs\\Catalog\\Index\\Optimize\\' . $name : '<not a string>';
			throw new \Aimeos\Controller\Jobs\Exception( sprintf( 'Invalid characters in class name "%1$s"', $classname ) );
		}

		$iface = '\\Aimeos\\Controller\\Jobs\\Iface';
		$classname = '\\Aimeos\\Controller\\Jobs\\Catalog\\Index\\Optimize\\' . $name;
		 ...
		 *
		 *  controller/jobs/catalog/index/optimize/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see controller/jobs/catalog/index/optimize/decorators/local
		 */

		/** controller/jobs/catalog/index/optimize/decorators/global
		 ...
		 *
		 *  controller/jobs/catalog/index/optimize/decorators/global = array( 'decorator1' )
		 *
		...
		/** controller/jobs/catalog/index/optimize/decorators/local
		 ...
		 * ("\Aimeos\Controller\Jobs\Catalog\Index\Optimize\Decorator\*") around this job controller.
		 *
		 *  controller/jobs/catalog/index/optimize/decorators/local = array( 'decorator2' )
		 *
		 * This would add the decorator named "decorator2" defined by
		 * "\Aimeos\Controller\Jobs\Catalog\Index\Optimize\Decorator\Decorator2" only to this job
		 * controller.
		 *
		 * @param array List of decorator names
		 * @since 2015.09
