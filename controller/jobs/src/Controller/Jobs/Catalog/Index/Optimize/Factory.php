	...
	implements Controller_Jobs_Common_Factory_Iface
{
	...
	public static function createController( MShop_Context_Item_Iface $context, Aimeos $aimeos, $name = null )
	{
		 ...
		 *
		 *  Controller_Jobs_Catalog_Index_Optimize_Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  Controller_Jobs_Catalog_Index_Optimize_Myoptimizer
		 *
		 ...
		 * ("Controller_Jobs_Catalog_Index_Optimize_Decorator_*") around this job controller.
		 *
		 *  controller/jobs/catalog/index/optimize/decorators/local = array( 'decorator2' )
		 *
		 * This would add the decorator named "decorator2" defined by
		 * "Controller_Jobs_Catalog_Index_Optimize_Decorator_Decorator2" only to this job
		 * controller.
		 *
		 * @param array List of decorator names
		 * @since 2015.09
