	...
	implements Controller_Jobs_Common_Factory_Interface
{
	...
	public static function createController( MShop_Context_Item_Interface $context, Arcavias $arcavias, $name = null )
	{
		 ...
		 *
		 *  Controller_Jobs_Catalog_Index_Optimize_Default
		 *
		...
		/** controller/jobs/catalog/decorators/excludes
		 * Excludes decorators added by the "common" option from the catalog job controller
		 *
		 ...
		 *
		 *  controller/jobs/catalog/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see controller/jobs/catalog/decorators/global
		 * @see controller/jobs/catalog/decorators/local
		 */

		/** controller/jobs/catalog/decorators/global
		 ...
		 *
		 *  controller/jobs/catalog/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developers
		 * @see controller/jobs/common/decorators/default
		 * @see controller/jobs/catalog/decorators/excludes
		 * @see controller/jobs/catalog/decorators/local
		 */

		/** controller/jobs/catalog/decorators/local
		 ...
		 * ("Controller_Jobs_Catalog_Decorator_*") around the job
		 * controller.
		 *
		 *  controller/jobs/catalog/decorators/local = array( 'decorator2' )
		 *
		 * This would add the decorator named "decorator2" defined by
		 * "Controller_Jobs_Catalog_Decorator_Decorator2"
